...
static void test_interrupt_with_mask(int vexId, int bMaskEnabled)
{
    ...
    unsigned int vex_tile_ctrl_offset = VEXABC1_GP_VE32_TILE_CTRL_BASE - VEXABC0_GP_VE32_TILE_CTRL_BASE;
    unsigned int vex_tile_ctrl_base_addr = VEXABC0_GP_VE32_TILE_CTRL_BASE + (vexId * vex_tile_ctrl_offset);
    ...
    print("test_interrupt_with_mask vex %d, bMaskEnabled %d\n", vexId, bMaskEnabled);

    // pre check status, masked status, car_high_int_status
    read_reg_expect_18a(vex_wdt_int_status, 0, 0xFFFFFFFF, "vex_wdt_int_status");
    ...
    write_reg_18a(vex_tile_ctrl_base_addr + VE32_TILE_CTRL_WDTIRQ_OFFSET, 0, 0xFFFFFFFF, "vex_tile_ctrl_wdtirq");
