...
volatile int AT(0x50) g_rxfb_scratch_addr;
volatile int AT(0x54) g_rxfb_dma0_ch0_llp_addr;

volatile int AT(0x58) g_rxfb_scratch_data;

vec32i32 AT(0x9000)    vDmaReqData;
...
void vex_producer() ENTRY
{
    ...
    v_xsto_32(Any, g_rxfb_scratch_addr, 0, g_rxfb_scratch_data);
    ...
    v_xstomi_512(Any, g_rxfb_dma0_ch0_llp_addr, 0, 1023, vDmaReqData, offset);
} // jesd_tx() ends
