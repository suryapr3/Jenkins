...
//main(int argc, const char * argv[])
{
    ...
    int offsetVal[1] = {HIVE_ADDR_dmem_write_prog_pattern
    };
    ...
    vex_loader(vexCoreId, "vex_fw/sim_m64/dmem_write_prog.fw");
