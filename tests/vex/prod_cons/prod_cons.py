...
if dut_preconfig == 1:
    ...
    vex_valid_cores_list = [*range(16)] + [32, 34, 36]
    src_core_id = 0
    

#    logger.info(my_functions.main(0, 1))
#    logger.info(my_functions.rte_deinit())
#    for dest_core_id in vex_valid_cores_list:
#            if src_core_id != dest_core_id:
#                logger.info(my_functions.main(src_core_id, dest_core_id))
#                logger.info(my_functions.rte_deinit())
