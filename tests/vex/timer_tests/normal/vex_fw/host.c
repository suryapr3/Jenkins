...
#define VE02 abc_vex_vex_0_2_ve32
...
#define BASE_VE02_CIO2STRM  _hrt_master_to_slave_address_host_op0_to_abc_vex_vex_0_2_cio2strm_sl_cfg
...
#define BASE_VE02_STRM2CIO  _hrt_master_to_slave_address_host_op0_to_abc_vex_vex_0_2_strm2cio_sl_cfg
...
int hrt_main(int argc, char **argv)
{
    ...
    hrt_cell_load_program(VE00, "v2d_flow3_tx");
    ...
    hrt_scalar_store(VE00, uint, v2d_flow3_tx_g_scalar_val, add_const);
    hrt_scalar_store(VE00, uint, v2d_flow3_tx_g_num_vecs_in, num_vec_input);
    hrt_scalar_store(VE00, uint, v2d_flow3_tx_g_dest_buffer_base, 0x4000);
    hrt_scalar_store(VE00, uint, v2d_flow3_tx_g_num_blocks, 0);
    hrt_scalar_store(VE00, uint, v2d_flow3_tx_g_initial_block_size, 3);
    ...
    hrt_scalar_store(VE01, uint, v2d_flow3_rx_g_tbs_in_blk, 32);
    ...
    hrt_scalar_store(VE02, uint, producer_prog_g_tbs_in_blk, 32);
    ...
    for(i = 0; i < num_vec_input; i++)
    {
        for(j = 0; j < NUM_OF_ELEMENTS_PER_VEC; j++)
        {
            ...
            hrt_indexed_store(VE00, int, v2d_flow3_tx_vbuffer, i * NUM_OF_ELEMENTS_PER_VEC + j,
                              (((i * NUM_OF_ELEMENTS_PER_VEC + j) << 16) |(i * NUM_OF_ELEMENTS_PER_VEC + j)));
        }
    }
    index = 0;
    ...
    // Run program
    hrt_cell_start_function(VE00, v2d_flow3_tx_v2d_flow3_tx);
