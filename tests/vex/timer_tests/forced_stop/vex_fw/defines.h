...
#define NUM_MAX_STREAMS_SUPPORT 8
...
#define TIMER_TMDVALR(t)        (TIMER_TMDVALR0 + (t * 9))
#define TIMER_TMDCFGR(t)        (TIMER_TMDCFGR0 + (t * 9))
#define TIMER_TMDINITR(t)       (TIMER_TMDINITR0 + (t * 9))
#define TIMER_TMDWDNOTR(t)      (TIMER_TMDWDNOTR0 + (t * 9))
#define TIMER_TMDWDADDRR(t)     (TIMER_TMDWDADDRR0 + (t * 9))
#define TIMER_TMDWDDATAR(t)     (TIMER_TMDWDDATAR0 + (t * 9))
#define TIMER_TMDCMDR(t)         (TIMER_TMDCMDR0 + (t * 9))
