...
# =============================================================================
# test description : this test checks the vex core timer in continous shot watchdog mode by modifying it at runtime
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if dut_preconfig == 1:
    ...
    for core_id in valid_vex_id_list:
        for timer_id in range(4):
	        logger.info(my_functions.main(core_id, 0x55555555,timer_id))
	        logger.info(my_functions.main(core_id, 0xAAAAAAAA,timer_id))
