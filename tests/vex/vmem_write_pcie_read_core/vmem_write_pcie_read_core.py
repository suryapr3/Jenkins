...
# =============================================================================
# test description : this test validates vex vmem by writing from pcie and reading from core
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if dut_preconfig == 1:
    ...
    for core_id in vex_valid_cores_list:
        logger.info(my_functions.main(core_id, 0x55555555))
        logger.info(my_functions.main(core_id, 0xAAAAAAAA))
