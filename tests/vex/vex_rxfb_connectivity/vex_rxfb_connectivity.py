...
#!/usr/bin/env python
# =============================================================================
# Created By  : Vijay Paidi
# Created Date: Dec 10 2023
# =============================================================================
# test description : this test checks the connectivity between jesd_0/1/2/3 and all vex cores
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if dut_preconfig == 1:
    ...
    vex_valid_cores_list = [*range(16)] + [32, 34, 36, 38]
    #vex_valid_cores_list = [0]
    
    for src_core_id in vex_valid_cores_list:
        for rxfb_id in range(1): 
            for dma_id in range(2):
                for ch_id in range(2): #works
                    for nsip_id in range(2):
                        if dma_id == ch_id and dma_id == nsip_id:
                            logger.info(my_functions.main(src_core_id, rxfb_id, dma_id, ch_id, nsip_id))
