...
int main(int argc, char **argv)
{
    ...
    for (write_iteration = 0;write_iteration < 1; write_iteration++)
    {
        ...
        {
            write_read_expect_18a(base_address[i]+VE32_BP_CFG_PMEM_FIRST_OFFSET, \
                                    VE32_BP_CFG_PMEM_FIRST_DEFAULT, write_data, expected_data, \
                                    VE32_BP_CFG_PMEM_FIRST_RD_MASK, VE32_BP_CFG_PMEM_FIRST_WR_MASK, \
                                    "VE32_BP_CFG_PMEM_FIRST_OFFSET");

            write_read_expect_18a(base_address[i]+VE32_BP_CFG_PMEM_LAST_OFFSET, \
                                    VE32_BP_CFG_PMEM_LAST_DEFAULT, write_data, expected_data, \
                                    VE32_BP_CFG_PMEM_LAST_RD_MASK, VE32_BP_CFG_PMEM_LAST_WR_MASK, \
                                    "VE32_BP_CFG_PMEM_LAST_OFFSET");
