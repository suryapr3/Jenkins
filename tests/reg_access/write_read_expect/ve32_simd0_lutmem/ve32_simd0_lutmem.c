...
int main(int argc, char **argv)
{
    ...
    for (write_iteration = 0;write_iteration < 1; write_iteration++)
    {
        ...
        {
            write_read_expect_18a(base_address[i]+VE32_SIMD0_LUTMEM_MEM_VE32_SIMD0_LUTMEM_FIRST_OFFSET, \
                                    VE32_SIMD0_LUTMEM_MEM_VE32_SIMD0_LUTMEM_FIRST_DEFAULT, write_data, expected_data, \
                                    VE32_SIMD0_LUTMEM_MEM_VE32_SIMD0_LUTMEM_FIRST_RD_MASK, VE32_SIMD0_LUTMEM_MEM_VE32_SIMD0_LUTMEM_FIRST_WR_MASK, \
                                    "VE32_SIMD0_LUTMEM_MEM_VE32_SIMD0_LUTMEM_FIRST_OFFSET");

            write_read_expect_18a(base_address[i]+VE32_SIMD0_LUTMEM_MEM_VE32_SIMD0_LUTMEM_LAST_OFFSET, \
                                    VE32_SIMD0_LUTMEM_MEM_VE32_SIMD0_LUTMEM_LAST_DEFAULT, write_data, expected_data, \
                                    VE32_SIMD0_LUTMEM_MEM_VE32_SIMD0_LUTMEM_LAST_RD_MASK, VE32_SIMD0_LUTMEM_MEM_VE32_SIMD0_LUTMEM_LAST_WR_MASK, \
                                    "VE32_SIMD0_LUTMEM_MEM_VE32_SIMD0_LUTMEM_LAST_OFFSET");
