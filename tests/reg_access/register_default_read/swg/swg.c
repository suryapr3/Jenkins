...
int main(int argc, char **argv)
{
    ...
    VHA7_UL_SWG_BASE, FB_ANT0_SWG_EVEN_BASE, FB_ANT0_SWG_ODD_BASE, FB_ANT1_SWG_EVEN_BASE, FB_ANT1_SWG_ODD_BASE,
    FB_SYS0_SWG0_BASE, FB_SYS1_SWG0_BASE
    };
    ...
    for(i=0; i<sizeof(base_address) / (sizeof(base_address[0])*2); i++)
    {
        ...
        read_reg_expect_18a(base_address[i]+SWG_APB_BRDG_STAT_OFFSET, \
                                    SWG_APB_BRDG_STAT_DEFAULT, \
                                    SWG_APB_BRDG_STAT_RD_MASK, "SWG_APB_BRDG_STAT_OFFSET");
