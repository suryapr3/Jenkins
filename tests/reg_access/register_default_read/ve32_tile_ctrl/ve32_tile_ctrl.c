...
int main(int argc, char **argv)
{
    ...
    for(i=0; i<sizeof(base_address) / (sizeof(base_address[0])*2); i++)
    {
        ...
        {
        read_reg_expect_18a(base_address[i]+VE32_TILE_CTRL_GPIO0_OFFSET, \
                                    VE32_TILE_CTRL_GPIO0_DEFAULT, \
                                    VE32_TILE_CTRL_GPIO0_RD_MASK, "VE32_TILE_CTRL_GPIO0_OFFSET");

        read_reg_expect_18a(base_address[i]+VE32_TILE_CTRL_GPIO1_OFFSET, \
                                    VE32_TILE_CTRL_GPIO1_DEFAULT, \
                                    VE32_TILE_CTRL_GPIO1_RD_MASK, "VE32_TILE_CTRL_GPIO1_OFFSET");

        read_reg_expect_18a(base_address[i]+VE32_TILE_CTRL_GPIO2_OFFSET, \
                                    VE32_TILE_CTRL_GPIO2_DEFAULT, \
                                    VE32_TILE_CTRL_GPIO2_RD_MASK, "VE32_TILE_CTRL_GPIO2_OFFSET");

        read_reg_expect_18a(base_address[i]+VE32_TILE_CTRL_GPIO3_OFFSET, \
                                    VE32_TILE_CTRL_GPIO3_DEFAULT, \
                                    VE32_TILE_CTRL_GPIO3_RD_MASK, "VE32_TILE_CTRL_GPIO3_OFFSET");

        read_reg_expect_18a(base_address[i]+VE32_TILE_CTRL_WDTIRQ_OFFSET, \
                                    VE32_TILE_CTRL_WDTIRQ_DEFAULT, \
                                    VE32_TILE_CTRL_WDTIRQ_RD_MASK, "VE32_TILE_CTRL_WDTIRQ_OFFSET");

        read_reg_expect_18a(base_address[i]+VE32_TILE_CTRL_CID_OFFSET, \
                                    VE32_TILE_CTRL_CID_DEFAULT, \
                                    VE32_TILE_CTRL_CID_RD_MASK, "VE32_TILE_CTRL_CID_OFFSET");

        read_reg_expect_18a(base_address[i]+VE32_TILE_CTRL_TMRCTL_OFFSET, \
                                    VE32_TILE_CTRL_TMRCTL_DEFAULT, \
                                    VE32_TILE_CTRL_TMRCTL_RD_MASK, "VE32_TILE_CTRL_TMRCTL_OFFSET");
