...
int main(int argc, char **argv)
{
    ...
    {
        read_reg_expect_18a(base_address[i]+VE32_SIMD0_VMEM_FIRST_OFFSET, \
                                    VE32_SIMD0_VMEM_FIRST_DEFAULT, \
                                    VE32_SIMD0_VMEM_FIRST_RD_MASK, "VE32_SIMD0_VMEM_FIRST_OFFSET");

        read_reg_expect_18a(base_address[i]+VE32_SIMD0_VMEM_LAST_OFFSET, \
                                    VE32_SIMD0_VMEM_LAST_DEFAULT, \
                                    VE32_SIMD0_VMEM_LAST_RD_MASK, "VE32_SIMD0_VMEM_LAST_OFFSET");
