...
int main(int argc, char **argv)
{
    ...
    {
        read_reg_expect_18a(base_address[i]+VHA_DDC_SCRATCH_OFFSET, \
                                    VHA_DDC_SCRATCH_DEFAULT, \
                                    VHA_DDC_SCRATCH_RD_MASK, "VHA_DDC_SCRATCH_OFFSET");

        read_reg_expect_18a(base_address[i]+VHA_DDC_CFG_OFFSET, \
                                    VHA_DDC_CFG_DEFAULT, \
                                    VHA_DDC_CFG_RD_MASK, "VHA_DDC_CFG_OFFSET");
...
//        read_reg_expect_18a(base_address[i]+VHA_DDC_APB_BRDG_STAT_OFFSET, \
                                    VHA_DDC_APB_BRDG_STAT_DEFAULT, \
                                    VHA_DDC_APB_BRDG_STAT_RD_MASK, "VHA_DDC_APB_BRDG_STAT_OFFSET");
