...
int main(int argc, const char * argv[])
{
    ...
    if (rcs_core != RCS_CORE_KP1)
    {
        LOG_PRINT("ERROR: COREID can take only value 3\nExiting...!\n");
        return FAILURE;
    }

    srp_rcs_rcp_t rcs_core_id;
    rcs_core_id = SRP_RCS_RCP_CALIB;
    rcs_params.rcs_cfg[rcs_core_id].img_file = "./rcs_fw/cal_rcs_fw.elf";
    ...
    int reg_num;
    uint32_t rsm_buf_addr, rd_addr;
    uint32_t act_val, exp_val, rd_mask, result;
