...
/**
 * @file    rcs_fw.c
 * @brief   This is a negative test to validate read access to target registers after changing security
 *          bit of base addr rbm register for each target.
 */
...
int main()
{
    ...
    skip_targets2 = (0 << (DRF_1_TRXSYS_0 - 32)) |         // Not available on FRIO, so disabling it.
                    ...
                    (0 << (RCS_1 - 32))          |         // Not accessible for M_RCS_0
                    (0 << (RCS_CS - 32))         |
                    (0 << (SYSCON_MAIN - 32))    |
                    (1 << (VEX_SFC_RBM - 32))    |
                    (0 << (V2D_0 - 32))          |
