...
#!/usr/bin/env python
# =============================================================================
# Created By  : irajm [infant.arockia.raj.m@intel.com ]
# Created Date: 01 Aug 2024
# =============================================================================
# test description : This is a negative test to validate read access
...
if arg_len != 3:
    ...
    print("python access_check_chainging_default_addr_mask_register.py <core_id> <pattern>\n")
