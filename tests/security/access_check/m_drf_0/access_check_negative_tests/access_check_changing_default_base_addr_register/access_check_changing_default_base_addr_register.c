...
int main(int argc, const char* argv[])
{
    ...
    LOG_PRINT("Test: Negative test: Access check modifying the default base addr register\n");
    LOG_PRINT("      %s\n", g_compile_time);
    ...
    skip_targets2 = (1 << (DRF_1_TRXSYS_0 - 32)) |         // Not available on FRIO, so disabling it.
                    ...
                    (1 << (RCS_1 - 32))          |         // Not accessible for DRF
    ...
    // Negative test, the access will fail and result in default pattern present in rsm_buf.
    uint32_t err_cnt = 0;
