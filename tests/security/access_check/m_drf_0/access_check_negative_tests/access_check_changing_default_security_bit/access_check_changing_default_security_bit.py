...
# Created Date: 5 Aug 2024
# =============================================================================
# test description : This is a negative test to validate read access we change
#                    the security bit of base address of the m_drf_0 port
...
if arg_len != 3:
    ...
    print("python access_check_chainging_default_security_bit.py <core_id> <pattern>\n")
