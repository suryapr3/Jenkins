...
fileId = fopen("input_samples/upconversion/single_band_upconversion_1.txt", "w");
fprintf(fileId, "%08x\n", input_iq);
fclose(fileId);
...
fileId = fopen("output_samples/upconversion/1g/single_band_upconversion_1.txt", "w");
fprintf(fileId, "%08x\n", output_iq_1);
fclose(fileId);
...
fileId = fopen("output_samples/upconversion/1g/single_band_upconversion_2.txt", "w");
fprintf(fileId, "%08x\n", output_iq_2);
fclose(fileId);
...
stem(n2, output_iq_4);title ("Output - W1, W2 enabled");
fileId = fopen("output_samples/upconversion/1g/single_band_upconversion_4.txt", "w");
fprintf(fileId, "%08x\n", output_iq_4);
fclose(fileId);
