...
{NSIP_HBI_H2B_FF_FIFO_CTRL_ADR(V2D0_AV2D_APB_0_NSIP_HBI_0_BASE), 0x184, 0xFFFFFFFF, "H2B_FIFO_CONTROL"},
...
{NSIP_HBI_H2B_MD_CTRL_TBL0_ADR(V2D0_AV2D_APB_0_NSIP_HBI_0_BASE), 0x40000007, 0xFFFFFFFF, "H2B_MD_CTRL_TBL0"},
