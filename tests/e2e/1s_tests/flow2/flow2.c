...
int main ()
{
	...
	configure_v2d_flow2(v2d_node_config.v2d_num, v2d_node_config.apb_num, v2d_node_config.in_rate, v2d_node_config.out_rate, v2d_node_config.drf_clock, v2d_node_config.test_config, v2d_node_config.pdpd_enable);
