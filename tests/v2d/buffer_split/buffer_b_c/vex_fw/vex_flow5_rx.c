...
//#pragma hive force_unroll=4
        ...
        for (int i = 0; i < (iter_max / 2); i++)
        {
          ...
          v_ldoi_2048_circ(Any, vex_src_buffer,src_compare_offset, LD_CTL1, LD_CTL2, vdata0, vdata1, src_compare_offset) NO_ALIAS SYNC(buffer_read);
          ...
          V_EQ_32(vadd0, vout0, sout0, sout1) SYNC_WITH(buffer_read);
          V_EQ_32(vadd1, vout1, sout2, sout3) SYNC_WITH(buffer_read);
#if DEBUG
