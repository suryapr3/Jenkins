...
# Created Date: March 22 2024
# =============================================================================
# test description : this test checks TX_HBI_0_NOCFG_DROP interrupt generation
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if arg_len != 7:
    ...
    print("python tx_hbi_0_nocfg_drop.py <tx_vex_id> <rx_vex_id> <v2d_id> <apb_id> <drf_clock> <sys_rate> \n")
...
if param[0] == param[1]:
    print("vex_tx and vex_rx can not be same\n")
...
V2D.sys_rate_check(param[4], param[5])
