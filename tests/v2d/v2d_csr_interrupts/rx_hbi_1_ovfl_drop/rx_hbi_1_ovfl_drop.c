 ...
 *********************************************************************************************/
/**
 * @file    rx_hbi_1_ovfl_drop.c
 * @details 1. This TC validates the RX_HBI_1_OVFL_DROP interrupt generation.
   @TC Description:
        1. Configure all the V2D registers.
        2. Program the H2B credit count as zero.
...
#define V2D_RX_HBI_1_OVFL_DROP  AV2D_CSR_INT_CSR_INT_STATUS_RX_HBI_1_OVFL_DROP_BF_MSK
...
int main(int argc, const char *argv[])
{
   ...
   if ((rv = srp_vex_memid_store(vex_hdl,
    ...
    if (rv = interrupt_status_check(v2d_num, apb_num, V2D_RX_HBI_1_OVFL_DROP/*V2D interrupt value*/, 0/*nsip0 interrupt value*/, 0/*nsip1 interrupt value*/))
    {
    ...
    if (rv = interrupt_status_check(v2d_num, apb_num, V2D_RX_HBI_1_OVFL_DROP | V2D_INTERRUPT_VALUE, 0/*nsip0 interrupt value*/, 0/*nsip1 interrupt value*/))
    {
        printf("ERROR: interrupt check failed\n");
        test_status = 1;
    }
    ...
    if (rv = write_interrupt_clear(v2d_num, apb_num, V2D_RX_HBI_1_OVFL_DROP | V2D_INTERRUPT_VALUE, 0/*nsip0 interrupt vlaue*/, 0/*nsip1 interrupt value*/))
    {
