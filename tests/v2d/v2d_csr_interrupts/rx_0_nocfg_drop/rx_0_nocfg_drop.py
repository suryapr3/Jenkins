...
# =============================================================================
# test description : this test checks RX_0_NOCFG_DROP interrupt generation
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if arg_len != 7:
    ...
    print("python rx_0_nocfg_drop.py <tx_vex_id> <rx_vex_id> <v2d_id> <apb_id> <drf_clock> <sys_rate> \n")
