...
import subprocess
import time
wb = openpyxl.load_workbook("tx_hbi_1_nocfg_drop_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    subprocess.call(['python tx_hbi_1_nocfg_drop.py '  f'{tx_vex_num} '  f'{rx_vex_num} ' f'{v2d_num} '  f'{apb_num} '  f'{drf_clock} ' f'{test_config} '], shell=True)
