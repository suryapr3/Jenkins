...
# =============================================================================
# test description : this test checks the PD_MAIN_UNDERRUN and PD_EXTRA_UNDERRUN
#                    interrupts of V2D
# =============================================================================
# Import statements
# =============================================================================
...
if arg_len != 5:
    ...
    print("python pd_main_pd_extra_no_data_start.py <v2d_id> <apb_id> <drf_clock> <test_config>\n")
