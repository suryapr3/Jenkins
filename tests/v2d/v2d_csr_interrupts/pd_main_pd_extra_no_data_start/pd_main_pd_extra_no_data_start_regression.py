...
import subprocess
import time
wb = openpyxl.load_workbook("pd_main_pd_extra_no_data_start_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    rv = subprocess.call(['python pd_main_pd_extra_no_data_start.py ' f'{v2d_num} '  f'{apb_num} '  f'{drf_clock} '  f'{test_config} '], shell=True)
