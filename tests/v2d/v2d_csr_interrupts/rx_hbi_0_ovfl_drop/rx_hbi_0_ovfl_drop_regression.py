...
import subprocess
import time
wb = openpyxl.load_workbook("rx_hbi_0_ovfl_drop_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    subprocess.call(['python rx_hbi_0_ovfl_drop.py '  f'{tx_vex_num} '  f'{rx_vex_num} ' f'{v2d_num} '  f'{apb_num} '  f'{drf_clock} ' f'{sys_rate} '], shell=True)
