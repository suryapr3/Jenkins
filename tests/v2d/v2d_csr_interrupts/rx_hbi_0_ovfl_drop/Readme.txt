...
python3 rx_hbi_0_ovfl_drop.py <tx_vex_id> <rx_vex_id> <v2d_id> <apb_id> <drf_clock> <sys_rate>
...
ex: python3 rx_hbi_0_ovfl_drop.py 0 1 0 0 0 0
...
The above will generate rx_hbi_0_ovfl_drop_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done in the regression_list_generation.py file.


Steps to run regression:
-------------------------------------------------------------------------------------------------------------------------------------------------------
python3 rx_hbi_0_ovfl_drop_regression.py

The above will run all the possible combination which was mentioned at the first step.
The input combinations will be taken from the rx_hbi_0_ovfl_drop_list.xlsx file.
