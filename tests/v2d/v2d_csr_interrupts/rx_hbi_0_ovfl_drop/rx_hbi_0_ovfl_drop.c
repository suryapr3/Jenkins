 ...
 *********************************************************************************************/
/**
 * @file    rx_hbi_0_ovfl_drop.c
 * @details 1. This TC validates the RX_HBI_0_OVFL_DROP interrupt generation.
   @TC Description:
        1. Configure all the V2D registers.
        2. Program the H2B max credit count as zero.
...
#define V2D_EXP_INTERRUPT_VALUE (AV2D_CSR_INT_CSR_INT_STATUS_RX_HBI_0_OVFL_DROP_BF_MSK | AV2D_CSR_INT_CSR_INT_STATUS_TX_UNDERRUN_BF_MSK)
/***********************************************
...
// H2B Registers
    ...
    {V2D_NSIP_HBI_0_OFFSET + NSIP_HBI_H2B_CREDIT_READY_CS_OFFSET, 0/*H2B_CREDIT_READY_CS_VALUE*/, NSIP_HBI_H2B_CREDIT_READY_CS_WR_MASK, \
        "H2B_CREDIT_READY_CS"},
