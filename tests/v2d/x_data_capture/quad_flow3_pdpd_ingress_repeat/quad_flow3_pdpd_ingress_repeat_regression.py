...
import subprocess
import time
wb = openpyxl.load_workbook("quad_flow3_ingress_repeat_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    subprocess.call(['python quad_flow3_pdpd_ingress_repeat.py '  f'{quad_instance} '  f'{drf_clock} ' f'{test_config} '], shell=True)
