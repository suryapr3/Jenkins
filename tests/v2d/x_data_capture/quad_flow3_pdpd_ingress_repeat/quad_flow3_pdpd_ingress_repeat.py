...
# =============================================================================
# test description : this test checks the V2D CAP MEM at PDPD ingress in Double
#                    configuration mode.
# =============================================================================
# Import statements
# =============================================================================
...
if arg_len != 4:
    ...
    print("python quad_flow3_pdpd_ingress_repeat.py <quad_instance> <drf_clock> <test_config>\n")
...
V2D.drf_clock_check(param[1])
V2D.test_config_check(param[2])

print("delay_value: %s" %param[3])
print("ant0_cycles: %s" %param[4])
print("ant1_cycles: %s" %param[5])
print("ant2_cycles: %s" %param[6])
print("ant3_cycles: %s" %param[7])
param.append(2)
...
skip_cycles = 8 * V2D.get_skip_cycles(param[1], param[2])
param.append(int(skip_cycles))
print("skip_cycles: %s" %param[9])
num_captures = (int)(V2D.get_num_captures(param[1], param[2]) / 8)
...
V2D.capture_delay_value_check(param[1], param[4])
V2D.capture_delay_value_check(param[1], param[5])
V2D.capture_delay_value_check(param[1], param[6])
V2D.capture_delay_value_check(param[1], param[7])
