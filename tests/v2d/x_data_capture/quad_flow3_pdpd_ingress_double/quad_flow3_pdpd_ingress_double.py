...
if arg_len != 9:
    ...
    print("python quad_flow3_pdpd_ingress.py <quad_instance> <drf_clock> <test_config> <delay_value> <capture_delay_value> \
<delay_antenna_capture> <capture_blocks_per_antenna> <consecutive_captures_delay>\n")
    ...
    print(" quad_instance: 0\n drf_clock: 0\n test_config: 0\n delay_value: 768\n capture_delay_value: 0\n delay_antenna_capture: 0\n \
capture_blocks_per_antenna: 20\n consecutive_captures_delay: 1024\n")
    param = [0,0,0,768,0,0,20,1024]
else:
