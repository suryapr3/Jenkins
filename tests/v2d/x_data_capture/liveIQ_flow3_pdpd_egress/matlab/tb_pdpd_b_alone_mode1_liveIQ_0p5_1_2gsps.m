...
temp1 = dlmread( 'liveIQ_ref_LUT0_64_0_i.txt');
temp2 = dlmread( 'liveIQ_ref_LUT0_64_0_q.txt');
temp3 = dlmread( 'liveIQ_ref_LUTall_64_i.txt');
temp4 = dlmread( 'liveIQ_ref_LUTall_64_q.txt');
temp5 = dlmread( 'liveIQ_FP_LUT0_64_0_out_i.txt');
temp6 = dlmread( 'liveIQ_FP_LUT0_64_0_out_q.txt');
...
M(1:size(8),8) = temp8;
for j = 100: nTestPts
difference_i(j) = M(j,3)-M(j,7);
difference_q(j) = M(j,4)-M(j,8);
end 
...
%later this can be changed to Ramons values
...
%
fileId = fopen("liveIQ_ref_LUTall_64_i.txt","w");
fileId1 = fopen("liveIQ_ref_LUTall_64_q.txt","w");
...
temp1 = dlmread( 'liveIQ_ref_LUT0_64_0_i.txt');
temp2 = dlmread( 'liveIQ_ref_LUT0_64_0_q.txt');
temp3 = dlmread( 'liveIQ_ref_output_passthru_i.txt');
temp4 = dlmread( 'liveIQ_ref_output_passthru_q.txt');
temp5 = dlmread( 'liveIQ_FP_LUT0_64_0_out_i.txt');
temp6 = dlmread( 'liveIQ_FP_LUT0_64_0_out_q.txt');
size(1) = numel(temp1);
size(2) = numel(temp2);
