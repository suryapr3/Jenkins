...
python3 flow3_pdpd_ingress_repeat.py <tx_vex> <rx_vex> <v2d_num> <apb_num> <drf_clock> <test_config>
...
ex: python3 flow3_pdpd_ingress_repeat.py 0 1 0 0 0 0
...
The above will generate flow3_pdpd_ingress_repeat_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done
...
The input combinations will be taken from the flow3_pdpd_ingress_repeat_list.xlsx file.
