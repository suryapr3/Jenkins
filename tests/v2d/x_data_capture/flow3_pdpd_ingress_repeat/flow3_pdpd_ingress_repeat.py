...
# Created Date: Jun 3 2024
# =============================================================================
# test description : this test checks the V2D X capture at PDPD ingress in
#                    repeat mode
# =============================================================================
# Import statements
# =============================================================================
...
if arg_len != 7:
    ...
    print("python flow3_pdpd_ingress_repeat.py <tx_vex_id> <rx_vex_id> <v2d_id> <apb_id> <drf_clock> <test_config>\n")
...
print("delay_value: %s\n" %{param[6]})
param.append(0)
print("capture_delay_value: 0\n")
param.append(1)
print("capture_blocks: %s\n" %{param[8]})
param.append(V2D.get_skip_cycles(param[4], param[5]))
print("skip_cycles: %s\n" %{param[9]})
param.append(V2D.get_num_captures(param[4], param[5]))
print("num_captures: %s\n" %{param[10]})
print (param)
...
if(param[0] == param[1]):
    print("tx vex and rx vex shouldn't be same\n")
    sys.exit("proper parameters were not provided\n")
