...
V2D = fw.ABC_V2D()
wa = wb.active
header = ["quad_instance", "channel0", "channel1", "drf_clock", "test_config"]
row = 1
...
sheet_name= wb['Sheet']
sheet_name.title ='flow3_pdpd_ingress_repeat_2_ch'

wb.save("flow3_pdpd_ingress_repeat_2_ch_list.xlsx")
