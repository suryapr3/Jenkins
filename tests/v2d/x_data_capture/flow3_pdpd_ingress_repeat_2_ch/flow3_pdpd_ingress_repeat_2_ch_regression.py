...
import subprocess
import time
wb = openpyxl.load_workbook("flow3_pdpd_ingress_repeat_2_ch_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    subprocess.call(['python flow3_pdpd_ingress_repeat_2_ch.py '  f'{quad_instance} ' f'{channel0} ' f'{channel1} ' f'{drf_clock} ' f'{test_config} '], shell=True)
