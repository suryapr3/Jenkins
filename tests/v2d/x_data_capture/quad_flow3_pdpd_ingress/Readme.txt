...
python quad_flow3_pdpd_ingress.py <quad_instance> <drf_clock> <test_config> <delay_value> <capture_delay_value> <delay_between_antenna_capture>
...
ex: python3 quad_flow3_pdpd_ingress.py 0 0 0 768 0 512
...
The above will generate quad_flow3_pdpd_ingress_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done
...
The input combinations will be taken from the quad_flow3_pdpd_ingress_list.xlsx file.
