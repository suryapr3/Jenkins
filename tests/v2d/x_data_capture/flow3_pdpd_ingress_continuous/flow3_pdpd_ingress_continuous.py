...
# =============================================================================
# test description : this test checks the X-data capture in continuous mode.
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if arg_len != 10:
    ...
    print("python flow3_pdpd_ingress_continuous.py <tx_vex_id> <rx_vex_id> <v2d_id> <apb_id> <drf_clock> <test_config> <filter_mode> <delay_value \
<capture_delay_value>\n")
    print("As there were no inputs provided executing with below parameters\n")
    print(" tx_vex_id : 0\n rx_Vex_id : 1\n v2d_id : 0\n apb_id : 0\n drf_clock: 0\n test_config : 0\n filter_mode : 0\n, delay_value: 768\n \
capture_delay_value: 0")
    param = [0, 1, 0, 0, 0, 0, 0, 768, 0]
else:
