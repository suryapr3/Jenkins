...
# =============================================================================
# test description : this test checks the Flow 3 Dynamic LUT update with data
#                    integrity check.
# =============================================================================
# Import statements
# =============================================================================
...
if arg_len != 8:
    ...
    print("python dyn_flow3_mode1_vex_vex.py <tx_vex_id> <adapt_vex_id> <v2d_id> <apb_id> <drf_clock> <test_config> <delay_value> \n")
    print("As there were no inputs provided executing with below parameters\n")
    print(" tx_vex_id : 0\n adapt_vex_id : 1\n v2d_id : 0\n apb_id : 0\n drf_clock: 0\n test_config : 0\n delay_value: 768\n")
    param = [0, 32, 0, 0, 0, 0, 768]
else:
...
param.append(0) #post_filter_mode
print (param)
...
if(param[0] == param[1]):
    print("tx vex and adapt vex shouldn't be same\n")
...
if load_shared_object == 1:
    #upload the test specific shared object
