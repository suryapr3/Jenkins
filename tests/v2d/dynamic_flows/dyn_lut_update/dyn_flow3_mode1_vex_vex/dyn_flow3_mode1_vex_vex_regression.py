...
import subprocess
import time
wb = openpyxl.load_workbook("dyn_flow3_mode1_vex_vex_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    adapt_vex_num = wb1.cell(row=i,column=2).value
    ...
    rv = subprocess.call(['python dyn_flow3_mode1_vex_vex.py '  f'{tx_vex_num} '  f'{adapt_vex_num} '  f'{v2d_num} '  f'{apb_num} '  f'{drf_clock} '  f'{test_config} ' f'{delay_value} ' ], shell=True)
