...
import subprocess
import time
wb = openpyxl.load_workbook("dyn_flow3_mode1_rcs_vex_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    rv = subprocess.call(['python dyn_flow3_mode1_rcs_vex.py '  f'{tx_vex_num} '  f'{adapt_vex_num} '  f'{v2d_num} '  f'{apb_num} '  f'{drf_clock} '  f'{test_config} ' f'{delay_value} ' ], shell=True)
