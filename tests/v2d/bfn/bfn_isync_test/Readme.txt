...
python3 bfn_isync_test.py <v2d_id> <drf_clock>

v2d_id can be with in the range [0,3]
drf_clock can be with in the range [0,1]

ex: python3 bfn_isync_test.py 0 0
...
The above will generate bfn_isync_test_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done
...
The input combinations will be taken from the bfn_isync_test_list.xlsx file.
