...
# Created Date: March 15 2023
# =============================================================================
# test description : this test checks the V2D delayed QUAD start feature for
#                    Ch0 only scenario for DRF channels.
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if arg_len != 5:
    ...
    print("python flow1_Ch0.py <quad_instance> <drf_clock> <sys_rate> <delay_value>\n")
...
V2D.sys_rate_check(param[1], param[2])
