...
# =============================================================================
# test description : this test validates the QUAD delayed start for
# PDPD + extra terms for all channels in the QUAD
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if arg_len != 6:
    ...
    print("python flow1_Ch0.py <quad_instance> <drf_clock> <test_config> <filter_mode> <delay_value>\n")
