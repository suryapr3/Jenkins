...
python3 flow4_multi_rate.py <quad_instance> <drf_clock> <test_config> <filter_mode> <delay_value>
...
ex: python3 flow4_multi_rate.py 0 0 0 0 768
...
The above will generate flow4_multi_rate_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done in the regression_list_generation.py file.
