...
python3 flow3_multi_rate_timed_trigger.py <quad_instance> <drf_clock> <test_config> <filter_mode> <delay_value>
...
ex: python3 flow3_multi_rate_timed_trigger.py 0 0 0 0 768
...
The above will generate flow3_multi_rate_timed_trigger_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done
in the regression_list_generation.py file..


Steps to run regression:
-------------------------------------------------------------------------------------------------------------------------------------------------------
python3 flow3_multi_rate_timed_trigger_regression.py

The above will run all the possible combination which was mentioned at the first step.
The input combinations will be taken from the flow3_multi_rate_timed_trigger_list.xlsx file.
