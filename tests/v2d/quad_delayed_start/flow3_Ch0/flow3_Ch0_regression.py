...
import subprocess
import time
wb = openpyxl.load_workbook("flow3_Ch0_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    subprocess.call(['python flow3_Ch0.py '  f'{quad_instance} '  f'{drf_clock} ' f'{test_config} ' f'{filter_mode} ' f'{delay_value} '], shell=True)
