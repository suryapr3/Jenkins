...
# =============================================================================
# test description : this test checks the V2D quad delayed start for PDPD Ch0
#                    in the given quad.
# =============================================================================
# Import statements
# =============================================================================
...
if arg_len != 6:
    ...
    print("python flow3_Ch0.py <quad_instance> <drf_clock> <test_config> <filter_mode> <delay_value>\n")
