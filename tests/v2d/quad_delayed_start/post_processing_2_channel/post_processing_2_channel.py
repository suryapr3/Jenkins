...
# =============================================================================
# test description : this test checks the QUAD delayed start for post processing
#   with single channel enable in the QUAD.
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if arg_len != 6:
    ...
    print("python post_processing_2channel.py <quad_instance> <apb_num> <drf_clock> <test_config> <delay_value>\n")
...
V2D.apb_id_check(param[1])
V2D.drf_clock_check(param[2])
V2D.test_config_check(param[3])
