...
python3 post_processing_2_channel.py <quad_instance> <apb_num> <drf_clock> <test_config> <delay_value>
...
ex: python3 post_processing_2_channel.py 0 0 0 0 768
...
The above will generate post_processing_2_channel_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done in the regression_list_generation.py file.

Steps to run regression:
-------------------------------------------------------------------------------------------------------------------------------------------------------
python3 post_processing_2_channel_regression.py

The above will run all the possible combination which was mentioned at the first step.
The input combinations will be taken from the post_processing_2_channel_list.xlsx file.
