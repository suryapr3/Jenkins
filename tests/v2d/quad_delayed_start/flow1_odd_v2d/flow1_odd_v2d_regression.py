...
import subprocess
import time
wb = openpyxl.load_workbook("flow1_odd_v2d_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    subprocess.call(['python flow1_odd_v2d.py '  f'{quad_instance} ' f'{apb_num} ' f'{drf_clock} ' f'{sys_rate} ' f'{delay_value} '], shell=True)
