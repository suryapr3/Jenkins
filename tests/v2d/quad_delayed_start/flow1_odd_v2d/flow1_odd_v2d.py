...
# =============================================================================
# test description : this test checks the QUAD delayed start feature for ODD V2D
# alone.
# =============================================================================
# Import statements
# =============================================================================
...
if arg_len != 6:
    ...
    print("python flow1_odd_v2d.py <quad_instance> <apb_num> <drf_clock> <sys_rate> <delay_value>\n")
...
V2D.sys_rate_check(param[2], param[3])
