 ...
 * @details 1. This TC validates the Post Processing path with QUAD deayed start for single channel
 *              in the given QUAD.
...
int main(int argc, const char *argv[])
{
    ...
    v2d_num = g_v2d_instance_in_quad[quad_instance][0]; // only even V2D
    ...
    printf("BFN triggered when PDPD Buffer is @0x%x", fill_level_value[0]);
    ...
    printf("BFN triggered when Tx Buffer is @0x%x", fill_level_value[0]);
