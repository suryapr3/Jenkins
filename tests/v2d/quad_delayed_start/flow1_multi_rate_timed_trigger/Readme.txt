...
python3 flow1_multi_rate_timed_trigger.py <tx_vex_id> <rx_vex_id> <v2d_id> <apb_id> <drf_clock> <test_config>
...
test_config can be with in the range [0,3]
...
The above will generate flow1_multi_rate_timed_trigger.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done in the regression_list_generation.py file.


Steps to run regression:
-------------------------------------------------------------------------------------------------------------------------------------------------------
python3 flow1_multi_rate_timed_trigger_regression.py

The above will run all the possible combination which was mentioned at the first step.
The input combinations will be taken from the flow1_multi_rate_timed_trigger.xlsx file.
