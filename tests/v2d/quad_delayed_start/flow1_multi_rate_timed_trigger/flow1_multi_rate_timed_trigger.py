...
# =============================================================================
# test description : this test checks QUAD delayedd start for a given QUAD for
# DRF channels.
# =============================================================================
# Import statements
# =============================================================================
...
if arg_len != 5:
    ...
    print("python flow1_multi_rate_timed_trigger.py <quad_instance> <drf_clock> <sys_rate> <delay_value>\n")
