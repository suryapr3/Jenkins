 ...
 *********************************************************************************************/
/**
 * @file    vex_flow1_tx_8iq.c
 * @brief   Vex FW code to validate V2D Path A.
 * @details 1. VEX will be sending the data continuosly with required number of vectors for every
 *          512 clock cycles untill there is an indication to stop the data transfer.
**/
...
volatile int AT(0x14) g_host_cycle_count;
