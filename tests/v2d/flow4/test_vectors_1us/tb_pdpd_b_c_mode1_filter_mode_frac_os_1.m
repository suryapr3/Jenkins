...
fileId = fopen("ref_output_filter_mode_frac_os_1.txt","w");

while global_input_index < 16385
    data_in_i(global_input_index) = data_value;
    data_in_q(global_input_index) = data_value + 2;
    ...
    %data will repeat for every 5K samples.
    if data_value >= 5124
        data_value = 0;
    end
