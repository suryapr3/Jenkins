...
/* Set Tx_CFG_COMPLETE (23) to 1 , PD_EXTRA_EN(16) to 1, TX_PD_ARB_MODE (8) to 2 and HBI_ARB_MODE (0) to 2*/
#define TX_GNRL_CSR_VALUE   ((1 << 23) | (1 << 16))
/* RX_CFG_COMPLETE (0) to 1*/
#define RX_GNRL_CSR_VALUE   (1 << 0)
#define GMP_C_I_VALUE  ((1 << 8) - 1)
#define GMP_C_Q_VALUE  0
#define DDR_C_I_VALUE   0
#define DDR_C_Q_VALUE   0

/* EXTRA DELAY and PASSTHRU DELAY should be same */
#define FLOW4_PASSTHRU_DELAY  10
#define FLOW4_EXTRA_DELAY FLOW4_PASSTHRU_DELAY
#define FLOW4_GMP_SHIFT_VALUE   0
#define FLOW4_DDR_SHIFT_VALUE   0
...
#define V2D_INTERRUPT_VALUE AV2D_CSR_INT_CSR_INT_STAT_PD_MAIN_UNDERRUN_BF_MSK  | AV2D_CSR_INT_CSR_INT_STAT_PD_EXTRA_UNDERRUN_BF_MSK
