...
import subprocess
import time
wb = openpyxl.load_workbook("flow4_Ch0_Ch1_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    subprocess.call(['python flow4_Ch0_Ch1.py '  f'{tx0_vex_num} '  f'{rx0_vex_num} ' f'{tx1_vex_num} ' f'{rx1_vex_num} ' f'{v2d_num} '  f'{drf_clock} ' f'{test_config} ' f'{post_filter_mode} '], shell=True)
