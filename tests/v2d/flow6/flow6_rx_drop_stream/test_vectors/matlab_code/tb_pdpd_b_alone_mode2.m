...
data_in_i = zeros( 24576, 1);
data_in_q = zeros( 24576, 1);


% ----- Extra Terms

xtra_in_i = zeros(24576, 1 );
xtra_in_q = zeros(24576, 1 );
...
fileId1 = fopen("ref_output_4gsps.txt","w");
...
for blc_cnt = 0:8  %max blocks this value should be 64 , 32, 16, 8, 4 for p5, 1IQ, 2IQ, 4IQ and 8IQ rates
    i_add = i_add + 0x0001;
    j_add = j_add + 0x0002;
