...
import subprocess
import time
wb = openpyxl.load_workbook("flow6_rx_drop_stream_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    subprocess.call(['python flow6_rx_drop_stream.py '  f'{tx_vex_num} '  f'{rx_vex_num} ' f'{v2d_num} '  f'{apb_num} '  f'{drf_clock} ' f'{test_config} '], shell=True)
