...
# =============================================================================
# test description : this test checks the V2D PDPD loop back with GMP and DDR
#                    coeffecients.
# =============================================================================
# Import statements
# =============================================================================
...
if arg_len != 7:
    ...
    print("python flow6_mode1.py <tx_vex_id> <rx_vex_id> <v2d_id> <apb_id> <drf_clock> <test_config>\n")
