...
python3 flow6_mode1.py <tx_vex_id> <rx_vex_id> <v2d_id> <apb_id> <drf_clock> <test_config>
...
ex: python3 flow6_mode1.py 0 1 0 0 0 0
...
The above will generate flow6_mode1_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done
...
The input combinations will be taken from the flow6_mode1_list.xlsx file.
