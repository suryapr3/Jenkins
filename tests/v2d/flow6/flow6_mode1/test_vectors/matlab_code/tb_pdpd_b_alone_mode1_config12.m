...
for blc_cnt = 0:8  %max blocks this value should be 32 , 16, 8, 4, 2 for p5, 1IQ, 2IQ, 4IQ and 8IQ rates
    i_add = i_add + 0x0000;
    j_add = j_add + 0x0000;
    for i = 0:63 % vectors per block this value should be 8, 16, 32, 64, 128 for p5, 1IQ, 2IQ, 4IQ and 8IQ rates
        for j = 0:31
...
for blc_cnt = 0:8  %max blocks this value should be 32 , 16, 8, 4, 2 for p5, 1IQ, 2IQ, 4IQ and 8IQ rates
    for i = 0:31    % vectors per block this value should be 8, 16, 32, 64, 128 for p5, 1IQ, 2IQ, 4IQ and 8IQ rates
        for j = 0:31
