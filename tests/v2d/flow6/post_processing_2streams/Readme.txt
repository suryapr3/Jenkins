...
python post_processing_2streams.py <vex_tx_b> <vex_rx0_d> <vex_rx1_d> <vex_rx_f> <v2d_id> <apb_id> <drf_clock> <test_config>
...
ex: python3 post_processing_2streams.py 0 1 8 9 0 0 0 0

Note: This information is for the FPGA model ABC_18A_0p5_R1.0
      None of the VEX ID's should be same.

Steps to create regression excel list (one time):
-------------------------------------------------------------------------------------------------------------------------------------------------------
python3 regression_list_generation.py

The above will generate post_proceessing_2streams_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done
in the regression_list_generation.py file..


Steps to run regression:
-------------------------------------------------------------------------------------------------------------------------------------------------------
python3 post_proceessing_2streams_regression.py
