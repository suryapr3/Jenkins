...
# Created Date: Feb 09 2024
# =============================================================================
# test description : this test validates the post processing in two vex cores.
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if arg_len != 9:
    ...
    print("python post_processing_2streams.py <vex_tx_b> <vex_rx0_d> <vex_rx1_d> <vex_rx_f> <v2d_id> <apb_id> <drf_clock> <test_config>\n")
    print("As there were no inputs provided executing with below parameters\n")
    print(" vex_tx_b: 0\n vex_rx_d0: 1\n vex_rx_d1: 8 vex_rx_f: 9\n v2d_id : 0\n apb_id : 0\n drf_clock: 0\n test_config : 0\n")
...
V2D.drf_clock_check(param[6])
V2D.test_config_check(param[7])
