...
int hrt_main(int argc, char **argv)
{
    ...
    hrt_scalar_store(VE00, uint, v2d_flow6_tx_g_num_blocks, 0);
    hrt_scalar_store(VE00, uint, v2d_flow6_tx_g_tx_instance, 0);
    hrt_scalar_store(VE00, uint, v2d_flow6_tx_g_initial_block_size, 1);
    ...
    hrt_scalar_store(VE01, uint, v2d_flow6_rx_g_tokens_per_block, 1);
