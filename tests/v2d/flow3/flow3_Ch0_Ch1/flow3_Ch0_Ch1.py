...
# Created Date: Jan 8 2024
# =============================================================================
# test description : this test checks the V2D B alone path with GMP terms
#                    enabled for both the channels.
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if arg_len != 9:
    ...
    print("python flow3_Ch0_Ch1.py <tx0_vex_id> <rx0_vex_id> <tx1_vex_id> <rx1_vex_id> <v2d_id> <drf_clock> <test_config> <filter_mode>\n")
    print("As there were no inputs provided executing with below parameters\n")
    print(" tx0_vex_id : 0\n rx0_vex_id : 1\n tx1_vex_id: 8\n rx1_vex_id: 9\n v2d_id : 0\n drf_clock: 0\n test_config : 0\n filter_mode : 0")
    param = [0, 1, 8, 9, 0, 0, 0, 0]
else:
...
V2D.drf_clock_check(param[5])
V2D.test_config_check(param[6])
V2D.filter_mode_check(param[7])
