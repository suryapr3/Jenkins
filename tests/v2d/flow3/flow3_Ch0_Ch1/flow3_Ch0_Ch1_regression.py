...
import subprocess
import time
wb = openpyxl.load_workbook("flow3_Ch0_Ch1_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    post_filter_mode = wb1.cell(row=i,column=8).value
    subprocess.call(['python flow3_Ch0_Ch1.py '  f'{tx0_vex_num} '  f'{rx0_vex_num} ' f'{tx1_vex_num} ' f'{rx1_vex_num} ' f'{v2d_num} '  f'{drf_clock} ' f'{test_config} ' f'{post_filter_mode} '], shell=True)
