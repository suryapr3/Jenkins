...
python3 flow3_coeff_vex_mode1_mode2.py <tx_vex> <rx_vex> <v2d_num> <apb_num> <drf_clock> <test_config>
...
ex: python3 flow3_coeff_vex_mode1_mode2.py 0 1 0 0 0 0
...
The above will generate flow3_coeff_vex_mode1_mode2_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done in the regression_list_generation.py file.
...
The input combinations will be taken from the flow3_coeff_vex_mode1_mode2_list.xlsx file.
