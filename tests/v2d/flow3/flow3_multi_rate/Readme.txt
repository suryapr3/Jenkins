...
-------------------------------------------------------------------------------------------------------------------------------------------------------
1. gmake clean; gmake (create the .so file)

2. To create executable for 1US granularity

    gmake clean; gmake VEX_1US_WINDOW=1

Steps to run individual TC:
-------------------------------------------------------------------------------------------------------------------------------------------------------
This script will take 7 arguments and script should be run in below format

python3 flow3_multi_rate.py <tx_vex_id> <rx_vex_id> <v2d_id> <apb_id> <drf_clock> <test_config> <filter_mode>
...
ex: python3 flow3_multi_rate.py 0 1 0 0 0 0 0
...
The above will generate flow3_multi_rate_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done
