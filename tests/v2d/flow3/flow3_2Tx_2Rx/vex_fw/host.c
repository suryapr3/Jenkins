...
#define NUMBER_OF_VECTORS_OUT 256 // Corresponds to 3 blocks of data for 8GSPS
...
int hrt_main(int argc, char **argv)
{
    ...
    hrt_scalar_store(VE00, uint, v2d_flow3_tx_g_tx_instance, 0);
    hrt_scalar_store(VE00, uint, v2d_flow3_tx_g_initial_block_size, 1);
    hrt_scalar_store(VE00, uint, v2d_flow3_tx_g_host_cycle_count, 511);
    ...
    hrt_scalar_store(VE01, uint, v2d_flow3_rx_g_tokens_per_block, 1);
