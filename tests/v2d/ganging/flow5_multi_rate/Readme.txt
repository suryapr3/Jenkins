...
python3 flow5_multi_rate.py <tx_b_vex_id> <tx_c_vex_id> <rx_vex_id> <v2d_id> <drf_clock> <test_config>
...
ex: python3 flow5_multi_rate.py 0 1 8 0 0 0

Note: This information is for the FPGA model ABC_18A_0p5_R1.0
None of the VEX_ID's should be equal
