%Same code will work for config 13 and config 7
...
fileId1 = fopen("ref_output_config13.txt","w");
...
for blc_cnt = 0:16  %max blocks this value should be 32 , 16, 8, 4, 2 for p5, 1IQ, 2IQ, 4IQ and 8IQ rates
    for i = 0:15    % vectors per block this value should be 8, 16, 32, 64, 128 for p5, 1IQ, 2IQ, 4IQ and 8IQ rates
        for j = 0:31
