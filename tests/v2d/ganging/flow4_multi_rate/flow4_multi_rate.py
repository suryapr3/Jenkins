...
# Created Date: Jan 31 2024
# =============================================================================
# test description : this test checks the V2D B +C path with GMP terms
#                    enabled in ganging mode (DGE).
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if arg_len != 7:
    ...
    print("python flow4_multi_rate.py <tx_vex_id> <rx_vex_id> <v2d_id> <drf_clock> <test_config> <filter_mode>\n")
