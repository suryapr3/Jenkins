...
import subprocess
import time
wb = openpyxl.load_workbook("underrun_handling_cm1_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    rv = subprocess.call(['python underrun_handling_cm1.py '  f'{tx_vex_num} '  f'{rx_vex_num} '  f'{v2d_num} '  f'{apb_num} '  f'{drf_clock} '  f'{test_config} '], shell=True)
