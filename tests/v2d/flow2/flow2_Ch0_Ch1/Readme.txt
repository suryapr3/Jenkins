...
python3 flow2_Ch0_Ch1.py <tx0_vex_id> <rx0_vex_id> <tx1_vex_id> <rx1_vex_id> <v2d_id> <drf_clock> <test_config>
...
ex: python3 flow2_Ch0_Ch1.py 0 1 8 9 0 0 0
...
The above will generate flow2_Ch0_Ch1_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done
...
The input combinations will be taken from the flow2_Ch0_Ch1_list.xlsx file.
