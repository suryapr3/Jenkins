...
import subprocess
import time
wb = openpyxl.load_workbook("flow2_2Tx_1Rx_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    subprocess.call(['python flow2_2Tx_1Rx.py '  f'{tx0_vex_num} '  f'{rx0_vex_num} ' f'{tx1_vex_num} ' f'{v2d_num} '  f'{apb_num} '  f'{split_method} ' f'{drf_clock} ' f'{test_config} '], shell=True)
