...
python3 flow1_2Tx_1Rx.py <tx0_vex_id> <rx_vex_id> <tx1_vex_id> <v2d_id> <apb_id> <split_method> <drf_clock> <test_config>
...
test_config should be between [1, 16] (greater than equal to 1GSPS)
...
ex: python3 flow2_2Tx_1Rx.py 0 1 8 0 0 0 0 4
...
The above will generate flow2_2Tx_1Rx_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done
...
The input combinations will be taken from the flow2_2Tx_1Rx_list.xlsx file.
