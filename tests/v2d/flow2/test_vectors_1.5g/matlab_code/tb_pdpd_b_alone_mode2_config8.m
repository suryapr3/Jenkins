...
fileId1 = fopen("ref_output_config8.txt","w");
...
for blc_cnt = 0:3  %max blocks this value should be 32 , 16, 8, 4, 2 for p5, 1IQ, 2IQ, 4IQ and 8IQ rates
    i_add = i_add + 0x0000;
    j_add = j_add + 0x0000;
...
for blc_cnt = 0:1  %max blocks this value should be 32 , 16, 8, 4, 2 for p5, 1IQ, 2IQ, 4IQ and 8IQ rates
    for i = 0:95    % vectors per block this value should be 11, 23, 47, 95, 191 for p5, 1IQ, 2IQ, 4IQ and 8IQ rates
        for j = 0:31
