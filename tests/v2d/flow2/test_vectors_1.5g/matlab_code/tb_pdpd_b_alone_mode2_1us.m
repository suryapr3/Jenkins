...
data_in_i = zeros( 18432, 1);
data_in_q = zeros( 18432, 1);


% ----- Extra Terms

xtra_in_i = zeros(18432, 1 );
xtra_in_q = zeros(18432, 1 );
...
fileId1 = fopen("ref_output_1gsps.txt","w");
...
for blc_cnt = 0:2  %max blocks this value should be 2 for p5, 1IQ, 2IQ, 4IQ and 8IQ rates
    i_add = i_add + 0x0000;
    j_add = j_add + 0x0000;
