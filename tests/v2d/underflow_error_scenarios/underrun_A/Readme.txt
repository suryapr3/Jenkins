...
python3 underrun_A.py <tx_vex_id> <rx_vex_id> <v2d_id> <apb_id> <drf_clock> <sys_rate>
...
The above will generate underrun_A_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done in the regression_list_generation.py file.
...
The input combinations will be taken from the underrun_A_list.xlsx file.
