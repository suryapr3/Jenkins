...
# Created Date: July 7 2023
# =============================================================================
# test description : this test checks the V2D Buffer B with A Underflow status
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if arg_len != 5:
    ...
    print("python underrun_B_with_A.py <vex_id> <v2d_id> <apb_id> <pdpd_rate>\n")
...
if not (param[1] >= 0 and param[1] <= 3):
    print("provided v2d_num is not with in the range, v2d_num should be in the range [0,3]\n")
    sys.exit("proper input parameters were not provided\n")
