 ...
 * @details 1. VEX will be sending the single block (g_num_vecs) per 512 cycles in a continuous manner.
 *          2. With host indication VEX will stop the transmission and store the number of blocks
 *             transferred to a pre-defined location.
**/
