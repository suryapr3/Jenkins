 ...
 *             sending 1 and 2  block of samples respectively
   ...
   @TC Description:
        1. One block and 2 blocks of data (0.5usec worth) for given data rate will be streamed to V2D Tx from
           configured VEX cores for path C and path B respectively.
...
int main(int argc, const char *argv[])
{
    ...
    unsigned int v2d_flow4_tx_c_args_val[] = {0x00120014, NUMBER_OF_VECTORS_INPUT, 0, 1, 0};    // Initial block size is 1 for C path
    ...
    unsigned int v2d_flow4_tx_b_args_val[] = {0x00120014, NUMBER_OF_VECTORS_INPUT, 0, 2, 0};    // Initial block size is 2 for B path
