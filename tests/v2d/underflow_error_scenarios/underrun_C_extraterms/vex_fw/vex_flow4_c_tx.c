 ...
 * @return          none
 */
void v2d_flow4_tx_c() ENTRY
{
    int i, j, offset =0;
    g_host_debug = 0;
    int b_dest_address = g_dest_buffer_base;
    ...
    for (j = 0; j < g_initial_block_size; j++)
    {
        ...
        for(i = 0; i < iter_max; i++)
        {
            ...
            v_xstomi_1024(Any, b_dest_address, offset, LD_OFFSET_MAX, vout, offset);
    ...
    for (; j < (g_initial_block_size + 1); j++)
    {
        vec32i32 vin2;
