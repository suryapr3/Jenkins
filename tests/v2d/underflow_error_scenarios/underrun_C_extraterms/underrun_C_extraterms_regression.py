...
import subprocess
import time
wb = openpyxl.load_workbook("underrun_C_extraterms_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    rv = subprocess.call(['python underrun_C_extraterms.py '  f'{vex_num0} '  f'{vex_num1} ' f'{v2d_num} '  f'{apb_num} ' f'{pdpd_rate} '], shell=True)
