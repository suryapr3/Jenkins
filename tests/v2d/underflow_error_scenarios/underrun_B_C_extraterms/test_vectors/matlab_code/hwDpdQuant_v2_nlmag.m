function y = hwDpdQuant_v2_nlmag(termParams, T, N, r, nlmag_en, lutN, lutC, lutS, x, xtra, enQuant)
...
if enQuant
    ...
    for n = nStart+1: nX+nEnd
        ...
        %y(n) = rx + gbsAccQ;
        y(n) = rx + gbsAccQ + xtra(n);
        Qu = Q.y; Qu.data = y(n);
        y(n) = quantCpx(Qu.msb,Qu.lsb,Qu.data,Qu.disErr,Qu.sim,Qu.enable);
    end
