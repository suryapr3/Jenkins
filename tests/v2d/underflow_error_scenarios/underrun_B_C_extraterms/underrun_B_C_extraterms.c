...
int main(int argc, const char *argv[])
{
    ...
    unsigned int v2d_flow4_tx_c_args_val[] = {0x00120014, NUMBER_OF_VECTORS_INPUT, 0, 1, 0};
    ...
    unsigned int v2d_flow4_tx_b_args_val[] = {0x00120014, NUMBER_OF_VECTORS_INPUT, 0, 1, 0};
