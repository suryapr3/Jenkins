function [pdpd_out_i, pdpd_out_q] = pdpd_wrap(term_types, q_dly, m_dly, passthru_dly, ...
         ...
         data_in_i, data_in_q, xtra_in_i, xtra_in_q )
  ...
  %lut_d = (lut_c_i(:,2:65) + 1i*lut_c_q(:,2:65)) / 2^12;
  lut_d = lut_c(1:48,2:65) - lut_c(1:48,1:64);
  ...
  y = hwDpdQuant_v2_nlmag( termParams, T, N, r, nlmag_en, lut_n, lut_c, lut_s, input_data, extra_data, enQuant );
