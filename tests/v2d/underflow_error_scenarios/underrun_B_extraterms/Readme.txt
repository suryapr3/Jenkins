...
python3 underrun_B_extraterms.py <vex_id1> <vex_id2> <v2d_id> <apb_id> <sys_rate>
...
ex: python3 underrun_B_extraterms.py 0 8 0 0 4
...
The above will generate underrun_B_extraterms_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done
...
The input combinations will be taken from the underrun_B_extraterms_list.xlsx file.
