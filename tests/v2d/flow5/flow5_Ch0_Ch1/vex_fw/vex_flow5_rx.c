...
void v2d_flow5_rx() ENTRY
{
    ...
    while (count < (g_num_blocks))
    {
        ...
        add_temp = add_temp + g_add_val_out;
...
//#pragma hive force_unroll=4
        ...
        for (int i = 0; i < (iter_max / 2); i++)
        {
          ...
          v_ldoi_2048(Any, vbuffer, ld_offset, vdata0, vdata1, ld_offset) NO_ALIAS SYNC(buffer_read);
          ...
          v_ldoi_2048_circ(Any, vex_dest_buffer, compare_offset, limit, rewind, vout0, vout1, compare_offset);
