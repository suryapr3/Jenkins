 ...
 * @return          status
 */
int flow5_configure_pdpd(int v2d_num, int apb_num, int test_config)
{
    int rv = 0;
    ...
    if (rv = pdpd_config_reg_config(v2d_num, apb_num, FLOW5_PASSTHRU_DELAY, pdpd_out_rate))
    {
    ...
    if (rv = pdpd_extra_static_reg_config(v2d_num, apb_num, FLOW5_EXTRA_DELAY))
    {
...
int pdpd_gmp_ddr_reg_config_p5_1_2(int v2d_num, int apb_num)
{
    ...
    /* GMP Static */
    if (rv = pdpd_gmp_static_config_p5_1_2(v2d_num, apb_num, num_gmp_terms, FLOW5_PASSTHRU_DELAY))
    {
    ...
    if (rv = pdpd_gmp_dynamic_shdw_gmp_shift_shdw_reg_config_p5_1_2(v2d_num, apb_num, num_gmp_terms, FLOW5_GMP_SHIFT_VALUE))
    {
        printf("ERROR:GMP_DYNAMIC_SHDW_GMP_SHIFT_LIVE_REG_CONFIG failed\n");
        return rv;
    }
    /* DDR STATIC */
    if (rv = pdpd_ddr_static_config_p5_1_2(v2d_num, apb_num, num_ddr_terms, FLOW5_PASSTHRU_DELAY))
    {
    ...
    if (rv = pdpd_ddr_dynamic_shdw_ddr_shift_shdw_reg_config_p5_1_2(v2d_num, apb_num, num_ddr_terms, FLOW5_DDR_SHIFT_VALUE))
    {
...
int pdpd_gmp_ddr_reg_config_iq_4(int v2d_num, int apb_num, pdpd_rate_t pdpd_in_rate)
{
    ...
    /* GMP Static */
    if (rv = pdpd_gmp_static_config_iq_4(v2d_num, apb_num, num_gmp_terms, FLOW5_PASSTHRU_DELAY, pdpd_in_rate))
    {
        printf("ERROR:GMP STATIC_CONFIG failed\n");
        return rv;
    }
    ...
    if (rv = pdpd_gmp_dynamic_shdw_gmp_shift_shdw_reg_config_iq_4(v2d_num, apb_num, num_gmp_terms, FLOW5_GMP_SHIFT_VALUE))
    {
        printf("ERROR:GMP_DYNAMIC_SHDW_GMP_SHIFT_LIVE_REG_CONFIG failed\n");
        return rv;
    }
    ...
    /* DDR STATIC */
    if (rv = pdpd_ddr_static_config_iq_4(v2d_num, apb_num, num_ddr_terms, FLOW5_PASSTHRU_DELAY, pdpd_in_rate))
    {
        printf("ERROR:DDR_STATIC_CONFIG failed\n");
        return rv;
    }
    ...
    if (rv = pdpd_ddr_dynamic_shdw_ddr_shift_shdw_reg_config_iq_4(v2d_num, apb_num, num_ddr_terms, FLOW5_DDR_SHIFT_VALUE))
    {
        printf("ERROR:DDR_DYNAMIC_SHDW_DDR_SHIFT_LIVE_REG_CONFIG failed\n");
        return rv;
    }
...
int pdpd_gmp_ddr_reg_config_iq_8(int v2d_num, int apb_num)
{
    ...
    /* GMP Static */
    if (rv = pdpd_gmp_static_config_iq_8(v2d_num, apb_num, num_gmp_terms, FLOW5_PASSTHRU_DELAY))
    {
        printf("ERROR:GMP STATIC_CONFIG failed\n");
        return rv;
    }
    ...
    if (rv = pdpd_gmp_dynamic_shdw_gmp_shift_shdw_reg_config_iq_8(v2d_num, apb_num, num_gmp_terms, FLOW5_GMP_SHIFT_VALUE))
    {
        printf("ERROR:GMP_DYNAMIC_SHDW_GMP_SHIFT_LIVE_REG_CONFIG failed\n");
        return rv;
    }
    ...
    /* DDR STATIC */
    if (rv = pdpd_ddr_static_config_iq_8(v2d_num, apb_num, num_ddr_terms, FLOW5_PASSTHRU_DELAY))
    {
        printf("ERROR:DDR_STATIC_CONFIG failed\n");
        return rv;
    }
    ...
    if (rv = pdpd_ddr_dynamic_shdw_ddr_shift_shdw_reg_config_iq_8(v2d_num, apb_num, num_ddr_terms, FLOW5_DDR_SHIFT_VALUE))
    {
        printf("ERROR:DDR_DYNAMIC_SHDW_DDR_SHIFT_LIVE_REG_CONFIG failed\n");
        return rv;
    }
