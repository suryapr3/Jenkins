...
# =============================================================================
# test description : this test checks the V2D DPD HW + Extra terms from 2 vex
# cores use case
# =============================================================================
# Import statements
# =============================================================================
...
if arg_len != 8:
    ...
    print("python flow5_multi_rate.py <tx1_vex_id> <tx2_vex_id> <rx_vex_id> <v2d_id> <apb_id> <drf_clock> <test_config>\n")
