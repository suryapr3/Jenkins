...
#define LD_CTL1 ((2 * BYTES_PER_VEC << 20) | ((VEX_DEST_BUF_SIZE_BYTES) - (2 * BYTES_PER_VEC)))
#define LD_CTL2 (VEX_DEST_BUF_SIZE_BYTES) - (2 * BYTES_PER_VEC)
#define LD_OFFSET_MAX   255
