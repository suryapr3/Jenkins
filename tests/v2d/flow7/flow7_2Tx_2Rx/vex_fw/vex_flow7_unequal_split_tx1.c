 ...
 *********************************************************************************************/
/**
 * @file    vex_flow2_unequal_split_tx1.c
 * @brief   Vex FW code to validate V2D Path C.
...
volatile int AT(0x20) g_tx_instance;
volatile int AT(0x1C) g_initial_block_size;
 ...
 * @return          none
 */
void v2d_flow7_unequal_split_tx1() ENTRY
{
    int i, j = 0, offset =0;
    g_host_debug = 0;
