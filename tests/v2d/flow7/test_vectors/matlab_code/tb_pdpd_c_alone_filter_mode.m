...
fileId = fopen("ref_output_p5gsps_mode1.txt","w");
fileId1 = fopen("ref_output_p5gsps_filter_mode.txt","w");
...
for blc_cnt = 0:32  %max blocks this value should be 32 , 16, 8, 4, 2 for p5, 1IQ, 2IQ, 4IQ and 8IQ rates
    i_add = i_add + 0x0001;
    j_add = j_add + 0x0002;
...
post_c(1:17) = 100;
%post_c(10:13) = 100;
post_c(9) = 1023; % Set center tap to ~1 to get a virtual passthru
