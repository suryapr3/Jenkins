...
//#pragma hive force_unroll=4
        ...
        for (int i = 0; i < iter_max; i++)
        {
          ...
          v_ldoi_1024_circ(Any, vex_dest_buffer ,compare_offset, limit, rewind, vout, compare_offset);
...
//              g_host_debug = sout0;
//              g_host_debug1 = i;
                V_GET_32(8,vout,g_host_debug);
                V_GET_32(8,vadd,g_host_debug1);
          }
#endif
          vec_processed++;
