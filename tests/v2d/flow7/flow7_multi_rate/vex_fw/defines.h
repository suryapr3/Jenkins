...
#define LD_CTL1 ((BYTES_PER_VEC << 20) | ((VEC_TO_BYTE((VEX_VMEM_SIZE / 2))) - (BYTES_PER_VEC)))
#define LD_CTL2 (VEC_TO_BYTE((VEX_VMEM_SIZE / 2))) - BYTES_PER_VEC
...
#define VEX_VMEM_SIZE   512 // in Vectors
#define VEC_TO_BYTE(x)  (x * BYTES_PER_VEC)
