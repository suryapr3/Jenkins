...
# =============================================================================
# test description : this test checks the connectivity between V2D to VEX cores
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if dut_preconfig == 1:
    ...
    for vex_id in v2d_0_valid_vex_list:
        for port_num in range(4):
            logger.info(my_functions.main(vex_id, 0, port_num, param[0]))
            logger.info(my_functions.rte_deinit())

    for vex_id in v2d_1_valid_vex_list:
        for port_num in range(4):
            logger.info(my_functions.main(vex_id, 1, port_num, param[0]))
            logger.info(my_functions.rte_deinit())

    for vex_id in v2d_2_valid_vex_list:
        for port_num in range(4):
            logger.info(my_functions.main(vex_id, 2, port_num, param[0]))
            logger.info(my_functions.rte_deinit())

    for vex_id in v2d_3_valid_vex_list:
        for port_num in range(4):
            logger.info(my_functions.main(vex_id, 3, port_num, param[0]))
            logger.info(my_functions.rte_deinit())
