...
#define VEX_DEST_BUF_SIZE 16 // In vectors
#define VEX_IN_BUF_SIZE 8 // In vectors
...
#define LD_OFFSET_MAX   639

#define SRC_PATTERN_ADDR 0
#define REF_PATTERN_ADDR 0x500
#define OUTPUT_VMEM_LOCATION    0x6000
