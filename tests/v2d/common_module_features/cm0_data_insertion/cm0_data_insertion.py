...
# =============================================================================
# test description : this test checks the Data insertion feature of CM0
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if arg_len != 7:
    ...
    print("python cm0_data_insertion.py <tx_vex_id> <rx_vex_id> <v2d_id> <apb_id> <drf_clock> <sys_rate>\n")
