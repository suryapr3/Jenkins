...
import subprocess
import time
wb = openpyxl.load_workbook("cm1_data_insertion_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    subprocess.call(['python cm1_data_insertion.py '  f'{tx_vex_num} '  f'{rx_vex_num} ' f'{v2d_num} '  f'{apb_num} '  f'{drf_clock} ' f'{test_config} '], shell=True)
