...
wa = wb.active
header = ["tx0_vex_id", "rx0_vex_id", "tx1_vex_id", "rx1_vex_id", "v2d_id", "apb_id", "split_method", "drf_clock","sys_rate"]
row = 1
...
sys_rate_list = [4, 5, 6, 7, 8, 9, 10, 21, 22, 23, 24, 25, 26]
...
sheet_name= wb['Sheet']
sheet_name.title ='cm0_data_drop_2streams'

wb.save("cm0_data_drop_2streams_list.xlsx")
