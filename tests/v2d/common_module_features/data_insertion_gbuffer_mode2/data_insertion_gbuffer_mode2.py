...
# =============================================================================
# test description : this test checks the data insertion feature on CM1 when
#                    stream0 is in insertion state and sending the G Buffer update
#                    on stream 5.
# =============================================================================
# Import statements
# =============================================================================
...
if arg_len != 8:
    ...
    print("python data_insertion_gbuffer_mode2.py <tx_vex_id> <tx_gbuffer_vex_id> <rx_vex_id> <v2d_id> <apb_id> <drf_clock> <test_config>\n")
...
if (param[0] == param[1]) or (param[0] == param[1]) or (param[0] == param[2]) or (param[1] == param[2]):
