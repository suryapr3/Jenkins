...
import subprocess
import time
wb = openpyxl.load_workbook("data_insertion_gbuffer_mode2_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    subprocess.call(['python data_insertion_gbuffer_mode2.py '  f'{tx0_vex_num} '  f'{tx_gbuffer_vex_num} ' f'{rx0_vex_num} ' f'{v2d_num} '  f'{apb_num} '  f'{drf_clock} ' f'{test_config} '], shell=True)
