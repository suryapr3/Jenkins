...
# Created Date: Jan 24 2024
# =============================================================================
# test description : this test checks the Data insertion for two stream case
#  on CM0
# =============================================================================
# Import statements
# =============================================================================
...
if arg_len != 10:
    ...
    print("python cm0_data_insertion_2streams.py <tx0_vex_id> <rx0_vex_id> <tx1_vex_id> <rx1_vex_id> <v2d_id> <apb_id> <split_method> <drf_clock> <sys_rate>\n")
    print("As there were no inputs provided executing with below parameters\n")
    print(" tx0_vex_id : 0\n  rx0_vex_id : 1\n tx1_vex_id : 8\n rx1_vex_id : 9\n v2d_id : 0\n apb_id : 0\n split_method : 0\n drf_clock : 0\n sys_rate : 10")
    param = [0, 1, 8, 9, 0, 0, 0, 0, 10]
else:
...
if (param[0] == param[1] or param[0] == param[2] or param[0] == param[3] or param[1] == param[2] or param[1] == param[3] or param[2] == param[3]):
    ...
    sys.exit("proper sys_rate was not provided\n")
...
V2D.sys_rate_check(param[7], param[8])
