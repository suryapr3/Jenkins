 ...
 *********************************************************************************************/
/**
 * @file    vex_cm1_data_drop_2streams_unequal_split_tx1.c
 ...
 * @return          none
 */
void cm1_data_drop_2streams_unequal_split_tx1() ENTRY
{
    int i, j = 0, offset =0;
    g_host_debug = 0;
...
#if DEBUG
    OP___printstring("vex_cm1_data_drop_2streams: 3 bloks sent:");
    OP___dump(__LINE__,0xFFFF);
#endif
} // cm1_data_drop_2streams() ends
