...
python3 flow1_Ch0_Ch1_fill_level.py <tx0_vex_id> <rx0_vex_id> <tx1_vex_id> <rx1_vex_id> <v2d_id> <drf_clock> <sys_rate>
...
sys_rate should be [2, 3, 4, 5, 6, 7, 8, 9, 10, 21, 22, 23, 24, 25, 26]
...
ex: python3 flow1_Ch0_Ch1_fill_level.py 0 1 8 9 0 0 10
...
The above will generate flow1_Ch0_Ch1_fill_level_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done
in the regression_list_generation.py file..


Steps to run regression:
-------------------------------------------------------------------------------------------------------------------------------------------------------
python3 flow1_Ch0_Ch1_fill_level_regression.py

The above will run all the possible combination which was mentioned at the first step.
The input combinations will be taken from the flow1_Ch0_Ch1_fill_level_list.xlsx file.
