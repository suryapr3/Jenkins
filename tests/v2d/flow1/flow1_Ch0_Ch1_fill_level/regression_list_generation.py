...
wa = wb.active
header = ["tx0_vex_id", "rx0_vex_id", "tx1_vex_id", "rx1_vex_id", "v2d_id", "drf_clock","sys_rate"]
row = 1
...
sys_rate_list = [2, 3, 4, 5, 6, 7, 8, 9, 10, 21, 22, 23, 24, 25, 26]
...
sheet_name= wb['Sheet']
sheet_name.title ='flow1_Ch0_Ch1_fill_level'
wb.save("flow1_Ch0_Ch1_fill_level_list.xlsx")
