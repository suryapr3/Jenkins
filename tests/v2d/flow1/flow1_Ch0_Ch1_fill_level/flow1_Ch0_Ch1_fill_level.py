...
#!/usr/bin/env python
# =============================================================================
# Created By  : Sai Manideep
# Created Date: Dec 08 2023
# =============================================================================
...
if arg_len != 8:
    ...
    print("python flow1_ch0_ch1_fill_level.py <tx0_vex_id> <rx0_vex_id> <tx1_vex_id> <rx1_vex_id> <v2d_id> <drf_clock> <sys_rate>\n")
    print("As there were no inputs provided executing with below parameters\n")
    print(" tx0_vex_id : 0\n  rx0_vex_id : 1\n tx1_vex_id : 8\n rx1_vex_id : 9\n v2d_id : 0\n drf_clock : 0\n sys_rate : 10")
    param = [0, 1, 8, 9, 0, 0, 10]
else:
...
V2D.sys_rate_check(param[5], param[6])
