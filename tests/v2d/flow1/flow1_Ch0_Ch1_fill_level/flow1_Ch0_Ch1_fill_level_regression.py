...
import subprocess
import time
wb = openpyxl.load_workbook("flow1_Ch0_Ch1_fill_level_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    sys_rate = wb1.cell(row=i,column=7).value
    subprocess.call(['python flow1_Ch0_Ch1_fill_level.py '  f'{tx0_vex_num} '  f'{rx0_vex_num} ' f'{tx1_vex_num} ' f'{rx1_vex_num} ' f'{v2d_num} '  f'{drf_clock} ' f'{sys_rate} '], shell=True)
