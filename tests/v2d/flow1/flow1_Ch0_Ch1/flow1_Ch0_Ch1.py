...
# Created Date: Jun 27 2023
# =============================================================================
# test description : this test checks the flow1 two channel scenario
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if arg_len != 8:
    ...
    print("python flow1_2Tx_2Rx.py <tx0_vex_id> <rx0_vex_id> <tx1_vex_id> <rx1_vex_id> <v2d_id> <drf_clock> <sys_rate>\n")
...
V2D.v2d_bfn_trigger_check(param[4])
