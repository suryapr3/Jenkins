...
int hrt_main(int argc, char **argv)
{
    ...
    hrt_scalar_store(VE00, uint, v2d_flow1_tx_p25_4iq_g_dest_buffer_base, 0x4000);
    hrt_scalar_store(VE00, uint, v2d_flow1_tx_p25_4iq_g_num_blocks, 0);
    hrt_scalar_store(VE00, uint, v2d_flow1_tx_p25_4iq_g_initial_block_size, 2);
