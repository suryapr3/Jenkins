...
int main(int argc, const char *argv[])
{
    ...
    unsigned int add_val[1], buf_status = 0;
   ...
   if ((rv = srp_vex_memid_store(vex_hdl,
    ...
    while (((buf_status = read_reg_18a(PDPD_BASE_ADDR(v2d_num, apb_num) + V2D_CSR_OFFSET + AV2D_CSR_TX_CSR_TX_BUF_STATUS_OFFSET, "V2D_TX_BUF_STATUS")) & 0x1) != 1)
    {
        // do nothing wait until A0 BUF was FULL
