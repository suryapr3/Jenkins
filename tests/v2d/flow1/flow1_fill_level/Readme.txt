...
python3 flow1_fill_level.py <tx_vex_id> <rx_vex_id> <v2d_id> <apb_id> <drf_clock> <sys_rate>
...
sys_rate can be with in the range [2, 3, 4, 5, 6, 7, 8, 9, 10, 21, 22, 23, 24, 25, 25, 26]
...
ex: python3 flow1_fill_level.py 0 1 0 0 0 0
...
The above will generate flow1_fill_level_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done
...
The input combinations will be taken from the flow1_fill_level_list.xlsx file.
