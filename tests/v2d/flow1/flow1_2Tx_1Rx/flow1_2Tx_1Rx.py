...
if arg_len != 9:
    ...
    print("python flow1_2Tx_1Rx.py <tx0_vex_id> <rx_vex_id> <tx1_vex_id> <v2d_id> <apb_id> <split_method> <drf_clock> <sys_rate>\n")
    print("As there were no inputs provided executing with below parameters\n")
    print(" tx0_vex_id : 0\n  rx_vex_id : 1\n tx1_vex_id : 8\n v2d_id : 0\n apb_id : 0\n split_method : 0\n drf_clock : 0\n sys_rate : 10")
    param = [0, 1, 8, 0, 0, 0, 0, 10]
else:
...
V2D.sys_rate_check(param[6], param[7])
