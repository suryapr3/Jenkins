...
import subprocess
import time
wb = openpyxl.load_workbook("flow1_multi_rate_list.xlsx")
...
for i in range(2,row_count +1):
    ...
    subprocess.call(['python flow1_multi_rate.py '  f'{tx_vex_num} '  f'{rx_vex_num} ' f'{v2d_num} '  f'{apb_num} '  f'{drf_clock} ' f'{sys_rate} '], shell=True)
