...
python3 flow1_multi_rate.py <tx_vex_id> <rx_vex_id> <v2d_id> <apb_id> <drf_clock> <sys_rate>
...
ex: python3 flow1_multi_rate.py 0 1 0 0 0 0
...
The above will generate flow1_multi_rate_list.xlsx file , needs to be done only if the xlsx file is not present or there were any changes done
