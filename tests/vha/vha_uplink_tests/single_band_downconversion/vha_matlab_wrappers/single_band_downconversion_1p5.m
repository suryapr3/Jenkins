...
fileId = fopen("input_samples/downconversion/single_band_downconversion_1p5.txt", "w");
fprintf(fileId, "%08x\n", input_iq);
fclose(fileId);
...
fileId = fopen("output_samples/downconversion/1p5/single_band_downconversion_1p5.txt", "w");
fprintf(fileId, "%08x\n", output_iq_1p5);
fclose(fileId);
...
fileId = fopen("output_samples/downconversion/1p5/single_band_downconversion_p75.txt", "w");
fprintf(fileId, "%08x\n", output_iq_p75);
fclose(fileId);
...
stem(n2, output_iq_p375);title ("Output - W1, W2 enabled");
fileId = fopen("output_samples/downconversion/1p5/single_band_downconversion_p375.txt", "w");
fprintf(fileId, "%08x\n", output_iq_p375);
fclose(fileId);
...
stem(n2, output_iq_p187);title ("Output - W1, W2, W3 enabled");
fileId = fopen("output_samples/downconversion/1p5/single_band_downconversion_p187.txt", "w");
fprintf(fileId, "%08x\n", output_iq_p187);
fclose(fileId);
