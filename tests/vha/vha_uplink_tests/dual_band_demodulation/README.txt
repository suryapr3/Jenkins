...
input rates (1G/2G) of demodulation.
Note:- 4Gsps/6Gsps traffic input to VHA is meant to be NOT from VEX but from DigRF


How to run the test ?
	From the FRIO bash terminal
	python dual_band_demodulation.py <tx_vex> <rx_vex0> <rx_vex1> <vha_num> <port_num> <in_rate> <out_rate> <ddc mode> <ul_clk>

	@input arguments
		tx_vex   : This is the VEX core who'll stream samples to the VHA instance.
		rx_vex0  : This is the VEX core who'll recieve VHA processed band0 samples.
		rx_vex1  : This is the VEX core who'll recieve VHA processed band1 samples.
