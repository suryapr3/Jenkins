...
#!/usr/bin/env python
# =============================================================================
# Created By  : Haridas P [haridas.p@intel.com]
# Created Date: January 29, 2024
# =============================================================================
# test description : this test validates VHA dual band DL path with demod
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if arg_len != 10:
    ...
    print("python dual_band_demodulation.py <tx_vex> <rx_vex0> <rx_vex1> <vha_num> <ant_num> <in_rate> <out_rate> <mode> <ul_clk> \n")
    print("As there were no or less inputs provided, executing the test with below parameters\n")
    print(" tx_vex \t : 0\n rx_vex0\t : 1\n rx_vex1\t : 8\n vha_num\t : 0\n ant_num\t : 0\n in_rate\t : 3\n out_rate\t : 0\n mode\t\t : 0\n ul_clk\t\t : 0\n")
    param = [0, 1, 8, 0, 0, 3, 0, 0, 0]
    #print (len(param))
