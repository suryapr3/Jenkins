 ...
 *********************************************************************************************/
/*
 * @file    single_band_demodulation.c
...
const char* g_input_file[2][3] = {
    {
    "single_band_demodulation_1.txt",                      // 1Gsps
    "single_band_demodulation_2.txt",                      // 2Gsps
    "single_band_demodulation_4.txt",                      // 4Gsps
    },
    {
    "single_band_demodulation_1p5.txt",                    // 1.5Gsps
    "single_band_demodulation_3.txt",                      // 3Gsps
    "single_band_demodulation_6.txt",                      // 6Gsps
    }
   };
...
const char* g_output_ref_file[2][12] = {
    ...
    "1g/single_band_demodulation_p5.txt",                  // W1
    "1g/single_band_demodulation_p25.txt",                 // W1+W2
    "1g/single_band_demodulation_p125.txt",                // W1+W2+W3
    NULL,

    // For the inputs at 2Gsps
    "2g/single_band_demodulation_1.txt",                   // W1
    "2g/single_band_demodulation_p5.txt",                  // W1+W2
    "2g/single_band_demodulation_p25.txt",                 // W1+W2+W3
    "2g/single_band_demodulation_p125.txt",                // W1+W2+W3+W4

    // For the inputs at 4Gsps
    NULL,
    "4g/single_band_demodulation_1.txt",                   // W1+W2
    "4g/single_band_demodulation_p5.txt",                  // W1+W2+W3
    "4g/single_band_demodulation_p25.txt",                 // W1+W2+W3+W4
    },
    {
    // For the inputs at 1.5Gsps
    "1p5/single_band_demodulation_p75.txt",                // W1
    "1p5/single_band_demodulation_p375.txt",               // W1+W2
    "1p5/single_band_demodulation_p187.txt",               // W1+W2+W3
    NULL,

    // For the inputs at 3Gsps
    "3g/single_band_demodulation_1p5.txt",                 // W1
    "3g/single_band_demodulation_p75.txt",                 // W1+W2
    "3g/single_band_demodulation_p375.txt",                // W1+W2+W3
    "3g/single_band_demodulation_p187.txt",                // W1+W2+W3+W4

    // For the inputs at 6Gsps
    NULL,
    "6g/single_band_demodulation_1p5.txt",                 // W1+W2
    "6g/single_band_demodulation_p75.txt",                 // W1+W2+W3
    "6g/single_band_demodulation_p375.txt",                // W1+W2+W3+W4
    },
};
    ...
    const char* argv[])
{
    ...
    printf("\n");
    printf("Test: Single band demodulation\n");
    printf("%s\n", g_compile_time);
    printf("BUILD_DIR: %s\n\n", BUILD_DIR);
    ...
    strcat(file_name, g_output_ref_file[ul_clk][((in_rate - 3) * 4) + (in_rate - out_rate - 1)]);
    ...
    uint32_t dest_id)
{
    ...
    uint64_t vha_reg_base_addr, ddc0_base_addr, dmod_base_addr, ant_reg_base_addr;
    uint32_t value;
    int i, rv = 0;
    ...
    ant_reg->VHA_ANT_UL_CFG.value = (1 << 8) | (out_rate << 4) | (0 << 3) | in_rate;
    ...
    fs = ((1 << (in_rate - 3)) * fclk);
    num_cordics = (fs / fclk);
    fout = (fs / 2);                                       // Generate a safe freq of half of the sampling rate
    if(!num_cordics)
    {
