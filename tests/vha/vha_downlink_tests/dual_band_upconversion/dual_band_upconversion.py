...
# =============================================================================
# test description : this test validates VHA dual band DL path
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if arg_len != 11:
    ...
    print("python dual_band_upconversion.py <tx_vex_num0> <rx_vex_num1> <tx_vex_num1> <rx_vex_num1> <vha_num> <ant_num> <in_rate> <out_rate> <mode> <dl_clk>\n")
    print("As there were no or less inputs provided, executing the test with below parameters\n")
    print(" tx_vex_num0\t : 0\n rx_vex_num0\t : 1\n tx_vex_num1\t : 8\n rx_vex_num1\t : 9\n vha_num\t : 0\n ant_num\t : 0\n in_rate\t : 0\n out_rate\t : 0\n mode\t\t : 0\n dl_clk\t\t : 0\n")
    param = [0, 1, 8, 9, 0, 0, 0, 0, 0, 0]
    #print (len(param))
