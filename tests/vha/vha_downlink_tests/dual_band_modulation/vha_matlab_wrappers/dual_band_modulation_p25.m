...
%               dual band modulation testing at p25 Gsps
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
stem(n1, band0_input_iq, 'green'); title("Band0 Input IQ samples @p25");
subplot(7, 2, 2); grid on; hold on;
stem(n1, band1_input_iq, 'green'); title("Band1 Input IQ samples @p25");

% write this into a file which can be sourced while running on FRIO
fileId = fopen("input_samples/modulation/band0_dual_band_modulation_p25.txt", "w");
fprintf(fileId, "%08x\n", bitshift(band0_input_iq, 16));
fclose(fileId);
fileId = fopen("input_samples/modulation/band1_dual_band_modulation_p25.txt", "w");
...
fileId = fopen("output_samples/modulation/p25/dual_band_modulation_1.txt", "w");
...
fileId = fopen("output_samples/modulation/p25/dual_band_modulation_2.txt", "w");
...
fileId = fopen("output_samples/modulation/p25/dual_band_modulation_4.txt", "w");
