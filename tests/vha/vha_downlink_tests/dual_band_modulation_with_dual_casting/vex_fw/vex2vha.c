 ...
 ***********************************************/
vec32i32 AT(0) vbuffer0[64];
vec32i32 AT(0x2000) vbuffer1[64];
...
#pragma hive pipeline ii=4
        ...
        for(i = 0; i < iter_max; i++)
        {
            ...
            v_xstomi_1024(Any, dest_address, offset, 511, vout, offset);
        }
#ifdef VOLCANO
#pragma hive pipeline ii=4
#endif
        for(i = 0; i < iter_max; i++)
        {
            ...
            v_xstomi_1024(Any, (dest_address + 0x10000), offset, 511, vout, offset);
        }
