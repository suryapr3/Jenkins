/*************************************************
*                                                *
*     Dual band modulation with DUAL CAST        *
*                                                *
* Author : Haridas P                             *
* Date   : 10 Aug 2024                           *
*                                                *
...
(4 cascaded interpolation filters). The same VHA processed samples will be streamed to two different VEX cores by
enabling both of the output FIFOs.
