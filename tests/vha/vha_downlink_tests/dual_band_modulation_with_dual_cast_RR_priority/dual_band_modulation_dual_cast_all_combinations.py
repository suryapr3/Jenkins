...
#!/usr/bin/env python
# =============================================================================
# Created By  : Haridas P
# Created Date: Aug 15, 2024
# =============================================================================
# test description : this test validates VHA dual band DL path with modulator
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if dut_preconfig == 1:
    ...
    for vha in vha_list:
        if vha == 0:
            ve_list = vha_0_valid_vex_list
        elif vha == 1:
            ve_list = vha_1_valid_vex_list
        elif vha == 2:
            ve_list = vha_2_valid_vex_list
        elif vha == 3:
            ve_list = vha_3_valid_vex_list
        for tx_id in ve_list:
            for rx_id0 in ve_list:
                if rx_id0 == tx_id:
                    continue
                for rx_id1 in ve_list:
                    if rx_id0 == rx_id1:
                        continue
                    if tx_id == rx_id1:
                        continue
                    for ant_num in range(2):
                        for in_rate in range(4):
                            min_rate = 3
                            max_rate = 6
                            if in_rate == 0:
                                max_rate = 5
                            if in_rate == 3:
                                min_rate = 4
                            for out_rate in range(min_rate,max_rate):
                                for duc_mode in range(2):
#                                    for dl_clk in range(1):
                                         param = [tx_id, rx_id0, rx_id1, vha, ant_num, in_rate, out_rate, duc_mode, 1]
                                         print(param)
