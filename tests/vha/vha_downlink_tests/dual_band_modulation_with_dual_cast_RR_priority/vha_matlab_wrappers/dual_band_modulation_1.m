...
%               dual band modulation testing at 1Gsps
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
stem(n1, band0_input_iq, 'green'); title("Band0 Input IQ samples @1");
subplot(5, 2, 2); grid on; hold on;
stem(n1, band1_input_iq, 'green'); title("Band1 Input IQ samples @1");

% write this into a file which can be sourced while running on FRIO
fileId = fopen("input_samples/modulation/band0_dual_band_modulation_1.txt", "w");
fprintf(fileId, "%08x\n", bitshift(band0_input_iq, 16));
fclose(fileId);
fileId = fopen("input_samples/modulation/band1_dual_band_modulation_1.txt", "w");
...
fileId = fopen("output_samples/modulation/1g/dual_band_modulation_2.txt", "w");
...
fileId = fopen("output_samples/modulation/1g/dual_band_modulation_4.txt", "w");
