 ...
 *********************************************************************************************/
/*
 * @file    dual_band_modulation_with_dual_cast_RR_priority.c
 ...
 *             output FIFOs.
 *          4. The ANT Arbitration will be made to Round Robin for this test.
    ...
    const char* argv[])
{
    ...
    printf("\n");
    printf("Test: Dual band modulation with dual casting and round robin priority\n");
    printf("%s\n", g_compile_time);
    printf("BUILD_DIR: %s\n\n", BUILD_DIR);
    ...
    uint32_t dest_id1)
{
    ...
    ant_reg->VHA_ANT_ARB_CFG.value = 1;                    // mode = 1 => Round Robin priority
