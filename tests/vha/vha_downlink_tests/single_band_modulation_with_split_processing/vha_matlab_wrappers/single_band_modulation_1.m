% This program is to generate an input and output sample files for VHA
 % single band Modulation testing at 1gsps
clc;
clear;
close all;
...
stem(n1, input_iq, 'green'); title("Input IQ samples @1g");

% write this into a file which can be sourced while running on FRIO
fileId = fopen("input_samples/modulation/single_band_modulation_1.txt", "w");
...
fileId = fopen("output_samples/modulation/1g/single_band_modulation_2.txt", "w");
...
fileId = fopen("output_samples/modulation/1g/single_band_modulation_4.txt", "w");
