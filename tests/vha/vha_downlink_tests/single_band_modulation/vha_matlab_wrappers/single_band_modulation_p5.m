% This program is to generate an input and output sample files for VHA
 % single band Modulation testing at p5 gsps
clc;
clear;
close all;
...
stem(n1, input_iq, 'green'); title("Input IQ samples @p5");

% write this into a file which can be sourced while running on FRIO
fileId = fopen("input_samples/modulation/single_band_modulation_p5.txt", "w");
...
fileId = fopen("output_samples/modulation/p5/single_band_modulation_1.txt", "w");
...
fileId = fopen("output_samples/modulation/p5/single_band_modulation_2.txt", "w");
...
fileId = fopen("output_samples/modulation/p5/single_band_modulation_4.txt", "w");
