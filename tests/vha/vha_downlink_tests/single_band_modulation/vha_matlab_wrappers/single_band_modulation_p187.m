...
% single band Modulation testing at p187 gsps
clc;
clear;
close all;
...
stem(n1, input_iq, 'green'); title("Input IQ samples @p187");

% write this into a file which can be sourced while running on FRIO
fileId = fopen("input_samples/modulation/single_band_modulation_p187.txt", "w");
...
% generate cw0 for the modulation freq = 750Mhz, Fs = 1.5Ghz, Fclk = 1.5Ghz, #sample = 768
Fclk = 1474000;
Fs   = 1474000;
freq = (Fclk / 2);
...
fileId = fopen("output_samples/modulation/p187/single_band_modulation_1p5.txt", "w");
...
fileId = fopen("output_samples/modulation/p187/single_band_modulation_3.txt", "w");
