...
% single band Modulation testing at p125 gsps
clc;
clear;
close all;
...
stem(n1, input_iq, 'green'); title("Input IQ samples @p125");

% write this into a file which can be sourced while running on FRIO
fileId = fopen("input_samples/modulation/single_band_modulation_p125.txt", "w");
...
fileId = fopen("output_samples/modulation/p125/single_band_modulation_1.txt", "w");
...
fileId = fopen("output_samples/modulation/p125/single_band_modulation_2.txt", "w");
