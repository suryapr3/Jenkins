 ...
 *          4. VHA processed samples will be streamed back to another VEX core for data comparison.
    ...
    const char* argv[])
{
    ...
    printf("\n");
    printf("Test: Single band modulation\n");
    printf("%s\n", g_compile_time);
    printf("BUILD_DIR: %s\n\n", BUILD_DIR);
    ...
    printf("HOST: Input sample file : %s\n", file_name);
