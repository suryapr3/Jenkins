...
The test will cover validation of all the output rates (1G/2G/4G) of modulation.


How to run the test ?
	From the FRIO bash terminal
	python single_band_modulation.py <tx_vex> <rx_vex> <vha_num> <port_num> <in_rate> <out_rate> <duc mode> <dl_clk>
