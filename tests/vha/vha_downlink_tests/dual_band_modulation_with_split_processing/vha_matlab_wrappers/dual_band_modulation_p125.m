...
%               dual band modulation testing at p125 Gsps
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
stem(n1, band1_input_iq, 'green'); title("Band1 Input IQ samples @p125");

% write this into a file which can be sourced while running on FRIO
fileId = fopen("input_samples/modulation/band0_dual_band_modulation_p125.txt", "w");
fprintf(fileId, "%08x\n", bitshift(band0_input_iq, 16));
fclose(fileId);
fileId = fopen("input_samples/modulation/band1_dual_band_modulation_p125.txt", "w");
...
fileId = fopen("output_samples/modulation/p125/dual_band_modulation_1.txt", "w");
...
fileId = fopen("output_samples/modulation/p125/dual_band_modulation_2.txt", "w");
