/*************************************************
*                                                *
* VHA interrupt test (UL input fifo UNDERFLOW)   *
*                                                *
* Author : Haridas P                             *
* Date   : April 10, 2024                        *
*                                                *
...
This test is to generate an UNDERFLOW interrupt in the input fifo of the uplink path of the
VHA antenna and then check the status of the same on the status registers.

How to run the test ?
	From the FRIO bash terminal
		python ul_input_fifo_underflow.py
