 ...
 *********************************************************************************************/
/**
 * @file    vha2vex_p5_8iq.c
 * @brief   Vex FW code to validate the VHA DL path.
...
#pragma hive pipeline ii=3
        ...
        for (int i = 0; i < iter_max; i++)
        {
         ...
         if ((0 == count) && (0 == i))
          {
             // Add if any debug specific code based on block or vector numbers
          }
#endif
#endif
          vec_processed++;
