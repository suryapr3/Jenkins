 ...
 *********************************************************************************************/
/*
 * @file    dl_output_fifo_overflow.c
    ...
    const char* argv[])
{
    ...
    printf("\n");
    printf("Test: DL Output fifo overflow test\n");
    printf("%s\n", g_compile_time);
    printf("BUILD_DIR: %s\n\n", BUILD_DIR);
...
int test_irq_handler(uint32_t vha_num, uint32_t ant_num, int band)
{
    ...
    uint32_t vha_int_high_stat, vha_int_low_stat, vha_ant_int_status, vha_ant_dl_of_stat;
    int rv;
    ...
    vha_ant_dl_of_stat = read_reg_18a(VHA_ANT_DL_OF_STAT0_ADR(addr1), "VHA_ANT_DL_OF_STAT0");
    if(band) vha_ant_dl_of_stat = read_reg_18a(VHA_ANT_DL_OF_STAT1_ADR(addr1), "VHA_ANT_DL_OF_STAT1");
    printf("INFO: ANT_DL_OF_STAT = %x\n", vha_ant_dl_of_stat);
    ...
    if((vha_int_high_stat != (4 << ant_num)) || (vha_int_low_stat != (4 << ant_num)))
    {
    ...
    if(vha_ant_int_status != (1 << (14 + band)))           // DL_OF_ERROR
    {
    ...
    if((vha_ant_dl_of_stat & 2) != FIFO_OVERFLOW)
    {
        // VHA_ANT_DL_OF_STAT register is NOT getting set correctly
