...
# =============================================================================
# test description : this test validates VHA UL OFIFO overflow interrupt
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if arg_len != 9:
    ...
    print("python ul_output_fifo_overflow.py <tx_vex_num> <rx_vex_num> <vha_num> <ant_num> <in_rate> <out_rate> <mode> <clk>\n")
    print("As there were no or less inputs provided, executing the test with below parameters\n")
    print(" tx_vex_num\t : 0\n rx_vex_num\t : 1\n vha_num\t : 0\n ant_num\t : 0\n in_rate\t : 3\n out_rate\t : 3\n mode\t\t : 0\n clk\t\t : 0\n")
    param = [0, 1, 0, 0, 3, 3, 0, 0]
    #print (len(param))
