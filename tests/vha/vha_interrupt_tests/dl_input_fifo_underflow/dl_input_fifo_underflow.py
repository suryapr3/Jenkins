...
# =============================================================================
# test description : this test is to validate DL IFIFO underflow interrupt
# =============================================================================
# Import statements
# =============================================================================
import sys
...
if arg_len != 10:
    ...
    print("python dl_input_fifo_underflow.py <tx_vex_num> <rx_vex_num> <vha_num> <ant_num> <in_rate> <out_rate> <mode> <clk> <band>\n")
