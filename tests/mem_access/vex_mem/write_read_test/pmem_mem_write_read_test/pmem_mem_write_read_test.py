...
present_time_split = str(present_time).split(" ")
print(present_time_split[0])
print(present_time_split[1])
#clog = frio_name + '_' + str(present_time) +'.log'
clog = frio_name + '_' + present_time_split[0] + present_time_split[1] +'.log'
