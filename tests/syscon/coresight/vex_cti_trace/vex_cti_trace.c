...
void configure_debug_reg(uint32_t etmb_address)
{
	// Generate manual application trigger
    write_m_cs_dbg_18a(etmb_address +VE32_TILE_ETMB_DBGCPHITSTATR_OFFSET, 0x1, SECURE, "CROSSPOINT START ENABLE REG");
    write_m_cs_dbg_18a(etmb_address +VE32_TILE_ETMB_DBGCMDR_OFFSET, 0x1, SECURE, "DEBUG COMMAND REG");

    write_m_cs_dbg_18a(etmb_address +VE32_TILE_ETMB_TRCPRGCTLR_OFFSET, 0x1, SECURE, "TRACE PROG CONTROL REG");
}
...
int main()
{
   ...
   //init_cs_soc_cti(CS_SOC_CTI16BIT_APB4_SLAVE_0_MM_BASE);
    ...
    configure_debug_reg(VEXABCCS0_ETMB_VE32_TILE_BASE);
