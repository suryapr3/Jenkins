...
int main(int argc, const char * argv[])
{
    ...
    etm_config(0, "RCS", trace_id);
    print("configured etm\n");
	//return 0;	
    // Enabling ETM
    etm_switch(0, "RCS", ENABLE);
...
# if 0
    ...
    for (rcsCoreId = SRP_RCS_RCP_CTRL_AX; rcsCoreId <1; rcsCoreId++)
    {
    ...
    post_coresight_config(0, "RCS", ETR_EN);

    uint32_t etr_size = etr_mem_read(ETR_DIS);
