...
void init_cs_soc_cti()
{
    ...
    write_m_cs_dbg_18a(CS_SOC_CTI16BIT_APB4_SLAVE_0_MM_BASE + CS_SOC_600_CTI_16BIT_ADDRBLK_0_CTIINEN15_OFFSET, 0xf, SECURE, "CS_SOC_CTI_EVEN_IN REG");

    // Generate an event-out signal, map all channels
    write_m_cs_dbg_18a(CS_SOC_CTI16BIT_APB4_SLAVE_0_MM_BASE + CS_SOC_600_CTI_16BIT_ADDRBLK_0_CTIOUTEN15_OFFSET, 0xf, SECURE, "CS_SOC_CTI_EVEN_OUT REG");
    ...
    write_m_cs_dbg_18a(CS_SOC_CTI16BIT_APB4_SLAVE_0_MM_BASE + CS_SOC_600_CTI_16BIT_ADDRBLK_0_CTIAPPSET_OFFSET, 0xf, SECURE, "CS_SOC_CTI_APPSET REG");
...
void init_core_cti(uint32_t core_cti_address)
{
    ...
    write_m_cs_dbg_18a(core_cti_address + CSS600_CTI_16BIT_ADDRBLK_0_CTIINEN2_OFFSET, 0x1, SECURE, "CTI_EVENT_IN REG");

    // Generate an event-out signal, map all channels
    write_m_cs_dbg_18a(core_cti_address + CSS600_CTI_16BIT_ADDRBLK_0_CTIOUTEN2_OFFSET, 0x1, SECURE, "CTI_EVEN_OUT REG");
...
{
	// Generate manual application trigger
    write_m_cs_dbg_18a(cti_address + CSS600_CTI_16BIT_ADDRBLK_0_CTIAPPSET_OFFSET, 0x1, SECURE, "CTI_APPSET REG");
    print("Manual trigger for : 0x%x\n", cti_address); 
   // sleep(1);
  //  write_m_cs_dbg_18a(cti_address + CSS600_CTI_16BIT_ADDRBLK_0_CTIAPPCLR_OFFSET, 0x1, SECURE, "CTI_APPCLEAR REG");
}
...
int main()
{
   ...
   //init_cs_soc_cti(CS_SOC_CTI16BIT_APB4_SLAVE_0_MM_BASE);
    ...
    init_core_cti(VEXARRAYCS16_00_CTI16BIT_APB4_SLAVE_0_MM_BASE);
   ...
   generate_trace_event(VEXARRAYCS16_00_CTI16BIT_APB4_SLAVE_0_MM_BASE);
    cti_status(VEXARRAYCS16_00_CTI16BIT_APB4_SLAVE_0_MM_BASE);
