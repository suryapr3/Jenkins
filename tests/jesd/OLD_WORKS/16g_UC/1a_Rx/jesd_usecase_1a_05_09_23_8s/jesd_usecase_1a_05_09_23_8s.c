...
int program_rx_ip_registers()
{
	...
	for (core_number=0; core_number <= 1; core_number++)
	{
		...
		write_read_expect(SRP_BLOCK_JESD_XIP_RX, core_number,JESD_XIP_RX_JL_F_REG,0x00000007,0x00000007,JESD_XIP_RX_JL_F_REG_RD_MASK,JESD_XIP_RX_JL_F_REG_WR_MASK,"JESD_XIP_RX_JL_F_REG");
		...
		write_read_expect(SRP_BLOCK_JESD_XIP_RX, core_number,JESD_XIP_RX_JL_THRESH_SH_ERR_REG,0x00000009,0x00000009,JESD_XIP_RX_JL_THRESH_SH_ERR_REG_RD_MASK,JESD_XIP_RX_JL_THRESH_SH_ERR_REG_WR_MASK,"JESD_XIP_RX_JL_THRESH_SH_ERR_REG");
		write_read_expect(SRP_BLOCK_JESD_XIP_RX, core_number,JESD_XIP_RX_JL_THRESH_EMB_ERR_REG,0x00000009,0x00000009,JESD_XIP_RX_JL_THRESH_EMB_ERR_REG_RD_MASK,JESD_XIP_RX_JL_THRESH_EMB_ERR_REG_WR_MASK,"JESD_XIP_RX_JL_THRESH_EMB_ERR_REG");
	}
} 
