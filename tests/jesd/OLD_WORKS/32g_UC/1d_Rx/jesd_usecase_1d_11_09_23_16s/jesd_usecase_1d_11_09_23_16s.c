...
int main(int argc, char **argv)
{
	...
	// function calls - Reg seq usecase 0b
...
int program_rx_ip_registers()
{
	...
	for (core_number=0; core_number <= 1; core_number++)
	{
		...
		write_read_expect(SRP_BLOCK_JESD_XIP_RX, core_number,JESD_XIP_RX_JL_M_REG,0x0000001f,0x0000000f,JESD_XIP_RX_JL_M_REG_RD_MASK,JESD_XIP_RX_JL_M_REG_WR_MASK,"JESD_XIP_RX_JL_M_REG");
		...
		write_read_expect(SRP_BLOCK_JESD_XIP_RX, core_number,JESD_XIP_RX_JL_THRESH_SH_ERR_REG,0x00000006,0x00000006,JESD_XIP_RX_JL_THRESH_SH_ERR_REG_RD_MASK,JESD_XIP_RX_JL_THRESH_SH_ERR_REG_WR_MASK,"JESD_XIP_RX_JL_THRESH_SH_ERR_REG");
		write_read_expect(SRP_BLOCK_JESD_XIP_RX, core_number,JESD_XIP_RX_JL_THRESH_EMB_ERR_REG,0x00000006,0x00000006,JESD_XIP_RX_JL_THRESH_EMB_ERR_REG_RD_MASK,JESD_XIP_RX_JL_THRESH_EMB_ERR_REG_WR_MASK,"JESD_XIP_RX_JL_THRESH_EMB_ERR_REG");
	}
} 
