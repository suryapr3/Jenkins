...
//VE00 cio2strm
    ...
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_STRM_DEST(4), 0x00000040, VEXA_VEXABC_C2S_REGS_CIO2STRM_STRM_DEST_WR_MASK, \
        "CIO2STRM_STRM_DEST0"},
    ...
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_STRM_DEST(5), 0x00000040, VEXA_VEXABC_C2S_REGS_CIO2STRM_STRM_DEST_WR_MASK, \
        "CIO2STRM_STRM_DEST0"},
    ...
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_STRM_DEST(6), 0x00000040, VEXA_VEXABC_C2S_REGS_CIO2STRM_STRM_DEST_WR_MASK, \
        "CIO2STRM_STRM_DEST0"},
    ...
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_STRM_DEST(7), 0x00000040, VEXA_VEXABC_C2S_REGS_CIO2STRM_STRM_DEST_WR_MASK, \
        "CIO2STRM_STRM_DEST0"},
...
//VE00 cio2strm
	...
	//Adding for stream 8-15
	//MEM_ADDR_LOW[8] - [31-17] destination ID,[16-0] bits local address as seen from STRM2CIO
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_LOW(0), 0x100000, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_LOW_WR_MASK, \
        "CIO2STRM_MEM_ADDR_LOW0"},
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_HIGH(0), 0x11FFFF, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_HIGH_WR_MASK, \
        "CIO2STRM_MEM_ADDR_HIGH0"},
    //MEM_OFFSET[8]- is in words
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_OFFSET(0), 0x00000000, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_OFFSET_WR_MASK, \
        "CIO2STRM_MEM_OFFSET0"},
    //STRM_DEST[8] - mapped to JESD_Port_1
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_STRM_DEST(0), 0x00000041, VEXA_VEXABC_C2S_REGS_CIO2STRM_STRM_DEST_WR_MASK, \
        "CIO2STRM_STRM_DEST0"},
	
	//MEM_ADDR_LOW[9] - [31-17] destination ID,[16-0] bits local address as seen from STRM2CIO
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_LOW(1), 0x120000, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_LOW_WR_MASK, \
        "CIO2STRM_MEM_ADDR_LOW0"},
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_HIGH(1), 0x13FFFF, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_HIGH_WR_MASK, \
        "CIO2STRM_MEM_ADDR_HIGH0"},
    //MEM_OFFSET[9]- is in words
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_OFFSET(1), 0x00000000, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_OFFSET_WR_MASK, \
        "CIO2STRM_MEM_OFFSET0"},
    //STRM_DEST[9] - mapped to JESD_Port_1
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_STRM_DEST(1), 0x00000041, VEXA_VEXABC_C2S_REGS_CIO2STRM_STRM_DEST_WR_MASK, \
        "CIO2STRM_STRM_DEST0"},

	//MEM_ADDR_LOW[10] - [31-17] destination ID,[16-0] bits local address as seen from STRM10CIO
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_LOW(2), 0x140000, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_LOW_WR_MASK, \
        "CIO10STRM_MEM_ADDR_LOW0"},
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_HIGH(2), 0x15FFFF, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_HIGH_WR_MASK, \
        "CIO10STRM_MEM_ADDR_HIGH0"},
    //MEM_OFFSET[10]- is in words
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_OFFSET(2), 0x00000000, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_OFFSET_WR_MASK, \
        "CIO10STRM_MEM_OFFSET0"},
    //STRM_DEST[10] - mapped to JESD_Port_1
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_STRM_DEST(2), 0x00000041, VEXA_VEXABC_C2S_REGS_CIO2STRM_STRM_DEST_WR_MASK, \
        "CIO10STRM_STRM_DEST0"},
		
	//MEM_ADDR_LOW[11] - [111-17] destination ID,[16-0] bits local address as seen from STRM2CIO
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_LOW(3), 0x160000, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_LOW_WR_MASK, \
        "CIO2STRM_MEM_ADDR_LOW0"},
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_HIGH(3), 0x17FFFF, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_HIGH_WR_MASK, \
        "CIO2STRM_MEM_ADDR_HIGH0"},
    //MEM_OFFSET[11]- is in words
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_OFFSET(3), 0x00000000, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_OFFSET_WR_MASK, \
        "CIO2STRM_MEM_OFFSET0"},
    //STRM_DEST[11] - mapped to JESD_Port_1
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_STRM_DEST(3), 0x00000041, VEXA_VEXABC_C2S_REGS_CIO2STRM_STRM_DEST_WR_MASK, \
        "CIO2STRM_STRM_DEST0"},
		
	//MEM_ADDR_LOW[12] - [31-17] destination ID,[16-0] bits local address as seen from STRM2CIO
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_LOW(4), 0x180000, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_LOW_WR_MASK, \
        "CIO2STRM_MEM_ADDR_LOW0"},
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_HIGH(4), 0x19FFFF, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_HIGH_WR_MASK, \
        "CIO2STRM_MEM_ADDR_HIGH0"},
    ...
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_LOW(5), 0x1A0000, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_LOW_WR_MASK, \
        "CIO2STRM_MEM_ADDR_LOW0"},
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_HIGH(5), 0x1BFFFF, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_HIGH_WR_MASK, \
        "CIO2STRM_MEM_ADDR_HIGH0"},
    //MEM_OFFSET[13]- is in words
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_OFFSET(5), 0x00000000, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_OFFSET_WR_MASK, \
        "CIO2STRM_MEM_OFFSET0"},
    //STRM_DEST[13] - mapped to JESD_Port_1
    ...
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_LOW(6), 0x1C0000, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_LOW_WR_MASK, \
        "CIO2STRM_MEM_ADDR_LOW0"},
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_HIGH(6), 0x1DFFFF, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_HIGH_WR_MASK, \
        "CIO2STRM_MEM_ADDR_HIGH0"},
    //MEM_OFFSET[14]- is in words
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_OFFSET(6), 0x00000000, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_OFFSET_WR_MASK, \
        "CIO2STRM_MEM_OFFSET0"},
    //STRM_DEST[14] - mapped to JESD_Port_1
    ...
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_LOW(7), 0x1E0000, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_LOW_WR_MASK, \
        "CIO2STRM_MEM_ADDR_LOW0"},
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_HIGH(7), 0x1FFFFF, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_ADDR_HIGH_WR_MASK, \
        "CIO2STRM_MEM_ADDR_HIGH0"},
    //MEM_OFFSET[15]- is in words
    {VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_OFFSET(7), 0x00000000, VEXA_VEXABC_C2S_REGS_CIO2STRM_MEM_OFFSET_WR_MASK, \
        "CIO2STRM_MEM_OFFSET0"},
    //STRM_DEST[15] - mapped to JESD_Port_1
...
// B2H Registers - JESD - 1
    ...
    {(JESD_NSIP_HBI_MAP_B2H_ADDR_MAP_TBL(8)), 0x80040000, JESD_NSIP_HBI_MAP_B2H_ADDR_MAP_TBL_WR_MASK, "B2H_ADDR_MAP_TBL0"},
    // Mask was set for total 2K flits in words
    {(JESD_NSIP_HBI_MAP_B2H_ADDR_MASK_TBL(8)), 0x7FFF, JESD_NSIP_HBI_MAP_B2H_ADDR_MASK_TBL_WR_MASK, "B2H_ADDR_MASK_TBL0"},

    // These are for Buffer S9
    {(JESD_NSIP_HBI_MAP_B2H_ADDR_MAP_TBL(9)), 0x80048000, JESD_NSIP_HBI_MAP_B2H_ADDR_MAP_TBL_WR_MASK, "B2H_ADDR_MAP_TBL0"},
    // Mask was set for total 2K flits in words
    {(JESD_NSIP_HBI_MAP_B2H_ADDR_MASK_TBL(9)), 0x7FFF, JESD_NSIP_HBI_MAP_B2H_ADDR_MASK_TBL_WR_MASK, "B2H_ADDR_MASK_TBL0"},
	
	// These are for Buffer S10
    {(JESD_NSIP_HBI_MAP_B2H_ADDR_MAP_TBL(10)), 0x80050000, JESD_NSIP_HBI_MAP_B2H_ADDR_MAP_TBL_WR_MASK, "B2H_ADDR_MAP_TBL0"},
    // Mask was set for total 2K flits in words
    {(JESD_NSIP_HBI_MAP_B2H_ADDR_MASK_TBL(10)), 0x7FFF, JESD_NSIP_HBI_MAP_B2H_ADDR_MASK_TBL_WR_MASK, "B2H_ADDR_MASK_TBL0"},
	
	// These are for Buffer S11
    {(JESD_NSIP_HBI_MAP_B2H_ADDR_MAP_TBL(11)), 0x80058000, JESD_NSIP_HBI_MAP_B2H_ADDR_MAP_TBL_WR_MASK, "B2H_ADDR_MAP_TBL0"},
    // Mask was set for total 2K flits in words
    {(JESD_NSIP_HBI_MAP_B2H_ADDR_MASK_TBL(11)), 0x7FFF, JESD_NSIP_HBI_MAP_B2H_ADDR_MASK_TBL_WR_MASK, "B2H_ADDR_MASK_TBL0"},
	
	// These are for Buffer S12
    {(JESD_NSIP_HBI_MAP_B2H_ADDR_MAP_TBL(12)), 0x80060000, JESD_NSIP_HBI_MAP_B2H_ADDR_MAP_TBL_WR_MASK, "B2H_ADDR_MAP_TBL0"},
    // Mask was set for total 2K flits in words
    {(JESD_NSIP_HBI_MAP_B2H_ADDR_MASK_TBL(12)), 0x7FFF, JESD_NSIP_HBI_MAP_B2H_ADDR_MASK_TBL_WR_MASK, "B2H_ADDR_MASK_TBL0"},

    // These are for Buffer S13
    {(JESD_NSIP_HBI_MAP_B2H_ADDR_MAP_TBL(13)), 0x80068000, JESD_NSIP_HBI_MAP_B2H_ADDR_MAP_TBL_WR_MASK, "B2H_ADDR_MAP_TBL0"},
    // Mask was set for total 2K flits in words
    {(JESD_NSIP_HBI_MAP_B2H_ADDR_MASK_TBL(13)), 0x7FFF, JESD_NSIP_HBI_MAP_B2H_ADDR_MASK_TBL_WR_MASK, "B2H_ADDR_MASK_TBL0"},
	
	// These are for Buffer S14
    {(JESD_NSIP_HBI_MAP_B2H_ADDR_MAP_TBL(14)), 0x80070000, JESD_NSIP_HBI_MAP_B2H_ADDR_MAP_TBL_WR_MASK, "B2H_ADDR_MAP_TBL0"},
    // Mask was set for total 2K flits in words
    {(JESD_NSIP_HBI_MAP_B2H_ADDR_MASK_TBL(14)), 0x7FFF, JESD_NSIP_HBI_MAP_B2H_ADDR_MASK_TBL_WR_MASK, "B2H_ADDR_MASK_TBL0"},
	
	// These are for Buffer S15
    {(JESD_NSIP_HBI_MAP_B2H_ADDR_MAP_TBL(15)), 0x80078000, JESD_NSIP_HBI_MAP_B2H_ADDR_MAP_TBL_WR_MASK, "B2H_ADDR_MAP_TBL0"},
    // Mask was set for total 2K flits in words
    {(JESD_NSIP_HBI_MAP_B2H_ADDR_MASK_TBL(15)), 0x7FFF, JESD_NSIP_HBI_MAP_B2H_ADDR_MASK_TBL_WR_MASK, "B2H_ADDR_MASK_TBL0"},
...
int configure_jesd_host(int vex_num, int jesd_num, int apb_num, int cm_num)
{
    ...
    for (i = 0; i < ARRAY_SIZE(g_cio2strm_0_config_tbl); i++)
    {
        if (rv = write_reg(SRP_BLOCK_VEX_CORE, vex_num, g_cio2strm_0_config_tbl[i].offset, g_cio2strm_0_config_tbl[i].value, \
                g_cio2strm_0_config_tbl[i].mask, g_cio2strm_0_config_tbl[i].name))
            return rv;
    }
    
	printf("INFO: Vex0 cio2strm configuration completed");
	
	for (i = 0; i < ARRAY_SIZE(g_cio2strm_1_config_tbl); i++)
    {
        if (rv = write_reg(SRP_BLOCK_VEX_CORE, vex_num+1, g_cio2strm_1_config_tbl[i].offset, g_cio2strm_1_config_tbl[i].value, \
                g_cio2strm_1_config_tbl[i].mask, g_cio2strm_1_config_tbl[i].name))
            return rv;
    }

    printf("INFO: Vex1 cio2strm configuration completed");
...
static int program_tx_ip_registers()
{
	...
	for (core_number=0; core_number <= 1; core_number++)
	{
		...
		write_read_expect(SRP_BLOCK_JESD_XIP_TX, core_number,JESD_XIP_TX_JL_M_REG,0x0000001f,0x0000001f,JESD_XIP_TX_JL_M_REG_RD_MASK,JESD_XIP_TX_JL_M_REG_WR_MASK,"JESD_XIP_TX_JL_M_REG");
...
static int program_tx_glue_registers()
{
	...
	{	
		...
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0(8),0x00008000,0x00008000,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_ID_TBL0");
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1(8),0x00000fff,0x00000fff,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_ID_TBL1");
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0(9),0x00009000,0x00009000,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_ID_TBL0");
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1(9),0x00000fff,0x00000fff,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_ID_TBL1");
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0(10),0x0000a000,0x0000a000,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_ID_TBL0");
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1(10),0x00000fff,0x00000fff,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_ID_TBL1");
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0(11),0x0000b000,0x0000b000,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_ID_TBL0");
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1(11),0x00000fff,0x00000fff,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_ID_TBL1");
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0(12),0x0000c000,0x0000c000,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_ID_TBL0");
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1(12),0x00000fff,0x00000fff,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_ID_TBL1");
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0(13),0x0000d000,0x0000d000,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_ID_TBL0");
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1(13),0x00000fff,0x00000fff,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_ID_TBL1");
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0(14),0x0000e000,0x0000e000,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_ID_TBL0");
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1(14),0x00000fff,0x00000fff,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_ID_TBL1");
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0(15),0x0000f000,0x0000f000,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_ID_TBL0_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_ID_TBL0");
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1(15),0x00000fff,0x00000fff,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_ID_TBL1_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_ID_TBL1");
	

		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_STRM_CRUX_PORT_MAP,0x0000ff00,0x0000ff00,JESD_JESDABC_TX_GLUE_STRM_CRUX_PORT_MAP_RD_MASK,JESD_JESDABC_TX_GLUE_STRM_CRUX_PORT_MAP_WR_MASK,"JESD_JESDABC_TX_GLUE_STRM_CRUX_PORT_MAP");
...
static void configure_jesd_block()
{
	...
	printf("JESD tx path - UC 1d -LMFS -4-32-16-1 - IQ bandwidth -4Gsps\n");
...
main(int argc, const char *argv[])
{
    ...
    if ((rv = srp_vex_loader(vex_hdl, vex_num+1, "vex_fw/sim_m64/jesd_tx.fw")))
        return rv; // Check
	...
	/* Loading the host parameters to VEX_1  Rx core*/
    for (lc = 0; lc < ARRAY_SIZE(vex_tx_offset_val); lc++)
    {
        if ((rv = srp_core_block_write32(srp,
                        SRP_BLOCK_VEX_CORE,
	...
	for (lc = 8; lc < total_streams_1; lc++)
	{
        for (i = 0; i < NUM_TOTAL_VEC_PER_STREAM; i++)
        {
            for (j = 0; j < NUM_OF_ELEMENTS_PER_VEC; j++)
        ...
        if ((rv = srp_vex_memid_store(vex_hdl,
                            vex_num+1,
                            SRP_VEX_VMEM,
                            vex_tx_buffer_addr[lc - 8],/*local_addr*/
                            val_inp[0],
                            (NUM_TOTAL_VEC_PER_STREAM * NUM_OF_ELEMENTS_PER_VEC * sizeof(int)))))
            return rv;
    }
    ...
    printf("Host: vex0 program start\n");
    srp_vex_start(vex_hdl, vex_num, 0); // vex_0 start
    
    printf("Host: vex1 program start\n");
    srp_vex_start(vex_hdl, vex_num+1, 0); // vex_1 start
