...
static int program_tx_ip_registers()
{
	...
	for (core_number=0; core_number <= 1; core_number++)
	{
		...
		write_read_expect(SRP_BLOCK_JESD_XIP_TX, core_number,JESD_XIP_TX_JL_SAMPLE_REQ_REG,0x00000101,0x00000101,JESD_XIP_TX_JL_SAMPLE_REQ_REG_RD_MASK,JESD_XIP_TX_JL_SAMPLE_REQ_REG_WR_MASK,"JESD_XIP_TX_JL_SAMPLE_REQ_REG");
		...
		write_read_expect(SRP_BLOCK_JESD_XIP_TX, core_number,JESD_XIP_TX_JL_L_REG,0x00000001,0x00000001,JESD_XIP_TX_JL_L_REG_RD_MASK,JESD_XIP_TX_JL_L_REG_WR_MASK,"JESD_XIP_TX_JL_L_REG");
		...
		write_read_expect(SRP_BLOCK_JESD_XIP_TX, core_number,JESD_XIP_TX_JL_F_REG,0x0000000f,0x0000000f,JESD_XIP_TX_JL_F_REG_RD_MASK,JESD_XIP_TX_JL_F_REG_WR_MASK,"JESD_XIP_TX_JL_F_REG");
		...
		write_read_expect(SRP_BLOCK_JESD_XIP_TX, core_number,JESD_XIP_TX_JL_TX_TL_DELAY_REG,0x0000000c,0x0000000c,JESD_XIP_TX_JL_TX_TL_DELAY_REG_RD_MASK,JESD_XIP_TX_JL_TX_TL_DELAY_REG_WR_MASK,"JESD_XIP_TX_JL_TX_TL_DELAY_REG");
...
static int program_tx_glue_registers()
{
	...
	{	
		...
		write_read_expect(SRP_BLOCK_JESD_XIP_TX_GLUE, core_number,JESD_JESDABC_TX_GLUE_MEM_RD_CFG,0x0000001f,0x0000001f,JESD_JESDABC_TX_GLUE_MEM_RD_CFG_RD_MASK,JESD_JESDABC_TX_GLUE_MEM_RD_CFG_WR_MASK,"JESD_JESDABC_TX_GLUE_MEM_RD_CFG");
...
static void configure_jesd_block()
{
	...
	printf("JESD tx path - UC 0a -LMFS -2-16-16-1 - IQ bandwidth -1Gsps\n");
...
main(int argc, const char *argv[])
{
    ...
    srp_vex_start(vex_hdl, vex_num, 0); // vex_0 start
