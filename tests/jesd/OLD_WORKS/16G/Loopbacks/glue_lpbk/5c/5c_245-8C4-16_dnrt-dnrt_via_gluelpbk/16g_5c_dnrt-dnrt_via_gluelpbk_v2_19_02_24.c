...
#define en_status_register_polling 1        //enable for glue lpbk, disable for rsb dump
...
static int program_tx_glue_registers()
{
    ...
    for(i=0; i<1; i++)
    {
        write_read_expect_18a(base_tx_glue[i]+JESDABC_TX_GLUE_MEM_TX_STRM_MEM_INST_CNT_OFFSET, JESDABC_TX_GLUE_MEM_TX_STRM_MEM_INST_CNT_DEFAULT, 0x000000c1, 0x000000c1, JESDABC_TX_GLUE_MEM_TX_STRM_MEM_INST_CNT_RD_MASK, JESDABC_TX_GLUE_MEM_TX_STRM_MEM_INST_CNT_WR_MASK, "JESDABC_TX_GLUE_MEM_TX_STRM_MEM_INST_CNT");
        ...
        //tsb trigger using trigger1 enable always is not working, so enabling trigger1 using programmable delay, roshan 19/02/24
