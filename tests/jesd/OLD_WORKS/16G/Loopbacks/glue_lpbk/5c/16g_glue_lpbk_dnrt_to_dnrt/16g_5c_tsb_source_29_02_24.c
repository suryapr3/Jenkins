...
#define enable_rsb_dump            0        //enable enable_rsb_cap
#define enable_rsb_cap             0        //enable dump_rsb_valid
#define enable_glue_lpbk           1
...
#else
        write_read_expect_18a(base_tx_glue[i]+JESDABC_TX_GLUE_MEM_TX_DATAPATH_GATE_SEL_OFFSET, JESDABC_TX_GLUE_MEM_TX_DATAPATH_GATE_SEL_DEFAULT, 0x00000024, 0x00000024, JESDABC_TX_GLUE_MEM_TX_DATAPATH_GATE_SEL_RD_MASK, JESDABC_TX_GLUE_MEM_TX_DATAPATH_GATE_SEL_WR_MASK, "JESDABC_TX_GLUE_MEM_TX_DATAPATH_GATE_SEL");
#endif
