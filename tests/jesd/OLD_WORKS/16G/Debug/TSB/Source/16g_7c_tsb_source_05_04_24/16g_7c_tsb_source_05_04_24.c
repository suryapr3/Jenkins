...
static int program_cmn_csr_rx_registers()
{
    ...
    for(i=0; i<1; i++)
    {
        ...
        write_read_expect_18a(base_address_cmn[i]+JESDABC_CMN_CSR_MEM_RX_SYSREF_TSAD_OFFSET, JESDABC_CMN_CSR_MEM_RX_SYSREF_TSAD_DEFAULT, 0x00000005, 0x00000005, JESDABC_CMN_CSR_MEM_RX_SYSREF_TSAD_RD_MASK, JESDABC_CMN_CSR_MEM_RX_SYSREF_TSAD_WR_MASK, "JESDABC_CMN_CSR_MEM_RX_SYSREF_TSAD");

        //bits 0-15 -> 1b, bits 16-31 -> b, so total is 0x0b001b
        write_read_expect_18a(base_address_cmn[i]+JESDABC_CMN_CSR_MEM_RX_SYNC_POINT_CTRL_OFFSET, JESDABC_CMN_CSR_MEM_RX_SYNC_POINT_CTRL_DEFAULT, 0x00050005, 0x00050005, JESDABC_CMN_CSR_MEM_RX_SYNC_POINT_CTRL_RD_MASK, JESDABC_CMN_CSR_MEM_RX_SYNC_POINT_CTRL_WR_MASK, "JESDABC_CMN_CSR_MEM_RX_SYNC_POINT_CTRL");
        write_read_expect_18a(base_address_cmn[i]+JESDABC_CMN_CSR_MEM_RX_BFN_SYSREF_TSAD_OFFSET, JESDABC_CMN_CSR_MEM_RX_BFN_SYSREF_TSAD_DEFAULT, 0x00000005, 0x00000005, JESDABC_CMN_CSR_MEM_RX_BFN_SYSREF_TSAD_RD_MASK, JESDABC_CMN_CSR_MEM_RX_BFN_SYSREF_TSAD_WR_MASK, "JESDABC_CMN_CSR_MEM_RX_BFN_SYSREF_TSAD");
        write_read_expect_18a(base_address_cmn[i]+JESDABC_CMN_CSR_MEM_RX_BFN_SYNC_POINT_CTRL_OFFSET, JESDABC_CMN_CSR_MEM_RX_BFN_SYNC_POINT_CTRL_DEFAULT, 0x00050005, 0x00050005, JESDABC_CMN_CSR_MEM_RX_BFN_SYNC_POINT_CTRL_RD_MASK, JESDABC_CMN_CSR_MEM_RX_BFN_SYNC_POINT_CTRL_WR_MASK, "JESDABC_CMN_CSR_MEM_RX_BFN_SYNC_POINT_CTRL");
...
static int program_crux_clk_csr_rx_registers()
{
    ...
    for(i=0; i<1; i++)
    {
       ...
       //enabling for 8 streams, 14/12/23
        ...
        write_read_expect_18a(base_address_crux_clk_csr[i]+JESDABC_CRUX_CLK_CSR_MEM_RX_WR_MEM_TBL1_OFFSET, JESDABC_CRUX_CLK_CSR_MEM_RX_WR_MEM_TBL_DEFAULT, 0x00000080, 0x00000080, JESDABC_CRUX_CLK_CSR_MEM_RX_WR_MEM_TBL_RD_MASK, JESDABC_CRUX_CLK_CSR_MEM_RX_WR_MEM_TBL_WR_MASK, "JESDABC_CRUX_CLK_CSR_MEM_RX_WR_MEM_TBL1");
        write_read_expect_18a(base_address_crux_clk_csr[i]+JESDABC_CRUX_CLK_CSR_MEM_RX_WR_MEM_TBL2_OFFSET, JESDABC_CRUX_CLK_CSR_MEM_RX_WR_MEM_TBL_DEFAULT, 0x00000100, 0x00000100, JESDABC_CRUX_CLK_CSR_MEM_RX_WR_MEM_TBL_RD_MASK, JESDABC_CRUX_CLK_CSR_MEM_RX_WR_MEM_TBL_WR_MASK, "JESDABC_CRUX_CLK_CSR_MEM_RX_WR_MEM_TBL2");
        write_read_expect_18a(base_address_crux_clk_csr[i]+JESDABC_CRUX_CLK_CSR_MEM_RX_WR_MEM_TBL3_OFFSET, JESDABC_CRUX_CLK_CSR_MEM_RX_WR_MEM_TBL_DEFAULT, 0x00000180, 0x00000180, JESDABC_CRUX_CLK_CSR_MEM_RX_WR_MEM_TBL_RD_MASK, JESDABC_CRUX_CLK_CSR_MEM_RX_WR_MEM_TBL_WR_MASK, "JESDABC_CRUX_CLK_CSR_MEM_RX_WR_MEM_TBL3");
        ...
        write_read_expect_18a(base_address_crux_clk_csr[i]+JESDABC_CRUX_CLK_CSR_MEM_RX_RD_MEM_TBL1_OFFSET, JESDABC_CRUX_CLK_CSR_MEM_RX_RD_MEM_TBL_DEFAULT, 0x00000280, 0x00000280, JESDABC_CRUX_CLK_CSR_MEM_RX_RD_MEM_TBL_RD_MASK, JESDABC_CRUX_CLK_CSR_MEM_RX_RD_MEM_TBL_WR_MASK, "JESDABC_CRUX_CLK_CSR_MEM_RX_RD_MEM_TBL1");
        write_read_expect_18a(base_address_crux_clk_csr[i]+JESDABC_CRUX_CLK_CSR_MEM_RX_RD_MEM_TBL2_OFFSET, JESDABC_CRUX_CLK_CSR_MEM_RX_RD_MEM_TBL_DEFAULT, 0x00000500, 0x00000500, JESDABC_CRUX_CLK_CSR_MEM_RX_RD_MEM_TBL_RD_MASK, JESDABC_CRUX_CLK_CSR_MEM_RX_RD_MEM_TBL_WR_MASK, "JESDABC_CRUX_CLK_CSR_MEM_RX_RD_MEM_TBL2");
        write_read_expect_18a(base_address_crux_clk_csr[i]+JESDABC_CRUX_CLK_CSR_MEM_RX_RD_MEM_TBL3_OFFSET, JESDABC_CRUX_CLK_CSR_MEM_RX_RD_MEM_TBL_DEFAULT, 0x00000780, 0x00000780, JESDABC_CRUX_CLK_CSR_MEM_RX_RD_MEM_TBL_RD_MASK, JESDABC_CRUX_CLK_CSR_MEM_RX_RD_MEM_TBL_WR_MASK, "JESDABC_CRUX_CLK_CSR_MEM_RX_RD_MEM_TBL3");
...
static int program_tx_glue_registers()
{
    ...
    for(i=0; i<1; i++)
    {
        write_read_expect_18a(base_tx_glue[i]+JESDABC_TX_GLUE_MEM_TX_STRM_MEM_INST_CNT_OFFSET, JESDABC_TX_GLUE_MEM_TX_STRM_MEM_INST_CNT_DEFAULT, 0x00000004, 0x00000004, JESDABC_TX_GLUE_MEM_TX_STRM_MEM_INST_CNT_RD_MASK, JESDABC_TX_GLUE_MEM_TX_STRM_MEM_INST_CNT_WR_MASK, "JESDABC_TX_GLUE_MEM_TX_STRM_MEM_INST_CNT");
...
static void configure_jesd_block()
{
    ...
    prefill_tsb_data();
#else
    printf("####tsb prefil data is disabled \n");
#endif
    delay(100);
