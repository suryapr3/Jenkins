...
static int program_tx_ip_registers()
{
    ...
    for(i=0; i<1; i++)
    {
        ...
        write_read_expect_18a(base_address_tx[i]+JESD_XIP_204C_TX_MEM_TX_FEC_OFFSET, JESD_XIP_204C_TX_MEM_TX_FEC_REG_DEFAULT, 0x00000001, 0x00000001, JESD_XIP_204C_TX_MEM_TX_FEC_REG_RD_MASK, JESD_XIP_204C_TX_MEM_TX_FEC_REG_WR_MASK, "JESD_XIP_204C_TX_MEM_TX_FEC_OFFSET");
...
static void configure_jesd_block()
{
    ...
    prefill_tsb_zero();
#else
    printf("####tsb prefil zero is disabled \n");
#endif
    delay(100);
