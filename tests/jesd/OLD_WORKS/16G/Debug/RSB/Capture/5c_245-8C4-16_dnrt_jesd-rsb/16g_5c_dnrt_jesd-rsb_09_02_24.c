...
*********************************************************************************************/
/**
* @file    16g_5c_dnrt_jesd-rsb_09_02_24.c
* @brief   DNRT is sending data and captured at RSB
* @details A 16G, usecase -5c, DNRT sends data, captured at JESD_Rx,
   then data flows to rx_glue and captured at RSB
*/
...
#define dump_rsb_valid 1

jesd_usecase_preconfig()
{
...
static int jesd_reset()
{
    //release reset of hub channel
    system("frioPciWrite -F s6a1 -P 0x20000 0x1");

    //JESD_MEM_DISABLE          -> 0
    write_read_expect_18a(DLNK_HUB_BASE + DLNK_HUB_APB_JESD_MAP0_JESD_MEM_DISABLE_OFFSET, DLNK_HUB_APB_JESD_MEM_DISABLE_DEFAULT, 0x0, 0x0, DLNK_HUB_APB_JESD_MEM_DISABLE_RD_MASK, DLNK_HUB_APB_JESD_MEM_DISABLE_WR_MASK, "JESD_MAP0_JESD_MEM_DISABLE");
    write_read_expect_18a(DLNK_HUB_BASE + DLNK_HUB_APB_JESD_MAP1_JESD_MEM_DISABLE_OFFSET, DLNK_HUB_APB_JESD_MEM_DISABLE_DEFAULT, 0x0, 0x0, DLNK_HUB_APB_JESD_MEM_DISABLE_RD_MASK, DLNK_HUB_APB_JESD_MEM_DISABLE_WR_MASK, "JESD_MAP1_JESD_MEM_DISABLE");
    //write_read_expect_18a(DLNK_HUB_BASE + DLNK_HUB_APB_JESD_MAP2_JESD_MEM_DISABLE_OFFSET, DLNK_HUB_APB_JESD_MEM_DISABLE_DEFAULT, 0x0, 0x0, DLNK_HUB_APB_JESD_MEM_DISABLE_RD_MASK, DLNK_HUB_APB_JESD_MEM_DISABLE_WR_MASK, "JESD_MAP2_JESD_MEM_DISABLE");
    //write_read_expect_18a(DLNK_HUB_BASE + DLNK_HUB_APB_JESD_MAP3_JESD_MEM_DISABLE_OFFSET, DLNK_HUB_APB_JESD_MEM_DISABLE_DEFAULT, 0x0, 0x0, DLNK_HUB_APB_JESD_MEM_DISABLE_RD_MASK, DLNK_HUB_APB_JESD_MEM_DISABLE_WR_MASK, "JESD_MAP3_JESD_MEM_DISABLE");

    //JESD_CLOCK_EN             -> 7F    
    write_read_expect_18a(DLNK_HUB_BASE + DLNK_HUB_APB_JESD_MAP0_JESD_CLOCK_EN_OFFSET, DLNK_HUB_APB_JESD_CLOCK_EN_DEFAULT, 0x7f, 0x7f, DLNK_HUB_APB_JESD_CLOCK_EN_RD_MASK, DLNK_HUB_APB_JESD_CLOCK_EN_WR_MASK, "MAP0_JESD_CLOCK_EN");
    write_read_expect_18a(DLNK_HUB_BASE + DLNK_HUB_APB_JESD_MAP1_JESD_CLOCK_EN_OFFSET, DLNK_HUB_APB_JESD_CLOCK_EN_DEFAULT, 0x7f, 0x7f, DLNK_HUB_APB_JESD_CLOCK_EN_RD_MASK, DLNK_HUB_APB_JESD_CLOCK_EN_WR_MASK, "MAP1_JESD_CLOCK_EN");
    //write_read_expect_18a(DLNK_HUB_BASE + DLNK_HUB_APB_JESD_MAP2_JESD_CLOCK_EN_OFFSET, DLNK_HUB_APB_JESD_CLOCK_EN_DEFAULT, 0x7f, 0x7f, DLNK_HUB_APB_JESD_CLOCK_EN_RD_MASK, DLNK_HUB_APB_JESD_CLOCK_EN_WR_MASK, "MAP2_JESD_CLOCK_EN");
    //write_read_expect_18a(DLNK_HUB_BASE + DLNK_HUB_APB_JESD_MAP3_JESD_CLOCK_EN_OFFSET, DLNK_HUB_APB_JESD_CLOCK_EN_DEFAULT, 0x7f, 0x7f, DLNK_HUB_APB_JESD_CLOCK_EN_RD_MASK, DLNK_HUB_APB_JESD_CLOCK_EN_WR_MASK, "MAP3_JESD_CLOCK_EN");

    //JESD_GLITCH_SUPPRESS_N    -> 3
    write_read_expect_18a(DLNK_HUB_BASE + DLNK_HUB_APB_JESD_MAP0_JESD_GLITCH_SUPPRESS_N_OFFSET, DLNK_HUB_APB_JESD_GLITCH_SUPPRESS_N_DEFAULT, 0x3, 0x3, DLNK_HUB_APB_JESD_GLITCH_SUPPRESS_N_RD_MASK, DLNK_HUB_APB_JESD_GLITCH_SUPPRESS_N_WR_MASK, "MAP0_JESD_GLITCH_SUPPRESS");
    write_read_expect_18a(DLNK_HUB_BASE + DLNK_HUB_APB_JESD_MAP1_JESD_GLITCH_SUPPRESS_N_OFFSET, DLNK_HUB_APB_JESD_GLITCH_SUPPRESS_N_DEFAULT, 0x3, 0x3, DLNK_HUB_APB_JESD_GLITCH_SUPPRESS_N_RD_MASK, DLNK_HUB_APB_JESD_GLITCH_SUPPRESS_N_WR_MASK, "MAP1_JESD_GLITCH_SUPPRESS");
    //write_read_expect_18a(DLNK_HUB_BASE + DLNK_HUB_APB_JESD_MAP2_JESD_GLITCH_SUPPRESS_N_OFFSET, DLNK_HUB_APB_JESD_GLITCH_SUPPRESS_N_DEFAULT, 0x3, 0x3, DLNK_HUB_APB_JESD_GLITCH_SUPPRESS_N_RD_MASK, DLNK_HUB_APB_JESD_GLITCH_SUPPRESS_N_WR_MASK, "MAP2_JESD_GLITCH_SUPPRESS");
    //write_read_expect_18a(DLNK_HUB_BASE + DLNK_HUB_APB_JESD_MAP3_JESD_GLITCH_SUPPRESS_N_OFFSET, DLNK_HUB_APB_JESD_GLITCH_SUPPRESS_N_DEFAULT, 0x3, 0x3, DLNK_HUB_APB_JESD_GLITCH_SUPPRESS_N_RD_MASK, DLNK_HUB_APB_JESD_GLITCH_SUPPRESS_N_WR_MASK, "MAP3_JESD_GLITCH_SUPPRESS");

    //JESD_SW_RESET_N           -> f3
    write_read_expect_18a(DLNK_HUB_BASE + DLNK_HUB_APB_JESD_MAP0_JESD_SW_RESET_N_OFFSET, DLNK_HUB_APB_JESD_SW_RESET_N_DEFAULT, 0xf3, 0xf3, DLNK_HUB_APB_JESD_SW_RESET_N_RD_MASK, DLNK_HUB_APB_JESD_SW_RESET_N_WR_MASK, "JESD_MAP0_JESD_SW_RESET");
    write_read_expect_18a(DLNK_HUB_BASE + DLNK_HUB_APB_JESD_MAP1_JESD_SW_RESET_N_OFFSET, DLNK_HUB_APB_JESD_SW_RESET_N_DEFAULT, 0xf3, 0xf3, DLNK_HUB_APB_JESD_SW_RESET_N_RD_MASK, DLNK_HUB_APB_JESD_SW_RESET_N_WR_MASK, "JESD_MAP1_JESD_SW_RESET");
    //write_read_expect_18a(DLNK_HUB_BASE + DLNK_HUB_APB_JESD_MAP2_JESD_SW_RESET_N_OFFSET, DLNK_HUB_APB_JESD_SW_RESET_N_DEFAULT, 0xf3, 0xf3, DLNK_HUB_APB_JESD_SW_RESET_N_RD_MASK, DLNK_HUB_APB_JESD_SW_RESET_N_WR_MASK, "JESD_MAP2_JESD_SW_RESET");
    //write_read_expect_18a(DLNK_HUB_BASE + DLNK_HUB_APB_JESD_MAP3_JESD_SW_RESET_N_OFFSET, DLNK_HUB_APB_JESD_SW_RESET_N_DEFAULT, 0xf3, 0xf3, DLNK_HUB_APB_JESD_SW_RESET_N_RD_MASK, DLNK_HUB_APB_JESD_SW_RESET_N_WR_MASK, "JESD_MAP3_JESD_SW_RESET");
...
static int program_crux_clk_csr_registers()
{
    ...
    for(i=0; i<1; i++)
    {
       ...
       //enabling for 8 streams, 14/12/23
        ...
        write_read_expect_18a(base_address_crux_clk_csr[i]+JESDABC_CRUX_CLK_CSR_MEM_RX_STRM_CFG_OFFSET, JESDABC_CRUX_CLK_CSR_MEM_RX_MEM_STREAM_CFG_DEFAULT, 0x000000e8, 0x000000e8, JESDABC_CRUX_CLK_CSR_MEM_RX_MEM_STREAM_CFG_RD_MASK, JESDABC_CRUX_CLK_CSR_MEM_RX_MEM_STREAM_CFG_WR_MASK, "JESDABC_CRUX_CLK_CSR_MEM_RX_MEM_STREAM_CFG");
...
static void configure_jesd_block()
{
    ...
    //rsb freeze mode enabled, roshan 12/02/24
