...
static register_config_tbl_t g_cio2strm_0_config_tbl[] = 
{
    ...
    {VEXABC0_C2S_CIO2STRM_BASE + CIO2STRM_MEM_CIO2STRM_RANGE_EN_OFFSET, 0x0000000f, CIO2STRM_MEM_CIO2STRM_RANGE_EN_WR_MASK, \
        "CIO2STRM_RANGE_EN"},
	...
	/*	
	//Added by Aditya for 4-stream UCs with 4blocks/16KB per stream
	// Enables the eight stream from vex core to CRUX -0xff
    {VEXABC0_C2S_CIO2STRM_BASE + CIO2STRM_MEM_CIO2STRM_RANGE_EN_OFFSET, 0x000000f, CIO2STRM_MEM_CIO2STRM_RANGE_EN_WR_MASK, \
        "CIO2STRM_RANGE_EN"},
...
static int program_cmn_csr_tx_registers()
{
    ...
    for(i=0; i<1; i++)
    {
		...
		else if (flow_params.jesdConfig.jesdUsecase == UC3A )
	    {
			...
			write_read_expect_18a(base_address_cmn[i]+JESDABC_CMN_CSR_MEM_TX_SYSREF_TSAD_OFFSET, JESDABC_CMN_CSR_MEM_TX_SYSREF_TSAD_DEFAULT, 0x00000013, 0x00000013, JESDABC_CMN_CSR_MEM_TX_SYSREF_TSAD_RD_MASK, JESDABC_CMN_CSR_MEM_TX_SYSREF_TSAD_WR_MASK, "JESDABC_CMN_CSR_MEM_TX_SYSREF_TSAD");

			//bits 0-15 -> 1b, bits 16-31 -> b, so total is 0x0b001b
			write_read_expect_18a(base_address_cmn[i]+JESDABC_CMN_CSR_MEM_TX_SYNC_POINT_CTRL_OFFSET, JESDABC_CMN_CSR_MEM_TX_SYNC_POINT_CTRL_DEFAULT, 0x000f001f, 0x000f001f, JESDABC_CMN_CSR_MEM_TX_SYNC_POINT_CTRL_RD_MASK, JESDABC_CMN_CSR_MEM_TX_SYNC_POINT_CTRL_WR_MASK, "JESDABC_CMN_CSR_MEM_TX_SYNC_POINT_CTRL");
			write_read_expect_18a(base_address_cmn[i]+JESDABC_CMN_CSR_MEM_TX_BFN_SYSREF_TSAD_OFFSET, JESDABC_CMN_CSR_MEM_TX_BFN_SYSREF_TSAD_DEFAULT, 0x00000013, 0x00000013, JESDABC_CMN_CSR_MEM_TX_BFN_SYSREF_TSAD_RD_MASK, JESDABC_CMN_CSR_MEM_TX_BFN_SYSREF_TSAD_WR_MASK, "JESDABC_CMN_CSR_MEM_TX_BFN_SYSREF_TSAD");
			write_read_expect_18a(base_address_cmn[i]+JESDABC_CMN_CSR_MEM_TX_BFN_SYNC_POINT_CTRL_OFFSET, JESDABC_CMN_CSR_MEM_TX_BFN_SYNC_POINT_CTRL_DEFAULT, 0x000f001f, 0x000f001f, JESDABC_CMN_CSR_MEM_TX_BFN_SYNC_POINT_CTRL_RD_MASK, JESDABC_CMN_CSR_MEM_TX_BFN_SYNC_POINT_CTRL_WR_MASK, "JESDABC_CMN_CSR_MEM_TX_BFN_SYNC_POINT_CTRL");
...
static int program_tx_ip_registers()
{
    ...
    for(i=0; i<1; i++)
    {
		...
		{
			printf("JESD TX path - UC 3A 16G -LMFS -1-8-16-1 - IQ bandwidth -\n");
			write_read_expect_18a(base_address_tx[i] + JESD_XIP_204C_TX_MEM_TX_L_OFFSET, JESD_XIP_204C_TX_MEM_TX_L_REG_DEFAULT, 0x00000000, 0x00000000, JESD_XIP_204C_TX_MEM_TX_L_REG_RD_MASK, JESD_XIP_204C_TX_MEM_TX_L_REG_WR_MASK, "JESD_XIP_204C_TX_MEM_TX_L_OFFSET");
...
//Added for 16 streams : U-2C, U-3D
	unsigned *vex_tx_val_kargs_tbl[19]={ v0_vex_tx_val_kargs, v1_vex_tx_val_kargs, v2_vex_tx_val_kargs,
...
//Added for 4 streams : U-3A, U-7C
//Added for 16 streams : U-2C, U-3D
	unsigned int vex_start_stop[19][2]={	{0,8},{0,8},{0,8},
										{0,4},{0,4},
										{0,8},{8,16},{0,8},
										{8,16},{0,8},{0,4},{0,4},
											{0,4},{0,2},{0,2},{0,1},
	...
	# if prefil_tsb_to_zero
		...
		for(m=0; m<1; m++)
		{
			...
			for(flit_count=0; flit_count < 64; flit_count++)
			{
				...
				write_read_expect_18a(base_address_crux_clk_csr[m]+JESDABC_CRUX_CLK_CSR_MEM_TX_MEM_APB_WDATA6_OFFSET, JESDABC_CRUX_CLK_CSR_MEM_TX_MEM_APB_WDATA_DEFAULT, 0xacacacac, 0xacacacac, JESDABC_CRUX_CLK_CSR_MEM_TX_MEM_APB_WDATA_RD_MASK, JESDABC_CRUX_CLK_CSR_MEM_TX_MEM_APB_WDATA_WR_MASK, "JESDABC_CRUX_CLK_CSR_MEM_TX_MEM_APB_WDATA6_OFFSET");
				...
				write_read_expect_18a(base_address_crux_clk_csr[m]+JESDABC_CRUX_CLK_CSR_MEM_TX_MEM_APB_WDATA13_OFFSET, JESDABC_CRUX_CLK_CSR_MEM_TX_MEM_APB_WDATA_DEFAULT, 0xacacacac, 0xacacacac, JESDABC_CRUX_CLK_CSR_MEM_TX_MEM_APB_WDATA_RD_MASK, JESDABC_CRUX_CLK_CSR_MEM_TX_MEM_APB_WDATA_WR_MASK, "JESDABC_CRUX_CLK_CSR_MEM_TX_MEM_APB_WDATA13_OFFSET");
