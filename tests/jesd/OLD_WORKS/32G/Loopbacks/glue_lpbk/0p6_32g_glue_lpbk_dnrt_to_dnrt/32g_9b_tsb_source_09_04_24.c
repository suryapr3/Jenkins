...
static int program_cmn_csr_rx_registers()
{
    ...
    for(i=0; i<1; i++)
    {
        ...
        write_read_expect_18a(base_address_cmn[i]+JESDABC_CMN_CSR_MEM_RX_SYSREF_TSAD_OFFSET, JESDABC_CMN_CSR_MEM_RX_SYSREF_TSAD_DEFAULT, 0x00000001, 0x00000001, JESDABC_CMN_CSR_MEM_RX_SYSREF_TSAD_RD_MASK, JESDABC_CMN_CSR_MEM_RX_SYSREF_TSAD_WR_MASK, "JESDABC_CMN_CSR_MEM_RX_SYSREF_TSAD");

        //bits 0-15 -> 1b, bits 16-31 -> b, so total is 0x0b001b
        write_read_expect_18a(base_address_cmn[i]+JESDABC_CMN_CSR_MEM_RX_SYNC_POINT_CTRL_OFFSET, JESDABC_CMN_CSR_MEM_RX_SYNC_POINT_CTRL_DEFAULT, 0x00010013, 0x00010013, JESDABC_CMN_CSR_MEM_RX_SYNC_POINT_CTRL_RD_MASK, JESDABC_CMN_CSR_MEM_RX_SYNC_POINT_CTRL_WR_MASK, "JESDABC_CMN_CSR_MEM_RX_SYNC_POINT_CTRL");
        write_read_expect_18a(base_address_cmn[i]+JESDABC_CMN_CSR_MEM_RX_BFN_SYSREF_TSAD_OFFSET, JESDABC_CMN_CSR_MEM_RX_BFN_SYSREF_TSAD_DEFAULT, 0x00000001, 0x00000001, JESDABC_CMN_CSR_MEM_RX_BFN_SYSREF_TSAD_RD_MASK, JESDABC_CMN_CSR_MEM_RX_BFN_SYSREF_TSAD_WR_MASK, "JESDABC_CMN_CSR_MEM_RX_BFN_SYSREF_TSAD");
        write_read_expect_18a(base_address_cmn[i]+JESDABC_CMN_CSR_MEM_RX_BFN_SYNC_POINT_CTRL_OFFSET, JESDABC_CMN_CSR_MEM_RX_BFN_SYNC_POINT_CTRL_DEFAULT, 0x00010013, 0x00010013, JESDABC_CMN_CSR_MEM_RX_BFN_SYNC_POINT_CTRL_RD_MASK, JESDABC_CMN_CSR_MEM_RX_BFN_SYNC_POINT_CTRL_WR_MASK, "JESDABC_CMN_CSR_MEM_RX_BFN_SYNC_POINT_CTRL");
...
static int program_rx_ip_registers()
{
    ...
    for(i=0; i<1; i++)
    {
        ...
        printf("JESD RX path - UC 9b 16G -LMFS -2-4-4-1 - IQ bandwidth -\n");
...
static int program_tx_ip_registers()
{
    ...
    for(i=0; i<1; i++)
    {
        ...
        printf("JESD TX path - UC 9b 16G -LMFS -2-4-4-1 - IQ bandwidth -\n");
...
static int program_crux_clk_csr_tx_registers()
{
    ...
    write_read_expect_18a(base_address_crux_clk_csr[i]+JESDABC_CRUX_CLK_CSR_MEM_TX_TSB_TRIG_EN_OFFSET, JESDABC_CRUX_CLK_CSR_MEM_TX_TSB_TRIG_EN_REG_DEFAULT, 0x00033fff, 0x00033fff, JESDABC_CRUX_CLK_CSR_MEM_TX_TSB_TRIG_EN_REG_RD_MASK, JESDABC_CRUX_CLK_CSR_MEM_TX_TSB_TRIG_EN_REG_WR_MASK, "JESDABC_CRUX_CLK_CSR_MEM_TX_TSB_TRIG_EN_REG");
...
int main(int argc, const char *argv[])
{
    ...
    fpga_provided_sysref();
    delay(100);
    printf("\n$$$$$$$$$$$$$Hello from roshan UC9b TSB source mode\n");
    ...
    while(loop_count < 1)
    {
        ...
        for(i=0; i<1; i++)
        {
            ...
            else
            {
                ...
                printf("###RSB buffer0 0-255 flits for stream0 \n");
                for(flit_count=0; flit_count<256; flit_count++)
            ...
            else
            {
                ...
                flit_count = 0;
                printf("###RSB buffer1 256-512 flits for stream1 \n");
                for(flit_count=256; flit_count<512; flit_count++)
