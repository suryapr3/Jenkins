...
static register_config_tbl_t g_cio2strm_0_config_tbl[] = {
  //roshan deleting the commented contents, 04/01/24
};
...
static int program_tx_ip_registers()
{
	...
	{ 
		...
		{
			printf("########JESD tx path - UC 5E -LMFS -4-16-8-1 \n");
...
static int program_cmn_csr_registers()
{
	...
	{ 		
		...
		{
			printf("JESD cmn csr registers, JESD0 usecase-5c \n");
			write_read_expect_18a(base_address_cmn[i]+JESDABC_CMN_CSR_MEM_TX_IP_CLK_CTRL_OFFSET, JESDABC_CMN_CSR_MEM_TX_IP_CLK_CTRL_DEFAULT, 0x00000006, 0x00000006, JESDABC_CMN_CSR_MEM_TX_IP_CLK_CTRL_RD_MASK, JESDABC_CMN_CSR_MEM_TX_IP_CLK_CTRL_WR_MASK, "JESDABC_CMN_CSR_MEM_TX_IP_CLK_CTRL_OFFSET");
			write_read_expect_18a(base_address_cmn[i]+JESDABC_CMN_CSR_MEM_RX_IP_CLK_CTRL_OFFSET, JESDABC_CMN_CSR_MEM_RX_IP_CLK_CTRL_DEFAULT, 0x00000006, 0x00000006, JESDABC_CMN_CSR_MEM_RX_IP_CLK_CTRL_RD_MASK, JESDABC_CMN_CSR_MEM_RX_IP_CLK_CTRL_WR_MASK, "JESDABC_CMN_CSR_MEM_RX_IP_CLK_CTRL_OFFSET");
			//printf("JESD cmn csr registers, JESD1 usecase-5c \n");
			//write_read_expect_18a(base_address_cmn[1]+JESDABC_CMN_CSR_MEM_TX_IP_CLK_CTRL_OFFSET, JESDABC_CMN_CSR_MEM_TX_IP_CLK_CTRL_DEFAULT, 0x00000006, 0x00000006, JESDABC_CMN_CSR_MEM_TX_IP_CLK_CTRL_RD_MASK, JESDABC_CMN_CSR_MEM_TX_IP_CLK_CTRL_WR_MASK, "JESDABC_CMN_CSR_MEM_TX_IP_CLK_CTRL_OFFSET");
			//write_read_expect_18a(base_address_cmn[1]+JESDABC_CMN_CSR_MEM_RX_IP_CLK_CTRL_OFFSET, JESDABC_CMN_CSR_MEM_RX_IP_CLK_CTRL_DEFAULT, 0x00000006, 0x00000006, JESDABC_CMN_CSR_MEM_RX_IP_CLK_CTRL_RD_MASK, JESDABC_CMN_CSR_MEM_RX_IP_CLK_CTRL_WR_MASK, "JESDABC_CMN_CSR_MEM_RX_IP_CLK_CTRL_OFFSET");
		}
...
static int program_tx_glue_registers()
{
	...
	{ 	
		...
		*/
		...
		//keeping buffer space to 1 block as per new sim log 05/01/23
		...
		//using 7ff for 3 lsb bits, as per new sim log, 05/01/24
...
//adding rx ip register, roshan 04/01/24
static int program_rx_ip_registers()
{
	...
	if (flow_params.jesdConfig.jesdUsecase == UC5E )
    {
    ...
    {
		printf("###JESD RX path - UC 5C -LMFS -4-16-8-1 - IQ bandwidth -\n");
	...
	else if (flow_params.jesdConfig.jesdUsecase == UC1D )
   {
	...
	{
		printf("JESD RX else loop or Default test i.e. - UC 0B -LMFS -4-32-16-1 \n");
...
//adding rx glue registers, roshan 04/01/24
...
//	for(i=0; i<sizeof(base_address_rx_glue) / sizeof(base_address_rx_glue[0]); i++)
	...
	{ 
		if (flow_params.jesdConfig.jesdUsecase == UC5C)
		{
		   ...
		   printf("########JESD RX GLUE CONFIG : usecase-5c \n");
			...
			write_read_expect_18a(base_address_rx_glue[i]+JESDABC_RX_GLUE_MEM_STRM_CFG_OFFSET, JESDABC_RX_GLUE_MEM_STRM_CFG_DEFAULT, 0x00000048, 0x00000048, JESDABC_RX_GLUE_MEM_STRM_CFG_RD_MASK, JESDABC_RX_GLUE_MEM_STRM_CFG_WR_MASK, "JESDABC_RX_GLUE_MEM_STRM_CFG_OFFSET");
		...
		{
			 printf("########JESD RX GLUE CONFIG : else loop or default Rx_glue \n");
			write_read_expect_18a(base_address_rx_glue[i]+JESDABC_RX_GLUE_MEM_WR_MEM_TBL0_OFFSET, JESDABC_RX_GLUE_MEM_WR_MEM_TBL_DEFAULT, 0x00000000, 0x00000000, JESDABC_RX_GLUE_MEM_WR_MEM_TBL_RD_MASK, JESDABC_RX_GLUE_MEM_WR_MEM_TBL_WR_MASK, "JESDABC_RX_GLUE_MEM_WR_MEM_TBL0_OFFSET");
			write_read_expect_18a(base_address_rx_glue[i]+JESDABC_RX_GLUE_MEM_WR_MEM_TBL1_OFFSET, JESDABC_RX_GLUE_MEM_WR_MEM_TBL_DEFAULT, 0x00000020, 0x00000020, JESDABC_RX_GLUE_MEM_WR_MEM_TBL_RD_MASK, JESDABC_RX_GLUE_MEM_WR_MEM_TBL_WR_MASK, "JESDABC_RX_GLUE_MEM_WR_MEM_TBL1_OFFSET");
			write_read_expect_18a(base_address_rx_glue[i]+JESDABC_RX_GLUE_MEM_WR_MEM_TBL2_OFFSET, JESDABC_RX_GLUE_MEM_WR_MEM_TBL_DEFAULT, 0x00000040, 0x00000040, JESDABC_RX_GLUE_MEM_WR_MEM_TBL_RD_MASK, JESDABC_RX_GLUE_MEM_WR_MEM_TBL_WR_MASK, "JESDABC_RX_GLUE_MEM_WR_MEM_TBL2_OFFSET");
			write_read_expect_18a(base_address_rx_glue[i]+JESDABC_RX_GLUE_MEM_WR_MEM_TBL3_OFFSET, JESDABC_RX_GLUE_MEM_WR_MEM_TBL_DEFAULT, 0x00000060, 0x00000060, JESDABC_RX_GLUE_MEM_WR_MEM_TBL_RD_MASK, JESDABC_RX_GLUE_MEM_WR_MEM_TBL_WR_MASK, "JESDABC_RX_GLUE_MEM_WR_MEM_TBL3_OFFSET");
...
static int program_enable_registers()
{
	...
	printf("JESD ENABLE : program_enable_registers for JESD0 \n");
	//for(i=0; i<sizeof(base_address_tx) / sizeof(base_address_tx[0]); i++)
	for(i=0; i<1; i++)
	{ 
	...
	//enable of jesd rx/jesd1 after data available in jesd0
	//for(j=1; j<2; j++)
	//{ 
	//	//using JESDABC_M1_XIP_204C_RX_BASE to configure jesd1 for rx
	//	write_read_expect_18a(base_address_rx[j]+JESD_XIP_204C_RX_MEM_RX_ENABLEMODULE_OFFSET, JESD_XIP_204C_RX_MEM_RX_ENABLEMODULE_REG_DEFAULT, 0x1, 0x1, JESD_XIP_204C_RX_MEM_RX_ENABLEMODULE_REG_RD_MASK, JESD_XIP_204C_RX_MEM_RX_ENABLEMODULE_REG_WR_MASK, "JESD_XIP_204C_RX_MEM_RX_ENABLEMODULE_OFFSET");
	//	write_read_expect_18a(base_address_tx[j]+JESD_XIP_204C_TX_MEM_TX_ENABLEMODULE_OFFSET, JESD_XIP_204C_TX_MEM_TX_ENABLEMODULE_REG_DEFAULT, 0x1, 0x1, JESD_XIP_204C_TX_MEM_TX_ENABLEMODULE_REG_RD_MASK, JESD_XIP_204C_TX_MEM_TX_ENABLEMODULE_REG_WR_MASK, "JESD_XIP_204C_TX_MEM_TX_ENABLEMODULE_OFFSET");
	//}
}
...
static void configure_jesd_block()
{
	...
	//=================================
	//enable tsb capture,
	//disabling this for vex to dnrt traffic, roshan 03/01/23
...
//Added for U-1A,U-0B,U-1D,U-1C,U-5C
	...
	//system("frioPciWrite -F s4a1 -P 0x20000 0xD0");
	//system("frioPciWrite -F s4b1 -P 0x20000 0xD0");
	system("frioPciWrite -F s5a3 -P 0x20000 0x07");
	system("frioPciWrite -F s5a1 -P 0x20000 0x94");
	system("frioPciWrite -F s5b1 -P 0x20000 0x94");
	
	printf("SYSREF for JESD0 Done\n");
	//=================================
	//=================================
	uint32_t tx_gb_empty_reg = 0;
	uint32_t tx_gb_full_reg = 0;
	...
	/* printf("JESD ENABLE : program_enable_registers for jesd_rx/jesd1 \n");
	for(j=1; j<2; j++)
	{ 
		//using JESDABC_M1_XIP_204C_RX_BASE to configure jesd1 for rx
		write_read_expect_18a(base_address_rx[j]+JESD_XIP_204C_RX_MEM_RX_ENABLEMODULE_OFFSET, JESD_XIP_204C_RX_MEM_RX_ENABLEMODULE_REG_DEFAULT, 0x1, 0x1, JESD_XIP_204C_RX_MEM_RX_ENABLEMODULE_REG_RD_MASK, JESD_XIP_204C_RX_MEM_RX_ENABLEMODULE_REG_WR_MASK, "JESD_XIP_204C_RX_MEM_RX_ENABLEMODULE_OFFSET");
	...
	//enable sysref for jesd1(tx jesd)
	system("frioPciWrite -F s4a1 -P 0x20000 0xD0");
	system("frioPciWrite -F s4b1 -P 0x20000 0xD0");
	printf("SYSREF for JESD1 Done\n");
	*/
	...
	printf("\n\nHello from roshan, going to dump 8 streams RSB buffer\n");
	...
	for(j=0; j<1; j++)
	{
		//using JESDABC_M1_XIP_204C_RX_BASE to configure jesd1 for rx, roshan 04/01/24
	...
	printf("\n\n");
	printf("After SYSREF, after TSB dumping and before RSB reading value for JL_N_TX_GB_EMPTY_REG --------is 0x%x \n", value24);
	printf("After SYSREF, after TSB dumping and before RSB reading value for JL_N_TX_GB_FULL_REG ---------is 0x%x \n", value25);
	printf("After SYSREF, after TSB dumping and before RSB reading value for JL_N_RX_GB_EMPTY_REG --------is 0x%x \n", value26);
	printf("After SYSREF, after TSB dumping and before RSB reading value for JL_N_RX_GB_FULL_REG ---------is 0x%x \n", value27);
	...
	{
		//using JESDABC_M1_XIP_204C_RX_BASE to configure jesd1 for rx, roshan 04/01/24
		value   = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE0_OFFSET, "ICOUNTER_REPORT_LANE0");
		value1  = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE1_OFFSET, "ICOUNTER_REPORT_LANE1");
		value2  = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE2_OFFSET, "ICOUNTER_REPORT_LANE2");
		value3  = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE3_OFFSET, "ICOUNTER_REPORT_LANE3");
		value4  = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE4_OFFSET, "ICOUNTER_REPORT_LANE4");
		value5  = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE5_OFFSET, "ICOUNTER_REPORT_LANE5");
		value6  = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE6_OFFSET, "ICOUNTER_REPORT_LANE6");
		value7  = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE7_OFFSET, "ICOUNTER_REPORT_LANE7");
		value8  = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE8_OFFSET, "ICOUNTER_REPORT_LANE8");
		value9  = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE9_OFFSET, "ICOUNTER_REPORT_LANE9");
		value10 = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE10_OFFSET, "ICOUNTER_REPORT_LANE10");
		value11 = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE11_OFFSET, "ICOUNTER_REPORT_LANE11");
		value12 = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE12_OFFSET, "ICOUNTER_REPORT_LANE12");
		value13 = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE13_OFFSET, "ICOUNTER_REPORT_LANE13");
		value14 = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE14_OFFSET, "ICOUNTER_REPORT_LANE14");
		value15 = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE15_OFFSET, "ICOUNTER_REPORT_LANE15");
		value16 = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE16_OFFSET, "ICOUNTER_REPORT_LANE16");
		value17 = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE17_OFFSET, "ICOUNTER_REPORT_LANE17");
		value18 = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE18_OFFSET, "ICOUNTER_REPORT_LANE18");
		value19 = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE19_OFFSET, "ICOUNTER_REPORT_LANE19");
		value20 = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE20_OFFSET, "ICOUNTER_REPORT_LANE20");
		value21 = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE21_OFFSET, "ICOUNTER_REPORT_LANE21");
		value22 = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE22_OFFSET, "ICOUNTER_REPORT_LANE22");
		value23 = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_ICOUNTER_REPORT_LANE23_OFFSET, "ICOUNTER_REPORT_LANE23");
		//value26 = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_GEARBOX_EMPTY_STATUS_OFFSET, "JL_N_RX_GB_EMPTY_REG");
		//value27 = read_reg_18a(base_address_rx[j] + JESD_XIP_204C_RX_MEM_RX_GEARBOX_FULL_STATUS_OFFSET, "JL_N_RX_GB_FULL_REG");
	}
	...
	while(loop_count < 1)
	{
		...
		//------------------0
		//using JESDABC_M1_RX_GLUE_BASE to configure jesd1 for rx, roshan 04/01/24
		...
		printf("\n");
		printf("\n");
		printf(" After sysref,tsb and rsb dump value for JL_N_TX_GB_EMPTY_REG --------is 0x%x \n", value24);
		printf(" After sysref,tsb and rsb dump value for JL_N_TX_GB_FULL_REG ---------is 0x%x \n", value25);
		printf(" After sysref,tsb and rsb dump value for JL_N_RX_GB_EMPTY_REG --------is 0x%x \n", value26);
		printf(" After sysref,tsb and rsb dump value for JL_N_RX_GB_FULL_REG ---------is 0x%x \n", value27);
		printf("\n");
		printf("\n");
		//---------------------------------------
