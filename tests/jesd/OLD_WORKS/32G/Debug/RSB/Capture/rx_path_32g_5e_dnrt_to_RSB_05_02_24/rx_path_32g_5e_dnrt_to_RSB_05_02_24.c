...
enum jesdUsecasenum{UC5C,UC2B,UC2C,UC3A,UC3B,UC3D,UC7C,UC5E};
...
//Added for 18A 32G Usecases:UC5E
//STRM2CIO table
...
//STRM2CIO Table Added for 18A 16G usecases:
// UC-5C;UC-2B;UC-2C;UC-3A;UC-3B;UC-3D;UC-7C;
//  UC-5E                                                                  0                         1                       2               3                      4                          5                   6                7                                            
static register_config_tbl_t* vexConfigArray_STRM2CIO[8] = {g_strm2cio_config_tbl, g_strm2cio_config_tbl, g_strm2cio_config_tbl, g_strm2cio_config_tbl, g_strm2cio_config_tbl, g_strm2cio_config_tbl, g_strm2cio_config_tbl, g_strm2cio_config_tbl
                                                            };

//                                                                  0                        1                                2                                            3                           4                           5                               6                                     7
static int vexConfigArray_STRM2CIOSize[8] = {	ARRAY_SIZE(g_strm2cio_config_tbl),ARRAY_SIZE(g_strm2cio_config_tbl),ARRAY_SIZE(g_strm2cio_config_tbl),ARRAY_SIZE(g_strm2cio_config_tbl),ARRAY_SIZE(g_strm2cio_config_tbl),ARRAY_SIZE(g_strm2cio_config_tbl),ARRAY_SIZE(g_strm2cio_config_tbl),ARRAY_SIZE(g_strm2cio_config_tbl)
	                                        };
...
//Commanon parameters & diff parameters added for UC-5C;UC-2B;UC-2C;UC-3A;UC-3B;UC-3D;UC-7C;
...
static int program_rx_ip_registers()
	{
	   ...
	   {
			printf("JESD RX path - UC 7C 16G-LMFS -4-8-8-1 - IQ bandwidth -\n");
			write_read_expect_18a(base_address_rx[i]+JESD_XIP_204C_RX_MEM_RX_L_OFFSET, JESD_XIP_204C_RX_MEM_RX_L_REG_DEFAULT, 0x00000003, 0x00000003, JESD_XIP_204C_RX_MEM_RX_L_REG_RD_MASK, JESD_XIP_204C_RX_MEM_RX_L_REG_WR_MASK, "JESD_XIP_204C_RX_MEM_RX_L_OFFSET");
			write_read_expect_18a(base_address_rx[i]+JESD_XIP_204C_RX_MEM_RX_M_OFFSET, JESD_XIP_204C_RX_MEM_RX_M_REG_DEFAULT, 0x00000007, 0x00000007, JESD_XIP_204C_RX_MEM_RX_M_REG_RD_MASK, JESD_XIP_204C_RX_MEM_RX_M_REG_WR_MASK, "JESD_XIP_204C_RX_MEM_RX_M_OFFSET");
			write_read_expect_18a(base_address_rx[i]+JESD_XIP_204C_RX_MEM_RX_F_OFFSET, JESD_XIP_204C_RX_MEM_RX_F_REG_DEFAULT, 0x00000007, 0x00000007, JESD_XIP_204C_RX_MEM_RX_F_REG_RD_MASK, JESD_XIP_204C_RX_MEM_RX_F_REG_WR_MASK, "JESD_XIP_204C_RX_MEM_RX_F_OFFSET");
	   		  ...
	   		  else if (flow_params.jesdConfig.jesdUsecase == UC5E )
	   {
		...
		{
			printf("JESD RX path for Default test i.e. - UC 5C -LMFS -4-32-16-1 \n");
...
* JESD:,
jesdUsecase: // UC-5C;UC-2B;UC-2C;UC-3A;UC-3B;UC-3D;UC-7C;
	...
	if ( rr == 0 )
	{
		while ( p != NULL)
		{
			...
			if ( p != NULL )
			{
				switch (i)
				{
					// Added for UC-5C;UC-2B;UC-2C;UC-3A;UC-3B;UC-3D;UC-7C;lata 08/12/23
                    case 0:
						/* USECASE NUMBER */
						...
						{ 
							...
							ucnum="3D";
							vexCountStartIdxTbl_STRM2CIO[0]=5;
						}
						...
						{ 
							...
							ucnum="7C";
							vexCountStartIdxTbl_STRM2CIO[0]=6;
						}
						...
						{ 
							...
							ucnum="5E";
							vexCountStartIdxTbl_STRM2CIO[0]=7;
						}						
						else
						{
...
main(int argc, const char *argv[])
	...
	system("frioPciWrite -F s5a1 -P 0x20000 0x90"); //WITH SYSREF==0x90
	system("frioPciWrite -F s5b1 -P 0x20000 0x90"); //WITH SYSREF==0x90
	*/
