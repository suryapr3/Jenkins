...
#define prefill_rsb_data_all_unique       1
#define prefill_rsb_one_flit_unique       0

//##############################################

enum jesdUsecasenum{UC0B, UC1A,UC1D,UC0A,UC1C,UC3C,UC3D,UC4A,UC4B,UC4D,UC5A,UC5C,UC5E};
...
//=======================================================
//=======================================================
#if prefill_rsb_one_flit_unique
	//prefill buffer with data
	printf("\n$$$$$$$$$$$$$$$ Going to prefil RSB buffer with only 1 unique flit data for 8 streams \n");
	int flit_count_pre = 0;
	write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_DATA_SRC_EN_OFFSET, JESDABC_RX_GLUE_MEM_RSB_DATA_SRC_EN_DEFAULT, 0x01, 0x01, JESDABC_RX_GLUE_MEM_RSB_DATA_SRC_EN_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_DATA_SRC_EN_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_DATA_SRC_EN");
	for(flit_count_pre=0; flit_count_pre<64; flit_count_pre++)
	{
		...
		// 16 registers *32 bit = 512 bit data 
		write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_WR_DATA0_OFFSET, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_DEFAULT, 0x00000001, 0x00000001, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_WR_DATA0");
		write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_WR_DATA1_OFFSET, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_DEFAULT, 0x00020003, 0x00020003, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_WR_DATA1");
		write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_WR_DATA2_OFFSET, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_DEFAULT, 0x00040005, 0x00040005, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_WR_DATA2");
		write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_WR_DATA3_OFFSET, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_DEFAULT, 0x00060007, 0x00060007, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_WR_DATA3");
		write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_WR_DATA4_OFFSET, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_DEFAULT, 0x00080009, 0x00080009, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_WR_DATA4");
		write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_WR_DATA5_OFFSET, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_DEFAULT, 0x000a000b, 0x000a000b, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_WR_DATA5");
		write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_WR_DATA6_OFFSET, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_DEFAULT, 0x000c000d, 0x000c000d, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_WR_DATA6");
		write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_WR_DATA7_OFFSET, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_DEFAULT, 0x000e000f, 0x000e000f, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_WR_DATA7");
		write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_WR_DATA8_OFFSET, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_DEFAULT, 0x00100011, 0x00100011, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_WR_DATA8");
		write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_WR_DATA9_OFFSET, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_DEFAULT, 0x00120013, 0x00120013, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_WR_DATA9");
		write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_WR_DATA10_OFFSET, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_DEFAULT, 0x00140015, 0x00140015, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_WR_DATA10");
		write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_WR_DATA11_OFFSET, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_DEFAULT, 0x00160017, 0x00160017, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_WR_DATA11");
		write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_WR_DATA12_OFFSET, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_DEFAULT, 0x00180019, 0x00180019, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_WR_DATA12");
		write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_WR_DATA13_OFFSET, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_DEFAULT, 0x001a001b, 0x001a001b, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_WR_DATA13");
		write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_WR_DATA14_OFFSET, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_DEFAULT, 0x001c001d, 0x001c001d, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_WR_DATA14");
		write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_WR_DATA15_OFFSET, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_DEFAULT, 0x001e001f, 0x001e001f, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_WR_DATA_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_WR_DATA15");
	...
	write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_DATA_SRC_EN_OFFSET, JESDABC_RX_GLUE_MEM_RSB_DATA_SRC_EN_DEFAULT, 0x00, 0x00, JESDABC_RX_GLUE_MEM_RSB_DATA_SRC_EN_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_DATA_SRC_EN_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_DATA_SRC_EN");
#else
	printf("######Disabling prefil of only one unique data for 8 streams\n\n");
#endif

//=======================================================
//=======================================================
#if prefill_rsb_data_all_unique	
	//prefill buffer with data
	delay(10);
	write_read_expect_18a(JESDABC_M0_RX_GLUE_BASE+JESDABC_RX_GLUE_MEM_RSB_DATA_SRC_EN_OFFSET, JESDABC_RX_GLUE_MEM_RSB_DATA_SRC_EN_DEFAULT, 0x01, 0x01, JESDABC_RX_GLUE_MEM_RSB_DATA_SRC_EN_RD_MASK, JESDABC_RX_GLUE_MEM_RSB_DATA_SRC_EN_WR_MASK, "JESDABC_RX_GLUE_MEM_RSB_DATA_SRC_EN");
	...
	while(unq_sample < 8192)
	{
		...
		{
			flits_per_strm = 0;
			while((flits_per_strm < 64) && (total_flits < 512 ))
			{
				current_flit = total_flits;
				//printf("current flit is %d \n",current_flit);				
...
#else
	printf("\n########Disabling Prefil of valid unique data to 512 flits of RSB\n");
#endif
