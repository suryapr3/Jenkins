...
static int program_rx_glue_registers()
	...
	for(i=0; i<1; i++)
		{ 
			...
			{
				printf("JESD RX path - UC 13A 32G GLUE-\n");				
			   //Enabling for 1 stream
				write_read_expect_18a(base_address_rx_glue[i]+JESDABC_RX_GLUE_MEM_WR_MEM_TBL0_OFFSET, JESDABC_RX_GLUE_MEM_WR_MEM_TBL_DEFAULT, 0x00000000, 0x00000000, JESDABC_RX_GLUE_MEM_WR_MEM_TBL_RD_MASK, JESDABC_RX_GLUE_MEM_WR_MEM_TBL_WR_MASK, "JESDABC_RX_GLUE_MEM_WR_MEM_TBL0_OFFSET");
			...
			{	
				printf("JESD RX path - UC 3E 16G GLUE-\n");
 ...
 */	
	...
	printf("\n");
	system("srpRead 0x63.0.0x31600 64");
	printf("\n");
	system("srpRead 0x63.0.0x31800 64");
	printf("\n");
	system("srpRead 0x63.0.0x32000 64");
	printf("\n");
	system("srpRead 0x63.0.0x32200 64");
	printf("\n");
	system("srpRead 0x63.0.0x32400 64");
	printf("\n");
	system("srpRead 0x63.0.0x32600 64");
	printf("\n");
	system("srpRead 0x63.0.0x32800 64");
	printf("\n");
	system("srpRead 0x63.0.0x33000 64");
	printf("\n");
