# 1 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/vex/applications/ve32/examples/jesd_vex_dnrt_usecase/vex_fw/vex_jesd_rx.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 543 "<built-in>" 3
# 1 "<command line>" 1
...
# 13 "<command line>" 2
# 1 "<built-in>" 2
# 1 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/vex/applications/ve32/examples/jesd_vex_dnrt_usecase/vex_fw/vex_jesd_rx.c" 2
# 32 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/vex/applications/ve32/examples/jesd_vex_dnrt_usecase/vex_fw/vex_jesd_rx.c"
...
# 32 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/vex/applications/ve32/examples/jesd_vex_dnrt_usecase/vex_fw/vex_jesd_rx.c" 2
...
# 33 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/vex/applications/ve32/examples/jesd_vex_dnrt_usecase/vex_fw/vex_jesd_rx.c" 2
...
# 1 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/Linux/vex/cores/ve32/include/hive/customops.h" 1
# 32 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/Linux/vex/cores/ve32/include/hive/support.h" 2
# 34 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/vex/applications/ve32/examples/jesd_vex_dnrt_usecase/vex_fw/vex_jesd_rx.c" 2

# 1 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/vex/applications/ve32/examples/jesd_vex_dnrt_usecase/vex_fw/defines.h" 1
# 35 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/vex/applications/ve32/examples/jesd_vex_dnrt_usecase/vex_fw/vex_jesd_rx.c" 2

# 1 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/vex/applications/ve32/examples/jesd_vex_dnrt_usecase/vex_fw/cir_buf.hive.h" 1
# 60 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/vex/applications/ve32/examples/jesd_vex_dnrt_usecase/vex_fw/cir_buf.hive.h"
inline void circ_buff_init( int ch_type, int tbs, int token_per_request, int loc_ptr, int sm_ch)
{
# 78 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/vex/applications/ve32/examples/jesd_vex_dnrt_usecase/vex_fw/cir_buf.hive.h"
...
# 92 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/vex/applications/ve32/examples/jesd_vex_dnrt_usecase/vex_fw/cir_buf.hive.h"
inline void semaphore_gate_init()
{

    (OP_mc_reset(0) __attribute__((on("Any"))) );
}
# 36 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/vex/applications/ve32/examples/jesd_vex_dnrt_usecase/vex_fw/vex_jesd_rx.c" 2
# 51 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/vex/applications/ve32/examples/jesd_vex_dnrt_usecase/vex_fw/vex_jesd_rx.c"
vec32i32 __attribute__((address(0x0))) vbuffer_0[64];

vec32i32 __attribute__((address(0xc000))) vbuffer_7[64*2];



vec32i32 __attribute__((address(0x4000))) vbuffer_out[256];


volatile int __attribute__((aligned((128)))) consumer_sm_gate[16];

volatile int __attribute__((address(0xC))) g_num_vecs_in;
volatile int __attribute__((address(0x14))) g_tbs_in_blk;
...
# 84 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/vex/applications/ve32/examples/jesd_vex_dnrt_usecase/vex_fw/vex_jesd_rx.c"
...
void jesd_rx() __attribute__((ipu_entry))
{
    ...
    semaphore_gate_init();
# 125 "/nfs/site/disks/zsc14.xne_abc_fe_001/users/vpaidi/check_in/vex-trunk/vex_core/vex/applications/ve32/examples/jesd_vex_dnrt_usecase/vex_fw/vex_jesd_rx.c"
    circ_buff_init( (1<<16), g_tbs_in_blk, 1, 0, sm_ch);
  ...
  unsigned int is_data_ready, idx, ptr;
        ...
        (is_data_ready = __builtin_ipu_OP_mc_request((unsigned int) (1), (unsigned int) (sm_ch), (unsigned int *) (&idx)) __attribute__((on("Any"))) ) __attribute__((sync("buffer_read")));

        for (int i = 0; i < iter_max; i++)
        {
    vec32i32 vout __attribute__((uninit));

          (vout = __builtin_ipu_OP_v_ldoi_1024_circ((unsigned int) (vex_dest_buffer), (unsigned int) (compare_offset), (unsigned int) (((0x80 << 20) | (((256 * 0x80)) - (0x80)))), (unsigned int) (((256 * 0x80)) - 0x80), (unsigned int *) (&compare_offset)) __attribute__((on("Any"))) ) __attribute__((no_alias)) __attribute__((sync_with("buffer_read")));

          vbuffer_7[index%(64*2)]= vout;

  }
  index++;
  (ptr = OP_mc_complete(sm_ch) __attribute__((on("Any"))) );
