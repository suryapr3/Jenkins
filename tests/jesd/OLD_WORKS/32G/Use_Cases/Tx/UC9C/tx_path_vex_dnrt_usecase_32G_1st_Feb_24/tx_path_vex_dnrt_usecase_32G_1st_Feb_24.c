...
enum jesdUsecasenum{UC0B, UC1A,UC1D,UC0A,UC1C,UC3C,UC3D,UC4A,UC4B,UC4D,UC5A,UC5C,UC5E,UC7G,UC9C};
...
// changing this to 1 port for UC 1a/0a Port 40[All 8 streams] - same can be reused for 5C,5e
// VEX0 table1
...
//U-1a==1 VEX entry; U-0b== 2 VEX entries; U-1d==2 VEX entries;U-0a==1 VEX entry;U-1c==1 VEX entry ;U-5c==1 VEX entry; U-5e==1 VEX entry
...
static int program_tx_ip_registers()
{
	...
	{ 
	    ...
	    {
			printf("JESD TX path - UC9C 32G -LMFS -4-8-4-1 - IQ bandwidth -\n");
...
//18A For 32G usecases JESD CMN CSR reg == 0x1(U-5E)
	...
	{ 	
		...
		*/
		...
		{	  
			...
			//changing to 0xc0000fff -> fff trig fill level size -4kb, trigger on half full, trigger en
			//using a value of 0x1fff, since stream id mem size is 0x1fff -8kb/stream
		...
		{	  
			...
			//taking values from programming guide op5 for 4 streams
			write_read_expect_18a(base_address_tx_glue[i]+JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR0_OFFSET, JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR_DEFAULT, 0x00000000, 0x00000000, JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR_RD_MASK, JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR_WR_MASK, "JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR0_OFFSET");
			write_read_expect_18a(base_address_tx_glue[i]+JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR1_OFFSET, JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR_DEFAULT, 0x00004000, 0x00004000, JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR_RD_MASK, JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR_WR_MASK, "JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR1_OFFSET");
			write_read_expect_18a(base_address_tx_glue[i]+JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR2_OFFSET, JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR_DEFAULT, 0x00008000, 0x00008000, JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR_RD_MASK, JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR_WR_MASK, "JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR2_OFFSET");
			write_read_expect_18a(base_address_tx_glue[i]+JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR3_OFFSET, JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR_DEFAULT, 0x0000c000, 0x0000c000, JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR_RD_MASK, JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR_WR_MASK, "JESDABC_TX_GLUE_MEM_STRM_ID_MEM_ADDR3_OFFSET");
			...
			// changing to 1 memory block/stream 8 streams*4kb - 32kb -> 0x1
			//as per programming guide, for 8 streams config, use 2 blocks per stream, so use 0x2
			write_read_expect_18a(base_address_tx_glue[i]+JESDABC_TX_GLUE_MEM_STRM_MEM_INST_CNT_OFFSET, JESDABC_TX_GLUE_MEM_STRM_MEM_INST_CNT_DEFAULT, 0x00000004, 0x00000004, JESDABC_TX_GLUE_MEM_STRM_MEM_INST_CNT_RD_MASK, JESDABC_TX_GLUE_MEM_STRM_MEM_INST_CNT_WR_MASK, "JESDABC_TX_GLUE_MEM_STRM_MEM_INST_CNT_OFFSET");
			...
			// SMPL_SHIFT_SIZE: 512/(32*SonI).16: SonI = 1; 
			// conv dp cfg :0x30
			write_read_expect_18a(base_address_tx_glue[i]+JESDABC_TX_GLUE_MEM_CONV_DP_CFG_OFFSET, JESDABC_TX_GLUE_MEM_CONV_DP_CFG_DEFAULT, 0x00000028, 0x00000028, JESDABC_TX_GLUE_MEM_CONV_DP_CFG_RD_MASK, JESDABC_TX_GLUE_MEM_CONV_DP_CFG_WR_MASK, "JESDABC_TX_GLUE_MEM_CONV_DP_CFG_OFFSET");
			...
			//changing to 0xc0000fff -> fff trig fill level size -4kb, trigger on half full, trigger en
			//using a value of 0x1fff, since stream id mem size is 0x1fff -8kb/stream
			write_read_expect_18a(base_address_tx_glue[i]+JESDABC_TX_GLUE_MEM_TX_TSB_TRIG_EN_OFFSET, JESDABC_TX_GLUE_MEM_TX_TSB_TRIG_EN_REG_DEFAULT, 0xc0002fff, 0xc0002fff, JESDABC_TX_GLUE_MEM_TX_TSB_TRIG_EN_REG_RD_MASK, JESDABC_TX_GLUE_MEM_TX_TSB_TRIG_EN_REG_WR_MASK, "JESDABC_TX_GLUE_MEM_TX_TSB_TRIG_EN_OFFSET");
		}
		else
		{
 ...
 * JESD:,
jesdUsecase: 3A,3B,3C,3D,4A,4B,4D,5A,5C,5E
...
//Added for U-1A,U-0A,U-1C,,U-0B,U-1D,U-5C,UC5E,UC3C,UC7G,UC9C
	unsigned *vex_tx_val_kargs_tbl[12]={ v1_vex_tx_val_kargs, 
										v1_vex_tx_val_kargs1, v1_vex_tx_val_kargs2,
										v2_vex_tx_val_kargs, v2_vex_tx_val_kargs_1, 
										vex_tx_val_kargs, vex_tx_val_kargs_1,
										v0_vex_tx_val_kargs,v3_vex_tx_val_kargs,
	...
	//Added to reset frio: 6th Feb 2024
	delay(500);
...
//Added for U-1A,U-0B,U-1D,U-1C,U-5C,U-5E,U-3C
	unsigned int vex_start_stop[12][2]={{0,8},{0,8},{0,8},
										{0,8},{8,16},{0,8},{8,16},
										{0,8},{0,8},{0,8},{0,8},{0,8}};
	int rr=0;
	int vexIdx;
