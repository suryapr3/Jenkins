...
static void configure_jesd_block()
	{
		...
		delay(10);
		printf("\n");
		reg_3 = read_reg_18a(JESDABC_M0_XIP_204C_RX_BASE + JESD_XIP_204C_RX_MEM_RX_GEN_SYSREF_OFFSET, "JESD_XIP_204C_RX_MEM_RX_GEN_SYSREF");
		reg_4 = read_reg_18a(JESDABC_M0_XIP_204C_RX_BASE + JESD_XIP_204C_TX_MEM_TX_GEN_SYSREF_OFFSET, "JESD_XIP_204C_RX_MEM_TX_GEN_SYSREF");
		printf(" Before enabling JESD, JESD_XIP_204C_RX_MEM_RX_GEN_SYSREF --------is 0x%x \n", reg_3);
		printf(" Before enabling JESD JESD_XIP_204C_RX_MEM_TX_GEN_SYSREF --------is 0x%x \n", reg_4);
		printf("\n");
...
main(int argc, const char *argv[])
	...
	reg_3 = read_reg_18a(JESDABC_M0_XIP_204C_RX_BASE + JESD_XIP_204C_RX_MEM_RX_GEN_SYSREF_OFFSET, "JESD_XIP_204C_RX_MEM_RX_GEN_SYSREF");
	reg_4 = read_reg_18a(JESDABC_M0_XIP_204C_RX_BASE + JESD_XIP_204C_TX_MEM_TX_GEN_SYSREF_OFFSET, "JESD_XIP_204C_RX_MEM_TX_GEN_SYSREF");
	printf(" After JESD_EN and before SYSREF JESD_XIP_204C_RX_MEM_RX_GEN_SYSREF --------is 0x%x \n", reg_3);
	printf(" After JESD_EN and before SYSREF JESD_XIP_204C_RX_MEM_TX_GEN_SYSREF --------is 0x%x \n", reg_4);
	printf("\n");
	printf("giving sysref as reg write\n");
	//system("frioPciWrite -F s5a1 -P 0x20000 0x94");
	//system("frioPciWrite -F s5b1 -P 0x20000 0x94");
	write_read_expect_18a(JESDABC_M0_XIP_204C_RX_BASE+JESD_XIP_204C_RX_MEM_RX_GEN_SYSREF_OFFSET, JESD_XIP_204C_RX_MEM_RX_GEN_SYSREF_REG_DEFAULT, 0x00000001, 0x00000001, JESD_XIP_204C_RX_MEM_RX_GEN_SYSREF_REG_RD_MASK, JESD_XIP_204C_RX_MEM_RX_GEN_SYSREF_REG_WR_MASK, "RX_GEN_SYSREF_REG");
	write_read_expect_18a(JESDABC_M0_XIP_204C_RX_BASE+JESD_XIP_204C_TX_MEM_TX_GEN_SYSREF_OFFSET, JESD_XIP_204C_TX_MEM_TX_GEN_SYSREF_REG_DEFAULT, 0x00000001, 0x00000001, JESD_XIP_204C_TX_MEM_TX_GEN_SYSREF_REG_RD_MASK, JESD_XIP_204C_TX_MEM_TX_GEN_SYSREF_REG_WR_MASK, "JESD_XIP_204C_TX_MEM_TX_GEN_SYSREF");
	printf("SYSREF Done\n");
	printf("\n");
	delay(1000);
	reg_3, reg_4 = 0;
	reg_3 = read_reg_18a(JESDABC_M0_XIP_204C_RX_BASE + JESD_XIP_204C_RX_MEM_RX_GEN_SYSREF_OFFSET, "JESD_XIP_204C_RX_MEM_RX_GEN_SYSREF");
	reg_4 = read_reg_18a(JESDABC_M0_XIP_204C_RX_BASE + JESD_XIP_204C_TX_MEM_TX_GEN_SYSREF_OFFSET, "JESD_XIP_204C_RX_MEM_TX_GEN_SYSREF");
	printf(" After SYSREF JESD_XIP_204C_RX_MEM_RX_GEN_SYSREF --------is 0x%x \n", reg_3);
	printf(" After SYSREF JESD_XIP_204C_RX_MEM_TX_GEN_SYSREF --------is 0x%x \n", reg_4);
