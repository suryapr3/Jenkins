...
# =============================================================================
# test description : this test validates multicore Vex 2 Vex data transfer
# =============================================================================
# Import statements
# =============================================================================
import sys
...
#path =os.getcwd()
#path_split  = path.split("/")
#current_working_directory = path_split[-2]
#print(current_working_directory)
...
if dut_preconfig == 1:
    ...
    #In Frio, only Vex core 0-17, 24, 25, 32-39 are functional
    for dest_core_id in vex_valid_cores_list:
        logger.info(my_functions.main(dest_core_id))
    
    #logger.info(my_functions.main(1))
