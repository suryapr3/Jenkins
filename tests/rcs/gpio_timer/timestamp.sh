# The WINDOW_START field can only be updated either before the timestamp
# has started or while the GLOBAL_DISABLE is set.
# set GLOBAL_DISABLE
srpWrite 0x26904C 0x81EC

# WINDOW_START
srpWrite 0x269048 0x00900000
