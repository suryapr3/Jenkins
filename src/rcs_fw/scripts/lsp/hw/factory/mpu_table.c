...
__xt_mpu_init_table[] __attribute__((section(".ResetHandler.text"))) = {
  ...
  XTHAL_MPU_ENTRY(0x00200000, 1, XTHAL_AR_RWXrwx, XTHAL_MEM_WRITEBACK), // sram
  XTHAL_MPU_ENTRY(0x00240000, 1, XTHAL_AR_NONE, XTHAL_MEM_DEVICE), // unused
  ...
  XTHAL_MPU_ENTRY(0x10080000, 1, XTHAL_AR_NONE, XTHAL_MEM_DEVICE), // unused
};
