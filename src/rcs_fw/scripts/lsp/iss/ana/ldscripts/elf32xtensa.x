/* This linker script generated from xt-genldscripts.tpp for LSP scripts/lsp/iss/ana */
...
MEMORY
{
  ...
  sram0_0_seg :                       	org = 0x00030000, len = 0x20000
  sram0_1_seg :                       	org = 0x00050000, len = 0x400000
  sram0_2_seg :                       	org = 0x00450000, len = 0x400000
  sram0_3_seg :                       	org = 0x00850000, len = 0x10000
}
...
_memmap_mem_sram0_start = 0x30000;
_memmap_mem_sram0_end   = 0x880000;
...
_memmap_seg_sram0_0_start = 0x30000;
_memmap_seg_sram0_0_max   = 0x50000;
_memmap_seg_sram0_1_start = 0x50000;
_memmap_seg_sram0_1_max   = 0x450000;
_memmap_seg_sram0_2_start = 0x450000;
_memmap_seg_sram0_2_max   = 0x850000;
_memmap_seg_sram0_3_start = 0x850000;
_memmap_seg_sram0_3_max   = 0x860000;
...
SECTIONS
{
  ...
  } >sram0_0_seg :sram0_0_bss_phdr


  .hwc_adc_output_global : ALIGN(4)
  {
    _hwc_adc_output_global_start = ABSOLUTE(.);
    *(.hwc_adc_output_global)
    . = ALIGN (4);
    _hwc_adc_output_global_end = ABSOLUTE(.);
    _memmap_seg_sram0_1_end = ALIGN(0x8);
  } >sram0_1_seg :sram0_1_phdr


  .hwc_adc_input_global : ALIGN(4)
  {
    _hwc_adc_input_global_start = ABSOLUTE(.);
    *(.hwc_adc_input_global)
    . = ALIGN (4);
    _hwc_adc_input_global_end = ABSOLUTE(.);
    _memmap_seg_sram0_2_end = ALIGN(0x8);
  } >sram0_2_seg :sram0_2_phdr


  .hwc_slice_cal_output_global : ALIGN(4)
  {
    _hwc_slice_cal_output_global_start = ABSOLUTE(.);
    *(.hwc_slice_cal_output_global)
    . = ALIGN (4);
    _hwc_slice_cal_output_global_end = ABSOLUTE(.);
