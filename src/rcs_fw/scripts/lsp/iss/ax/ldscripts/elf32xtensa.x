/* This linker script generated from xt-genldscripts.tpp for LSP scripts/lsp/iss/ax */
...
SECTIONS
{
  ...
  .dram0.ax_tables.data : ALIGN(4)
  {
    _dram0_ax_tables_data_start = ABSOLUTE(.);
    *(.dram0.ax_tables.data)
    . = ALIGN (4);
    _dram0_ax_tables_data_end = ABSOLUTE(.);
