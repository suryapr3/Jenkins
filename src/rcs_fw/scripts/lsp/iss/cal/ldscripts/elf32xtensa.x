/* This linker script generated from xt-genldscripts.tpp for LSP scripts/lsp/iss/cal */
...
MEMORY
{
  ...
  dram0_0_seg :                       	org = 0x10040000, len = 0x2000
  dram0_1_seg :                       	org = 0x10042000, len = 0xB000
  dram0_4_seg :                       	org = 0x10050000, len = 0x30000
  sram0_0_seg :                       	org = 0x10080000, len = 0x2000
  sram0_1_seg :                       	org = 0x10082000, len = 0x2000
  sram0_2_seg :                       	org = 0x10084000, len = 0x18C000
  sram0_3_seg :                       	org = 0x10210000, len = 0x100000
}
...
_memmap_mem_sram_end   = 0x10310000;
...
_memmap_seg_dram0_0_max   = 0x10042000;
_memmap_seg_dram0_1_start = 0x10042000;
...
_memmap_seg_sram0_2_max   = 0x10210000;
_memmap_seg_sram0_3_start = 0x10210000;
_memmap_seg_sram0_3_max   = 0x10310000;
...
SECTIONS
{
  ...
  } >sram0_2_seg :sram0_2_bss_phdr

  PROVIDE(__stack = 0x10210000);
  _heap_sentry = 0x10210000;
