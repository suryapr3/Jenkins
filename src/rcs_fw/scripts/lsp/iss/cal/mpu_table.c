...
__xt_mpu_init_table[] __attribute__((section(".ResetHandler.text"))) = {
  ...
  XTHAL_MPU_ENTRY(0x10040000, 1, XTHAL_AR_RWrw, XTHAL_MEM_NON_CACHEABLE), // dram0
  XTHAL_MPU_ENTRY(0x10080000, 1, XTHAL_AR_RWXrwx, XTHAL_MEM_WRITEBACK), // sram
  XTHAL_MPU_ENTRY(0x10310000, 1, XTHAL_AR_NONE, XTHAL_MEM_DEVICE), // unused
};

#if defined (__cplusplus)
extern "C"
#endif
const uint32_t __xt_mpu_init_table_size __attribute__((section(".ResetHandler.text"))) = 6;
...
#if defined (__STDC_VERSION__) && (__STDC_VERSION__ >= 201112L)
static_assert(sizeof(__xt_mpu_init_table)/sizeof(__xt_mpu_init_table[0]) == 6, "Incorrect MPU table size");
#endif
