/* This linker script generated from xt-genldscripts.tpp for LSP scripts/lsp/iss/tx */
...
MEMORY
{
  ...
  iram0_21_seg :                      	org = 0x10000BC0, len = 0x1F440
  dram0_0_seg :                       	org = 0x10020000, len = 0x4000
  dram0_1_seg :                       	org = 0x10024000, len = 0x19000
  sram0_0_seg :                       	org = 0x10080000, len = 0x2000
  sram0_1_seg :                       	org = 0x10082000, len = 0x2000
  sram0_2_seg :                       	org = 0x10084000, len = 0x7C000
}
...
_memmap_mem_iram0_end   = 0x10020000;
_memmap_mem_dram0_start = 0x10020000;
_memmap_mem_dram0_end   = 0x10040000;
_memmap_mem_sram_start = 0x10080000;
_memmap_mem_sram_end   = 0x10100000;
...
_memmap_seg_iram0_21_max   = 0x10020000;
_memmap_seg_dram0_0_start = 0x10020000;
_memmap_seg_dram0_0_max   = 0x10024000;
_memmap_seg_dram0_1_start = 0x10024000;
_memmap_seg_dram0_1_max   = 0x1003d000;
_memmap_seg_sram0_0_start = 0x10080000;
_memmap_seg_sram0_0_max   = 0x10082000;
_memmap_seg_sram0_1_start = 0x10082000;
_memmap_seg_sram0_1_max   = 0x10084000;
_memmap_seg_sram0_2_start = 0x10084000;
_memmap_seg_sram0_2_max   = 0x10100000;
...
SECTIONS
{
  ...
  .dram0.com_tables.data : ALIGN(4)
  {
    ...
    *(.dram0.com_tables.data)
    . = ALIGN (4);
    _dram0_com_tables_data_end = ABSOLUTE(.);
  } >dram0_0_seg :dram0_0_phdr

  .dram0.tx_tables.data : ALIGN(4)
  {
    _dram0_tx_tables_data_start = ABSOLUTE(.);
    *(.dram0.tx_tables.data)
    . = ALIGN (4);
    _dram0_tx_tables_data_end = ABSOLUTE(.);
  ...
  _end = 0x1003d000;
  PROVIDE(end = 0x1003d000);
  _heap_sentry = 0x1003f000;

  _stack_sentry = 0x1003f000;
  PROVIDE(__stack = 0x10040000);
