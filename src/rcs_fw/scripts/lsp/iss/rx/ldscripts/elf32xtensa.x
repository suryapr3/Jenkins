/* This linker script generated from xt-genldscripts.tpp for LSP scripts/lsp/iss/rx */
...
SECTIONS
{
  ...
  .dram0.rx_tables.data : ALIGN(4)
  {
    _dram0_rx_tables_data_start = ABSOLUTE(.);
    *(.dram0.rx_tables.data)
    . = ALIGN (4);
    _dram0_rx_tables_data_end = ABSOLUTE(.);
