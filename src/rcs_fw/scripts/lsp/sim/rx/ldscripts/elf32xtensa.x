/* This linker script generated from xt-genldscripts.tpp for LSP scripts/lsp/sim/rx */
...
MEMORY
{
  ...
  sram0_2_seg :                       	org = 0x00210000, len = 0x30000
...
_memmap_seg_sram0_2_max   = 0x240000;
...
SECTIONS
{
  ...
  .adc_core.data : ALIGN(4)
  {
    _adc_core_data_start = ABSOLUTE(.);
    *(.adc_core.data)
    . = ALIGN (4);
    _adc_core_data_end = ABSOLUTE(.);
  ...
  .dram0.debug.rodata : ALIGN(4)
  {
    _dram0_debug_rodata_start = ABSOLUTE(.);
    *(.dram0.debug.rodata)
    . = ALIGN (4);
    _dram0_debug_rodata_end = ABSOLUTE(.);
  } >dram0_1_seg :dram0_1_phdr
