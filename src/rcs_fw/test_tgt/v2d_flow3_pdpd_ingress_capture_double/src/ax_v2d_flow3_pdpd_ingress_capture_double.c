...
int main (int argc, char **argv)
{
    ...
    uint32_t v2d_base = 0, vex_base = 0, v2d_num = 0, apb_num = 0, tx_vex_num = 0, rx_vex_num = 0, drf_clock = 0, match_value = 0,
             ...
             capture_blocks = 0, clks_per_blk = 0;
    ...
    if (0 == apb_num)
    {
        configure_v2d_bfn_config(v2d_num, 1/*reg_instance*/, BFN_EVENT_OUTPUT_MODE_PULSE, BFN_EVENT_MODE_DOUBLE);
    }
    else
    {
        configure_v2d_bfn_config(v2d_num, 2/*reg_instance*/, BFN_EVENT_OUTPUT_MODE_PULSE, BFN_EVENT_MODE_DOUBLE);
    }
