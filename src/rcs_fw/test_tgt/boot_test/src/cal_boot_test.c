...
volatile uint32_t write_rsm[SIZE] __attribute__((section(".sram.reserved")));
...
uint32_t boot_test()
{
    ...
    {
        write_dram[dataCnt] = 0x9999aaaa;
        write_rsm[dataCnt] = 0xbbbbcccc;
    }
