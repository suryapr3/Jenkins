...
volatile uint32_t  buff_rsm[IDMA_TEST_BUFF_SIZE] __attribute__ ((section (".sram.rx.rw")));
...
volatile uint32_t  buff_r[IDMA_TEST_BUFF_SIZE*8] __attribute__ ((section (".sram.rx.rw")));
