...
int main (int argc, char **argv)
{
    ...
    /*function to validate the sys_ref load*/
    bfn_sys_ref_load();
    ...
    /*function to validate the reset*/
    bfn_follower_reset();
...
uint32_t bfn_start()
{
    ...
    INTRINSIC_BARRIER;
    RCS_TIMER_GPREG -> ICTRL.LOAD_READ = 1;

    // Set the SYSREF
    RCS_TIMER_GPREG -> OPPS_VAL_TIMESYNC_CTRL.value = TIMESYNC_CTRL;    //0x00050031
    INTRINSIC_BARRIER;
...
/**
 * @brief           Function for testing the sysref load
 * @param [in]      None
 * @return          None
 */
void bfn_sys_ref_load()
{

    RCS_TIMER_GPREG -> INC_PRE_REG0.value = 0x50000;
    INTRINSIC_BARRIER;
    ...
    ((bfn_csr_t*) g_v2d_base) -> AW_ISYNC_INC_PRE.value = 0x50000;
    INTRINSIC_BARRIER;
    ...
    ((bfn_csr_t*) g_v2d_base) -> AW_ISYNC_CTRL.LOAD_READ = 0;
    INTRINSIC_BARRIER;
    RCS_TIMER_GPREG -> ICTRL.LOAD_READ = 0;
    INTRINSIC_BARRIER;
