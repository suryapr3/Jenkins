...
/**
 * @file    ax_v2d_quad_flow3_pdpd_ingress_capture_repeat_2_ch.c
 * @brief   Program the BFN for capturing the data for two channels in a QUAD in REPEAT mode
...
int main (int argc, char **argv)
{
    ...
    bfn_incr_value = (num_antennas * capture_blocks_per_antenna * clk_per_blk) + skip_cycles + ((v2d_rcs_host_param_t *) rsm_buf) -> ant1_cycles;
    ...
    *(BFN_CSR_BFNE_START0_REG(v2d_base)) = bfne_start_reg;
    ...
    dram_buff[4] = quad_mem_fb_compare_2_ch_repeat(ref_pattern, (v2d_rcs_host_param_t *)rsm_buf);
