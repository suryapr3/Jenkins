...
#ifndef RF_CALIB_COM_HEAP__H
#define RF_CALIB_COM_HEAP__H
 ...
 * -------------------------------------------------------------------------------------------------------------------*/
extern void *rf_calib_calloc (uint32_t count, uint32_t obj_size); // Our version of calloc
/* ---------------------------------------------------------------------------------------------------------------------
 * @brief           Free the allocated memory.
 * @param [in]      ptr - Generic pointer to be freed
 * @return          boolean indicating whether the operation was successful or not
 * -------------------------------------------------------------------------------------------------------------------*/
extern bool rf_calib_free (void *ptr); // Our version of free
/* ---------------------------------------------------------------------------------------------------------------------
 * @brief           Create heap.
 ...
 * @return          boolean indicating whether the operation was successful or not
 * -------------------------------------------------------------------------------------------------------------------*/
extern bool rf_calib_heap_create (uint8_t *p_heap, uint32_t size);
#endif
