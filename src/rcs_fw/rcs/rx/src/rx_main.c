...
/**
 * @file    rx_main.c
 * @brief   This file contains description of the entry function for RX core.
 * @details RX core main function with boot phases.
 */
...
void boot_phase1 ()
{
    ...
    msg_queue_t *p_rx_rm_queue = com_shared_mem_get_queue_block (e_RX_RM_QUEUE);
    com_queue_init (p_rx_rm_queue);
...
void boot_phase2 ()
{
    ...
    com_msg_init_mb_irq (rx_msg_irq_hdlr_map, e_NUM_RX_MB_IRQ);
