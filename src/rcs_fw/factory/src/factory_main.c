...
/**
 * @file    factory_main.c
 * @brief   Main processing loop for factory test implementation.
 * @details This has the main() entry point for the factory testing.
 * @todo    Write documentation for source file factory_main.c
 */
...
void boot_phase2 ()
{
    ...
    // TODO: Since selftest involves only 2 cores we need to revisit this
...
int main (int argc, char **argv)
{
    ...
    FW_PRINT (FW_INFO, "KP1: Boot Phase 1 completed");
    boot_phase2 ();
    FW_PRINT (FW_INFO, "KP1: Boot Phase 2 completed");
